...
<html>
<head>
<title>FAQ Category Manager</title>
...
RecordCounter = RecordCounter%>.</b>    </td>
    <td width="85%" valign="middle"><form name="form" method="POST" action="<%=MM_editAction%>">      
        <div align="left">
    ...
    <td width="13%" valign="baseline"><form ACTION="<%=MM_editAction%>" METHOD="POST" name="delete">
        <div align="left">
