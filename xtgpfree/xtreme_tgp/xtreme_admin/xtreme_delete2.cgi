...
print MAIL "\n";
print MAIL "We regret to inform you that your listing on\n";
print MAIL "EliteList Movie Post was removed.\n";
close(MAIL);
}
else
{
...
<META HTTP-EQUIV="Refresh" CONTENT="0; URL=xtreme_admin.cgi?there">
HTML2
