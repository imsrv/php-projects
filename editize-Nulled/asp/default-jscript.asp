...
<%
	...
	var blurb   = Request.Form("blurb");
	var article = Request.Form("article");
%>
<html>
<head>
...
<% if (Request.QueryString("submit").Count > 0) { %><base href="http://www.sitepoint.com/" /><% } %>
</head>
<body bgcolor="#FFFFFF" text="#000000">
<%
	// Determine if the form has been submitted or not.
	if (Request.QueryString("submit").Count < 1)
...
<%
	...
	Response.Write(ed.DisplaySubmit("Submit Article",150,30));
%>
</form>
<%
	}
