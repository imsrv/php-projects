...
<html>
	<!--
	  ...
	  -->
	<head>
		<title>Editize API for ASP.NET Demo (C#)</title>
		<script runat="server">
			private void Page_Load(object sender, EventArgs e)
			{
				EventHandler handler = new EventHandler(FormContent_Changed);
				TitleTextBox.TextChanged += handler;
				BlurbEditize.ContentChanged += handler;
				ArticleEditize.ContentChanged += handler;
			}
			
			protected void FormContent_Changed(object sender, EventArgs e)
			{
	...
	<body bgcolor="#FFFFFF" text="#000000">
		<form id="Form1" method="post" runat="server">
			...
			<!-- We use a special Java submit button for this form to make it compatible
			  ...
			  -- a standard asp:Button could be used. -->
			<SitePoint:EditizeSubmitButton id="EditizeSubmit" runat="server"
				width="150px" height="30px" Text="Submit Article" />
		</form>
	</body>
</html>