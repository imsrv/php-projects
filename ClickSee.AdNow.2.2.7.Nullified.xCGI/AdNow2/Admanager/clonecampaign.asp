<%@ Language=VBScript %>
<!--#Include File="Include/clonec.asp"-->
<HTML>
<HEAD>
<TITLE>Clone Campaign</TITLE>
...
<form method="POST" action="include/clonec.asp?<%=Request.ServerVariables ("Query_String")%>" onsubmit="return validate(this)" id=form1 name=form1>
<script Language="JavaScript">
function validate(theForm)
{
  if (theForm.elements["campaignname"].value == "") {
    theForm.elements["campaignname"].focus();
...
<TD WIDTH="100%" VALIGN="TOP" COLSPAN="3" ALIGN="CENTER">
	...
	<div align="right"><strong><font size="4" COLOR="#CCCCCC"><span style="font-family: Arial;">CLONE CAMPAIGN</strong></font></div><br>
	<table border="0">
		
	<TR>
		<TD VALIGN="TOP" COLSPAN="2" ALIGN="center"><FONT COLOR="#FF0000" FACE="arial, helvetica" SIZE="-1"><STRONG><%ErrMSG%></STRONG></FONT></TD>
	</TR>
    <tr>
      <td align="right"><b><font size="-1" COLOR="#FF9900"><span style="font-family: Arial;">Campaign Name*</span></font></b></td>
      <td><input type="text" name="campaignname" size="40" value=""></td>
    </tr>
    <tr>
  ...
  <table border="0" width="90%">
    <tr>
	  <td colspan="2"><b><font size="-1" COLOR="#FFCC00"><span style="font-family: Arial;">Please Select the Ads to be added to new campaign</span></font></b></td>
	</tr>
<% findCampaign %>
    <tr>
      <td>&nbsp;<input type="hidden" name="campaignid" value="<%=Request("campaignid")%>"></td>
      <td><br>
