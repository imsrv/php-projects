<%@ Language=VBScript %>
<!--#Include File="Include/edita.asp"-->
<HTML>
<HEAD>
...
<!--#include file="include/logo.asp"--><br><br>
<script Language="JavaScript">
...
function validate(theForm)
{
  ...
  if ((theForm.elements["dateend"].value != "")  && (theForm.elements["impressionsPurchased"].value != "" ))
  {
    alert("Please enter 'Date End' or 'Click Expire' or 'Imp Purchased'.");
    return (false);
  }
...
<form method="POST" action="<%=Request.ServerVariables ("Path_info")%>?<%=Request.ServerVariables ("Query_String")%>" onsubmit="return validate(this)" id=form1 name=form1>
...
<TD WIDTH="100%" VALIGN="TOP" COLSPAN="3" ALIGN="CENTER">
	...
	<!-- V LINE -->
	<TD VALIGN="TOP"><IMG SRC="../images2/grey.gif" WIDTH=1 HEIGHT=870 BORDER="0"></TD>
	<!-- Form Text Field -->	
	<TD WIDTH="450" VALIGN="TOP" ALIGN="CENTER">
		<div align="right"><strong><font size="4" COLOR="#CCCCCC"><span style="font-family: Arial;">EDIT AN ADVERTISEMENT</strong></font></div>
		<table>
		<TR>
        ...
        <td><input type="text" name="adname" size="40" value="<%=Print_ad ("adname",Request.QueryString ("adid"))%>"></td>
	    </tr>
	    ...
	    <td><input type="text" name="adtarget" size="40" value="<%=Print_ad ("adTarget",Request.QueryString ("adid"))%>">&nbsp;&nbsp;<a href="javascript:new_window('glossary.asp#linktarget')"><img src="../images2/help.gif" width="17" height="17" border="0" alt="What is 'LINK TARGET'?"></a></td>
	    </tr>
	...
	<tr>
     ...
     <td><select name="status" size="1">
        <option 
        <%If lcase(Print_ad ("status",Request.QueryString ("adid")))="active" Or Print_ad ("status",Request.QueryString ("adid"))=empty Then%>
        selected 
        <%End If%>
        value="Active">Active</option>
        <option 
        <%If lcase(Print_ad ("status",Request.QueryString ("adid")))="expired" Then%>
        selected 
        <%End If%>
        value="Expired">Expired</option>
        <option 
        <%If lcase(Print_ad ("status",Request.QueryString ("adid")))="hold" Then%>
        selected 
        <%End If%>
        value="Hold">Hold</option>
        <option 
        <%If lcase(Print_ad ("status",Request.QueryString ("adid")))="hold to launch" Then%>
        selected 
        <%End If%>
     ...
     <td><input type="text" name="datestart" size="40" Value="<%=Print_date (Print_ad ("datestart",Request.QueryString ("adid")))%>">
	 </td>
     </tr>
	 <tr>
     ...
     <td><input type="text" name="dateend" size="40" Value="<%IF Print_ad ("dateend",Request.QueryString ("adid")) <> EMPTY Then Response.Write Print_date (Print_ad ("dateend",Request.QueryString ("adid"))) ELSE Response.Write "" END IF%>">&nbsp;&nbsp;<a href="javascript:new_window('glossary.asp#dateend')"><img src="../images2/help.gif" width="17" height="17" border="0" alt="What is 'DATE END'?"></a>
	 </td>
     </tr>
	<tr>
      <td align="right"><font size="-1" COLOR="#FFCC00"><span style="font-family: Arial;">Click Expire</span></font></td>
      <td><input type="text" name="clickexpire" size="40" value="<%IF (Print_ad ("clickexpire",Request.QueryString ("adid")))<>EMPTY AND (Print_ad ("clickexpire",Request.QueryString ("adid")))<>"0" THEN Response.Write Print_ad ("clickexpire",Request.QueryString ("adid")) ELSE Response.Write "" END IF%>">&nbsp;&nbsp;<a href="javascript:new_window('glossary.asp#clickexpire')"><img src="../images2/help.gif" width="17" height="17" border="0" alt="What is 'CLICK EXPIRE'?"></a>
	  </td>
    </tr>
	<tr>
      <td align="right"><font size="-1" COLOR="#FFCC00"><span style="font-family: Arial;"># of Impression Purchased</span></font></td>
      <td><input type="text" name="impressionsPurchased" size="40" value="<%IF Print_ad ("impressionsPurchased",Request.QueryString ("adid"))<>EMPTY AND Print_ad ("impressionsPurchased",Request.QueryString ("adid"))<>0 THEN Response.Write Print_ad ("impressionsPurchased",Request.QueryString ("adid")) ELSE Response.Write "" END IF%>">&nbsp;&nbsp;<a href="javascript:new_window('glossary.asp#imp')"><img src="../images2/help.gif" width="17" height="17" border="0" alt="What is '# OF IMPRESSION PURCHASED'?"></a>
	  </td>
    </tr>
    ...
    <tr>
	  <td>&nbsp;</td>
      <td>
      <input type="submit" value="S U B M I T" name="Finish" style="font-weight: bold;">
