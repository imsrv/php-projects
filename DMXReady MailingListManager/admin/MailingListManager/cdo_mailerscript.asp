...
strBodyPrev = strDate & "<br><br>" & vbCrLf _
...
strBodyPrev = strDate & vbCrLf _
					...
					End if
Dim objCDOPreview
Set objCDOPreview = Server.CreateObject("CDONTS.NewMail")
objCDOPreview.To = strEmailPrev
objCDOPreview.From = strFrom
objCDOPreview.CC = strCC
objCDOPreview.BCC = strBCC
objCDOPreview.BodyFormat = strBodyFormat
objCDOPreview.MailFormat = strMailFormat
objCDOPreview.Importance = strPriority
objCDOPreview.Subject = strSubject
objCDOPreview.Body = strBodyPrev
objCDOPreview.Send
...
strBodyNew = strDate & "<br><br>" & vbCrLf _
					& strText & "<br><br>" & vbCrLf _
					& strBody & "<br><br>" & vbCrLf _
					& "<br><br>" & vbCrLf _
					& strText & vbCrLf _
...
objCDO.CC = strCC
objCDO.BCC = strBCC
objCDO.BodyFormat = strBodyFormat
objCDO.MailFormat = strMailFormat
objCDO.Importance = strPriority
objCDO.Subject = strSubject
objCDO.Body = strBodyNew 
objCDO.Send
'Cleanup and Close DB
Set objCDO = Nothing
%>
