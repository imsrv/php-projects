...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<th width="100%">
			...
			<img src="templates/Avalanche/images/icon_newest_reply.gif" alt="" /> <a href="{U_VIEW_FORUM}" class="thCenter">{FORUM_NAME}</a></span></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="forumline">
	<tr> 
		<td class="cat" colspan="2"><b>{L_POST_A}</b></td>
	</tr>
