...
<table width="100%" class="forumline" cellspacing="0" cellpadding="2" border="0" align="center">
	<tr>
		<td align="center" class="cat">{ERROR_BOX}</td>
	</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="forumline">
	<tr> 
		<td class="cat" colspan="2" valign="middle">{L_REGISTRATION_INFO}</td>
	</tr>
	<tr> 
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="forumline">
	<tr>
	  <td class="cat" colspan="2" valign="middle">{L_PROFILE_INFO}</td>
	</tr>
	<tr> 
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="forumline">
	<tr> 
	  <td class="cat" colspan="2" valign="middle">{L_PREFERENCES}</td>
	</tr>
	<tr> 
	...
	<tr> 
	  <td class="row1" width="38%"><span class="gen">{L_NOTIFY_ON_REPLY}:</span><br />
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="forumline">
	<tr> 
	  <td class="cat" colspan="2" valign="middle">{L_AVATAR_PANEL}</td>
	</tr>
	<tr> 
