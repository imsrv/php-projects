...
############################################################
# File name               dk_.php                          #
# File purpose            Addition to dutch langfile       #
...
'Laveste dato først',
'Høyeste dato først',
'Lavest fornavn først',
'Høyeste fornavn føst',
'Lavest alder først',
'Høyeste alder først',
'Laveste høyde først',
'Høyeste høyde først',
...
$wst=array(
'Alle brugere',
'Venter på godkjennelse av email',
'Venter på registrerings godkjennelse',
'Venter på opppdaterings godkjennelse',
'Venter på administrator godkjennelse til å fjerne',
'Aktive brukere'
);

$wcr=array(
' Ikke spesifisert', // First space is required for sorting
'Afganistan',
'Albanien',
'Algeriet',
'Andorra',
