...
#################################################
# Password Checker for e_Match 3.5
#################################################
...
for $line (@lines) {
	...
	if($FORM{'email'} eq $item[2]) {
		...
		print "<H1 align=center>Thanks!</H1><hr>\n";
		print "Your nickname and password will arrive via email shortly. Then you can return <A HREF=\"index35.cgi\">HERE</A> and log on.\n";
		print "</body></html>";
		exit;
	}
}
print "Content-type: text/html\n\n";
print "<html><head>$header\n";
print "<h2>Your email address could not be found.</h2><hr>\n";
