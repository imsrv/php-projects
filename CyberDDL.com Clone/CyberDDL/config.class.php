...
class config {
	...
	var $site_url = "";	// Your sites url
	var $site_name = "";			// Your sites name
	var $site_mail = "";			// Your e-mail
	
	var $r_user = "admin";						// Admin Username (Case Sensitive)
	var $r_pass = "pass";						// Admin Password (Case Sensitive)
	...
	var $admin_email = "";	// Your e-mail
	var $mysql_host = "localhost";				// MySQL host - usually localhost
	var $mysql_user = "";					// MySQL username
	var $mysql_pass = "";					// MySQL password
	var $mysql_db = "";						// Your MySQL database
