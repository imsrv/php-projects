...
If (CStr(Request("MM_insert")) = "ParentCategory") Then
  ...
  MM_editRedirectUrl = "../CategoryManager/list.asp#step2"
...
allcategories.ActiveConnection = MM_joblistingmanager_STRING
...
parentcategorymenu.ActiveConnection = MM_joblistingmanager_STRING
...
rsParentCategory.ActiveConnection = MM_joblistingmanager_STRING
...
<!--#include file="../CategoryManager/header.asp" -->
<br>
    ...
    <td class="tableborder"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
      <tr>
        <td><strong><font color="#FF0000" size="2">STEP 1</font></strong><font color="#FF0000" size="2">&nbsp; </font>-
          <font color="#FF0000"><strong>Create Division </strong></font>: Enter
          the name of the Division and press the create button.</td>
      </tr>
      <tr>
...
%>">
          ...
          <td width="5%"><div align="center"><a href="../CategoryManager/update_category.asp?cid=<%=(rsParentCategory.Fields.Item("CategoryID").Value)%>">Edit</a></div>
          </td>
          <td><a href="../CategoryManager/delete_category.asp?cid=<%=(rsParentCategory.Fields.Item("CategoryID").Value)%>">Delete</a> </td>
        </tr>
      </table>
      <% 
    ...
    <td height="81" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
      <tr>
        <td><strong><font color="#FF0000" size="2"><a name="step2"></a>STEP 2</font></strong><font color="#FF0000" size="2">&nbsp; </font>- <font color="#FF0000"><strong>Create
              Department </strong></font>: Select the Division, enter the name
              of the Department and press the create button. </td>
      </tr>
      <tr>
        <td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&raquo;&nbsp;&nbsp;&nbsp;&nbsp;<%=(allcategories.Fields.Item("CategoryValue").Value)%></td>
          <td width="5%"><div align="center"><a href="../CategoryManager/update_category.asp?cid=<%=(allcategories.Fields.Item("CategoryID").Value)%>">Edit</a></div></td>
          <td><a href="../CategoryManager/delete_category.asp?cid=<%=(allcategories.Fields.Item("CategoryID").Value)%>">Delete</a>
</td>
        </tr>
      </table>
      <% 
...
<div align="center"><br>
  <a href="../CategoryManager/closewindow_redirect.asp">Close Window
</a></div>
</body>
</html>
<%
