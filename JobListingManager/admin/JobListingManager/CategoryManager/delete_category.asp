...
deletelistitem.ActiveConnection = MM_joblistingmanager_STRING
deletelistitem.Source = "SELECT *  FROM tblItems_Category  WHERE CategoryID = " + Replace(deletelistitem__value1, "'", "''") + ""
