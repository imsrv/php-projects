...
objCDOSYSCon.Fields("http://schemas.microsoft.com/cdo/configuration/smtpserver") = "mail.mydomain.com" ' change to your smtp server
...
sendmail.TextBody =  messagebody & _
...
%>
              <%
pre_url = "http://www." & request.servervariables("HTTP_HOST") & request.servervariables("URL") & "?" & request.servervariables("QUERY_STRING")
url = Server.URLencode(pre_url)
%>
<a href="javascript:;"  onClick="MM_openBrWindow('inc_sendtofriendmanager.asp?emailform=yes&amp;url=<%=url%>','SendToFriend','width=500,height=350')">SEND TO FRIEND</a>
<%end if%></div></td>
  </tr>
</table>
<%else%>
<p align="center"><strong><font size="4">Automatically email Job Listing to
...
<form action="" method="post" name="SendToFriend" id="SendToFriend" onSubmit="YY_checkform('SendToFriend','sendtoemail','#S','2','Enter recipients email address','sendtoname','#q','0','Enter recipients name','sentfromname','#q','0','Enter senders name','sentfromemail','#S','2','Enter senders email address','messagesubject','#q','0','Enter a subject');return document.MM_returnValue">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="tableborder2">
    <tr>
      <td width="150" height="26" bgcolor="#666666"><font color="#FFFFFF"><strong>Send to email address:</strong></font></td>
      <td><input name="sendtoemail" type="text" id="sendtoemail"> 
      Enter recipients email address</td>
    </tr>
    <tr>
      <td width="150" bgcolor="#666666"><font color="#FFFFFF"><strong>Send to name:</strong></font></td>
      <td><input name="sendtoname" type="text" id="sendtoname"> 
      Enter recipients name</td>
    </tr>
    <tr>
      <td width="150" bgcolor="#666666"><font color="#FFFFFF"><strong>Sent from name:</strong></font></td>
      <td><input name="sentfromname" type="text" id="sentfromname">
      Enter your name</td>
    </tr>
    <tr>
      <td width="150" bgcolor="#666666"><font color="#FFFFFF"><strong>Sent from email address:</strong></font></td>
      <td><input name="sentfromemail" type="text" id="sentfromemail"> 
      Enter your email address</td>
    </tr>
    <tr>
      <td width="150" bgcolor="#666666"><font color="#FFFFFF"><strong>Email subject:</strong></font></td>
      <td><input name="messagesubject" type="text" id="messagesubject" value="Check out this job posting" size="40"> 
      Enter Subject</td>
    </tr>
    <tr>
      <td width="150" bgcolor="#666666"><font color="#FFFFFF"><strong>Email message:</strong></font></td>
      <td>      <textarea name="messagebody" cols="30" rows="3" id="messagebody">
Your friend has sent you this email and thought you would should check out this job posting.</textarea>
  <br>
  <font color="#FF0000" size="1"><a href="<%=Request.QueryString("url")%>" target="_blank">Click
  to Preview Page</a></font>
  <input type="hidden" name="url" value="<%=Request.QueryString("url")%>"></td>
    </tr>
  </table>
  <p align="center">    
