...
If (CStr(UploadFormRequest("MM_insert")) <> "") Then
  ...
  MM_fieldsStr  = "ItemName|value|ItemDesc|value|ItemDescShort|value|ImageFileB|value|Activated|value"
...
List_Manufacturers.Source = "SELECT *  FROM tblManufacturers"
      ...
      <form ACTION="<%=MM_editAction%>" METHOD="post" enctype="multipart/form-data" name="form1" onSubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','');return document.MM_returnValue">
        <table width="100%" align="center" class="tableborder">
          ...
          <tr align="right" valign="top">
            ...
            <td align="left">
              <input name="ItemName" type="text" id="ItemName" value="Enter name" size="50">
          ...
          <tr align="right" valign="top">
            ...
            <td align="left">
              <textarea name="ItemDesc" cols="50" rows="5" id="ItemDesc">Enter Description</textarea>
          ...
          <tr align="right" valign="top">
            ...
            <td align="left">
            http://
            <input name="ItemDescShort" type="text" id="ItemDescShort" value="www." size="50">
            <img src="questionmark.gif" alt="Enter a short description of the event" width="15" height="15"></td>
          </tr>
          <tr align="right" valign="top">
            <td class="tableheader">Image:</td>
            <td align="left"><input name="ImageFileB" type="file" id="ImageFileB" onChange="checkOneFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','')" value="" size="32"></td>
          </tr>
          <tr align="right" valign="top">
