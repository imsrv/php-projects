...
If (CStr(Request.QueryString("GP_upload")) <> "") Then
  ...
  pau_thePath = """../../applications/CatalogManager/download"""
  pau_Extensions = ""
  pau_Form = "form1"
  pau_Redirect = ""
  pau_storeType = "file"
...
If (CStr(UploadFormRequest("MM_update")) <> "" And CStr(UploadFormRequest("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "DocFile|value"
  MM_columnsStr = "DownloadFile2|',none,''"
...
<form ACTION="<%=MM_editAction%>" METHOD="post" enctype="multipart/form-data" name="form1" onSubmit="checkFileUpload(this,'',true,'','','','','','','');return document.MM_returnValue">
  <table width="100%" align="center" class="tableborder">
    ...
    <tr valign="baseline"> 
      ...
      <td height="28"> <input name="DocFile" type="file" id="DocFile" onChange="checkOneFileUpload(this,'',true,'','','','','','','')"> </td>
    </tr>
    <tr valign="baseline"> 
      <td nowrap align="right">&nbsp;</td>
