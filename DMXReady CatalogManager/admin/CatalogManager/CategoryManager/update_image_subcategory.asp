...
If (CStr(UploadFormRequest("MM_update")) <> "" And CStr(UploadFormRequest("MM_recordId")) <> "") Then
  ...
  MM_columnsStr = "SubCategoryImageFile|',none,''"
...
If (Request.QueryString("scid")     <> "") Then 
  Category__MMColParam = Request.QueryString("scid")    
End If
%>
<%
set Category = Server.CreateObject("ADODB.Recordset")
Category.ActiveConnection = MM_catalogmanager_STRING
Category.Source = "SELECT *  FROM tblCatalogSubCategory  WHERE SubCategoryID = " + Replace(Category__MMColParam, "'", "''") + ""
...
<form ACTION="<%=MM_editAction%>" METHOD="post" enctype="multipart/form-data" name="form1" onSubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','');return document.MM_returnValue" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="tableborder">
    <tr>
    <td height="28" colspan="2"><strong><font size="2">Update: <%=(Category.Fields.Item("SubCategoryName").Value)%></font></strong></td>
    </tr>
    <tr>
      <td width="2%" nowrap>&nbsp;</td>
      <td width="98%" valign="baseline"> 
        <input name="ImageFile" type="file" onChange="checkOneFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','')">
      </td>
    </tr>
    <tr>
  ...
  <input type="hidden" name="MM_recordId" value="<%= Category.Fields.Item("SubCategoryID").Value %>">
</form>
<p>&nbsp;</p>
</body>
</html>
