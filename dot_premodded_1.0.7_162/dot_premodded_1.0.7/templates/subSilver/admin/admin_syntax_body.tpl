...
<form action="{S_SYNTAX_ACTION}" method="post"><table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	<tr>
		<td><input type="radio" name="enable_disable_syntax" value="2"{s_advanced_mode_enabled.SYNTAX_ENABLED_CHECKED}/> {s_advanced_mode_enabled.L_ENABLED}<br />
		<input type="radio" name="enable_disable_syntax" value="1"{s_advanced_mode_enabled.SYNTAX_PARTIAL_CHECKED}/> {s_advanced_mode_enabled.L_PARTIAL}<br />
		<input type="radio" name="enable_disable_syntax" value="0"{s_advanced_mode_enabled.SYNTAX_DISABLED_CHECKED}/> {s_advanced_mode_enabled.L_DISABLED}</td>
	</tr>
	<tr>
...
<form action="{S_SYNTAX_ACTION}" method="post"><table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline" width="90%">
	<tr>
		<th class="thHead" align="center">{s_advanced_mode_enabled.L_LANGUAGE_NAME}</th>
		<th class="thHead" align="center">{s_advanced_mode_enabled.L_LANGUAGE_ENABLED}</th>
