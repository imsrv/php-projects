...
<form method="post" name="group_list" action="{S_DESIGNATED_GROUPS_CP_ACTION}" style="display: inline;">
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr> 
	  <td class="catHead" colspan="5" align="center" height="28"><span class="cattitle">{L_DESIGNATED_GROUPS_CP}</span> 
	  </td>
	</tr>
	<tr> 
	  <td class="spaceRow" colspan="5" align="center"><span class="gensmall">{L_DESIGNATED_GROUPS_CP_EXPLAIN}</span></td>
	</tr>
	<tr> 
	  <th width="90%" class="thCornerL" nowrap="nowrap">&nbsp;{L_GROUPS}&nbsp;</th>
	  <th width="10%" class="thCornerR" nowrap="nowrap">&nbsp;{L_SELECT}&nbsp;</th>
	</tr>
	<!-- BEGIN listrow -->
	<tr> 
	  <td width="90%" valign="middle" class="{listrow.ROW_CLASS}"><span class="topictitle">&nbsp;{listrow.U_GROUP_NAME}</span></td>
	...
	<!-- BEGIN switch_include_text_checkbox -->
	  <tr> 
		<td width="90%" align="right" valign="middle"><span class="topictitle">&nbsp;{L_INCLUDE_TEXT}</span></td>
		<td width="10%" align="center" valign="middle"><span class="postdetails">
			<input type="checkbox" name="include_text" {S_INCLUDE_TEXT} />
			</span></td>
	  </tr>
	  <tr> 
		<td width="90%" align="right" valign="middle"><span class="topictitle">&nbsp;{L_INCLUDE_UNAUTHORIZED_USERS}</span></td>
		<td width="10%" align="center" valign="middle"><span class="postdetails">
