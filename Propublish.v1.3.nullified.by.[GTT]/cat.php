...
include ("admin/language/eng.php");
...
if ($catid)
{
	for ($i=0; $i<$num_res; $i++)
	{
              ...
              $fname = "cat.php";
				...
				// Image tags
				$intro = str_replace("<image>", "<img align=left width='90' src='admin/img_get.php?id=", $intro);
				$intro = str_replace("</image>", "'>", $intro);
		
				$intro = str_replace("&lt;image&gt;", "<img width='90' src='admin/img_get.php?id=", $intro);
				$intro = str_replace("&lt;/image&gt;", "'>", $intro);
				
				$intro = str_replace("<image_left>", "<img align='left' src='admin/img_get.php?id=", $intro);
				$intro = str_replace("</image>", "'>", $intro);
