...
for ($i=0; $i<$num_res; $i++)
{
    ...
    $intro = ereg_replace("<image>", "<!--",$intro);
    $intro = ereg_replace("</image>", "-->",$intro);
...
border=\"1\"><tr><td width=\"100%\">";
	...
	{	
		...
		// Image tags
		$body = str_replace("<image>", "<img src='admin/img_get.php?id=", $body);
		$body = str_replace("</image>", "'>", $body);
		
		$body = str_replace("&lt;image&gt;", "<img src='admin/img_get.php?id=", $body);
		$body = str_replace("&lt;/image&gt;", "'>", $body);
		
		$body = str_replace("<image_left>", "<img align='left' src='admin/img_get.php?id=", $body);
		$body = str_replace("</image>", "'>", $body);
		...
		$body = str_replace("<image_right>", "<img align='right' src='admin/img_get.php?id=", $body);
		$body = str_replace("</image>", "'>", $body);
