...
<span class="meny">
<? 
if (file_exists("cat_list.php"))
{
	include "cat_list.php"; 
}
elseif (file_exists("../cat_list.php"))
{
	include "../cat_list.php";
}
?>
...
<? 
if (file_exists("search_include.php"))
{
...
<tr>
	...
	<tr><td bgcolor="#EAEAEA" valign="top"><font color="#0000FF">&nbsp; </font><font face="Arial" size="2"><font color="#0000FF">DeltaScripts</font></td>
