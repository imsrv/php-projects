...
$pass = "MYSQL_PASSWORD"; #Database password
$database = "MYSQL_DB_NAME"; #Database Name
...
$timefix = "0";
$zone = "CDT";
$main_html = "/path/to/html/tgp.shtml"; #This is the path and file name of the main page of your TGP
$cat_html = "/path/to/html/archives"; #This is the path to the dir. that all of your archive pages will be built in.
$filesdir = "/path/to/cgi-bin/tgp/files";
$adminurl = "http://www.domain.com/cgi-bin/tgp/admin.cgi";
$cgiurl = "http://www.domain.com/cgi-bin/tgp";
####################################################################
######### Thumbnail Mod Configuration Area ####################################
####################################################################
$mondir = "/path/to/html/thumbs"; #Path where you would like the uploaded thumbnails to be uploaded to.
$monurl = "http://www.domain.com/thumbs"; #URL of the directory that thumbnails will be uploaded to.
$max_size = "8000"; #Maximum size of thumbs that my be uploaded (in bytes).
####################################################################
######### No need to modify below this point #######################
####################################################################
$thumblinetemp = "$filesdir/templates/thumb.temp";
$category_db = "$filesdir/categories.db";
$pid_db =  "$filesdir/pid.txt";
$apstats =  "$filesdir/autopost.txt";
$banlist = "$filesdir/banlist.txt";
$domainlist = "$filesdir/domainlist.txt";
$options_db = "$filesdir/options.txt";
$tgpoptions_db = "$filesdir/tgpoptions.txt";
...
$version = "2.9";
$creator = "http://www.youdomain.com";
$creator_email = "support\@youdomain.com";
sub error {
