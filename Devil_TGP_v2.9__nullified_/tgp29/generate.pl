...
$poi = <P>;
close(P);
($pont1,$pont2,$pont3,$pont5,$pont6,$pont7,$pont8,$pont9,$pont10,$pont11,$pont12,$pont13)=split(/::/, $poi);
...
my $num_rows = $sth->fetchrow;
        ...
        $tempcount++ while ($laters =~ /#-THUMB-#/g);
        chomp $laters;
        }
       	my($query) = "SELECT * FROM DMtgpgalleries WHERE thumb = '1' AND approval = '1' ORDER BY datecode DESC, rate DESC, idnum DESC LIMIT $tempcount";
...
##
        ...
        my($query) = "SELECT * FROM DMtgpgalleries WHERE webcate LIKE '$categ' AND approval = '1' AND thumb != '1' ORDER BY datecode DESC, rate DESC, idnum DESC LIMIT $startat, $endat";
...
print "<body>\n";
print "\n";
print "<p align=\"center\"><font face=\"Verdana\">Page generated<!--CyKuH [WTN]--></font></p>\n";
print "\n";
print "</body>\n";
print "\n";
print "</html>\n";
