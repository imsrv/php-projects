...
If (CStr(Request.QueryString("GP_upload")) <> "") Then
  ...
  pau_thePath = """../../applications/DocumentLibraryManager/upload"""
  pau_Extensions = ""
  pau_Form = "form1"
  pau_Redirect = ""
  pau_storeType = "file"
...
If (CStr(UploadFormRequest("MM_insert")) = "form1") Then
  ...
  MM_fieldsStr  = "CategoryID|value|ItemName|value|ItemDescription|value|Link|value|Activated|value"
  MM_columnsStr = "CategoryID|none,none,NULL|ItemName|',none,''|ItemDesc|',none,''|ItemLink|',none,''|Activated|',none,''"
...
List_Library.Source = "SELECT *  FROM DocumentLibrary"
...
<script language="javascript">// --- Pure ASP File Upload -----------------------------------------------------
// Copyright 2001-2004 (c) George Petrov, www.DMXzone.com
// Version: 2.18
// ------------------------------------------------------------------------------
    ...
    <td width="600"> 
      <form ACTION="<%=MM_editAction%>" METHOD="post" enctype="multipart/form-data" name="form1" onSubmit="checkFileUpload(this,'',false,'','','','','','','');return document.MM_returnValue">
        <table width="100%" align="center" class="tableborder">
          <tr> 
            <td nowrap align="right" valign="top" colspan="2" class="tableheader">Insert 
              New Record</td>
          </tr>
          <tr> 
            <td nowrap align="right" valign="top" class="tableheader">Category</td>
...
%>
              ...
              category</a> <img src="questionmark.gif" alt="select a category that best desribes the document" width="15" height="15"></td>
          </tr>
          <tr> 
            <td nowrap align="right" valign="top" class="tableheader">Document  Name:</td>
            <td valign="baseline" class="tablebody"> 
              <textarea name="ItemName" cols="50" rows="2"></textarea>
            <img src="questionmark.gif" alt="Enter a short name to identify the document" width="15" height="15">            </td>
          </tr>
          <tr> 
            <td nowrap align="right" valign="top" class="tableheader">Document  Description:</td>
            <td valign="baseline" class="tablebody"> 
              <textarea name="ItemDescription" cols="50" rows="5"></textarea>
            <img src="questionmark.gif" alt="Enter a description of the document" width="15" height="15">            </td>
          </tr>
          <tr valign="baseline"> 
            <td nowrap align="right" class="tableheader">Upload File:</td>
            <td class="tablebody"> 
              <input name="Link" type="file" onChange="checkOneFileUpload(this,'',false,'','','','','','','')" value="" size="32">
            <img src="questionmark.gif" alt="Click on the browse button to locate the file on your computer" width="15" height="15">            </td>
          </tr>
          <tr valign="baseline"> 
            <td nowrap align="right" class="tableheader"><input name="Activated" type="hidden" id="Activated" value="True"></td>
            <td class="tablebody"> 
