...
<form method="post" action="{S_SPLIT_ACTION}">
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumborder">
        <tr> 
          <th class="forumtitle" colspan="3" nowrap="nowrap">{L_SPLIT_TOPIC}</th>
        </tr>
        <tr> 
        ...
        <tr> 
          <th class="forumtitle" nowrap="nowrap">{L_AUTHOR}</th>
          <th class="forumtitle" nowrap="nowrap">{L_MESSAGE}</th>
          <th class="forumtitle" nowrap="nowrap">{L_SELECT}</th>
        </tr>
        <!-- BEGIN postrow -->
        <tr> 
          ...
          <td width="100%" valign="top" class="{postrow.ROW_CLASS}"> 
                <table width="100%" cellspacing="0" cellpadding="3" border="0">
                  <tr> 
                        <td valign="middle"><img src="templates/alexisRed/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}:
        ...
        <tr> 
          <td colspan="3" height="1" class="row3"><img src="templates/alexisRed/images/spacer.gif" width="1" height="1" alt="."></td>
        </tr>
        <!-- END postrow -->
        <tr> 
          <td class="menu" colspan="3" height="28">
                <table width="60%" cellspacing="0" cellpadding="0" border="0" align="center">
                  <tr> 
                        <td width="50%" align="center"> 
                          <input class="liteoption" type="submit" name="split_type_all" value="{L_SPLIT_POSTS}" />
