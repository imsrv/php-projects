...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumborder">
  <tr> 
        <th width="35%" class="forumtitle">&nbsp;{L_USERNAME}&nbsp;</th>
        <th width="25%" class="forumtitle">&nbsp;{L_LAST_UPDATE}&nbsp;</th>
        <th width="40%" class="forumtitle">&nbsp;{L_FORUM_LOCATION}&nbsp;</th>
  </tr>
  <tr> 
        <td class="menu" colspan="3"><b>{TOTAL_REGISTERED_USERS_ONLINE}</b></td>
  </tr>
  <!-- BEGIN reg_user_row -->
  <tr> 
  ...
  <tr> 
        <td class="menu" colspan="3" height="28"><span class="cattitle"><b>{TOTAL_GUEST_USERS_ONLINE}</b></span></td>
  </tr>
