...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumborder" align="center">
  <tr> 
        <th width="150" height="25" class="forumtitle" nowrap="nowrap">{L_AUTHOR}</th>
        <th width="100%" class="forumtitle" nowrap="nowrap">{L_MESSAGE}</th>
  </tr>
  <!-- BEGIN searchresults -->
  <tr> 
        <th class="menu" colspan="2" height="28"><span class="topictitle"><img src="templates/alexisRed/images/folder.gif" align="absmiddle">&nbsp; {L_TOPIC}:&nbsp;<a href="{searchresults.U_TOPIC}" class="topictitle">{searchresults.TOPIC_TITLE}</a></span></td>
  </tr>
  <tr> 
  ...
  <!-- END searchresults -->
  <tr> 
        <td class="menu" colspan="2" height="28" align="center">&nbsp; </td>
  </tr>
</table>
