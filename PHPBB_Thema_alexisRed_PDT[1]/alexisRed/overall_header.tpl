...
<link rel="stylesheet" href="templates/alexisRed/{T_HEAD_STYLESHEET}" type="text/css">
...
<!-- <td width="150" background="templates/alexisRed/images/top.gif">&nbsp;</td> -->

<td valign="bottom"><div align="right"><img src="templates/alexisRed/images/logo.gif"></img></div></td></tr></table></td>
</tr>
<tr>
<td class="subtitle">
<table width="100%" height="100%" cellpadding="0" cellspacing="0">
<tr>
<!-- <td width="100" background="templates/alexisRed/images/bottom.gif">&nbsp;</td>   -->
<td class="small">
<div align="left">
