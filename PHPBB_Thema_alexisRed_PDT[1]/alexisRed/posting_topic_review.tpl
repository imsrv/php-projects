...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumborder">
        <tr> 
                <td class="forumtitle" align="center"><b><span>{L_TOPIC_REVIEW}</span></b></td>
        </tr>
        <tr>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumborder">
        <tr>
                <td class="forumtitle" width="22%">{L_AUTHOR}</th>
                <td class="forumtitle">{L_MESSAGE}</th>
        </tr>
        <!-- BEGIN postrow -->
        <tr>
        ...
        <tr> 
                <td colspan="2" height="1" class="spaceRow"><img src="templates/alexisRed/images/spacer.gif" alt="" width="1" height="1" /></td>
        </tr>
         <!-- END postrow -->
</table>
<!-- BEGIN switch_inline_mode -->
