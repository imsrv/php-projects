...
// run this update only if you are updating from CaLogic version 1.0.0a

include("../include/dbloader.php");

$sqlstr = "ALTER TABLE ".$dbname.".".$tabpre."_user_con ADD tzos INT DEFAULT '0' NOT NULL AFTER bday"; 
mysql_query($sqlstr) or die("Cannot update User Contacts Table<br><br>MySQL said: ".mysql_error()."<br><br>SQL String: ".$sqlstr."<br><br>File: ".substr(__FILE__,strrpos(__FILE__,"/"))."<br><br>Line: ".__LINE__.$GLOBALS["errep"]);
