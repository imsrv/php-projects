...
if (CStr(Request("MM_delete")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "updateAnswer.asp"
...
If (Request.QueryString("AnswerID")       <> "") Then 
  deletelistitem__MMColParam = Request.QueryString("AnswerID")      
End If
%>
<%
set deletelistitem = Server.CreateObject("ADODB.Recordset")
deletelistitem.ActiveConnection = MM_pollingboothmanager_STRING
deletelistitem.Source = "SELECT *  FROM tblPBM_PollAnswers  WHERE AnswerID = " + Replace(deletelistitem__MMColParam, "'", "''") + ""
...
<input type="hidden" name="MM_recordId" value="<%= deletelistitem.Fields.Item("AnswerID").Value %>">
</form>
<%
