...
{
window.open("agregar_banner_zona1.php?" + cual, "ventana", "height=110, width=198, scrollbars=no, resizable=no, toolbar=no, menubar=no")
}
</script>
...
$sql_cliente = "Select * from ads_clientes where id = '$id_usuario_session'";
...
$sql = "select * from ads_banners where id_cliente = $id_usuario_session";
