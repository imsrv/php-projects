...
if($enviado== "1"){
	...
	if($todo_ok == "1"){
		...
		$sql_grabo = "Insert into ads_banners values ('', '$id_usuario_session', '$tipo', '$contenido','$link',
		...
		if($result_grabo = mysql_query($sql_grabo)){
			if ($error_permiso == 1){
				Header("Location: exito_alta.php?opcion_menu=banner&error_permiso=1");
			}else{
				Header("Location: exito_alta.php?opcion_menu=banner");
	                               	}
		}
	}
}
