...
if($enviado== "1"){
	...
	if($todo_ok == "1"){
		...
		$sql_grabo = "UPDATE ads_banners SET id_cliente='$id_cliente', tipo='$tipo',contenido='$contenido',link='$link',
...
<form enctype="multipart/form-data" name="ti" method="post" action="banners_m2.php?enviado=1">
