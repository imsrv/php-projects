...
<form method="post" action="banners_m1.php">
                  ...
                  <td bgcolor="#FFD735"> <font size="-2" face="Verdana, Arial, Helvetica, sans-serif">
                    <div align="center"><br>
                      ...
                      <br>
                        <?
                        //Optimizo la DB
                        $sql = "OPTIMIZE TABLE ads_banners, ads_clientes, ads_estadisticas, ads_zonas, ads_zonas_banners";
                        $result = mysql_query($sql);
                        echo $nkads_traduccion[193];
                        ?>
                      <br>
                      &nbsp; </div>
                    </font> </td>
