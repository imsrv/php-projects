...
%>
      ...
      category</a> <img src="questionmark.gif" alt="Select a category that best describes the Image i.e. Sporting Image" width="15" height="15"></td>
          ...
          <tr align="right" valign="top">
            <td class="tableheader">Image A:<br>
            (Large Size)</td>
            <td align="left">              <% if photogallery_list.Fields.Item("ImageFileA").Value <> "" then %>
              ...
              | <a href="javascript:;" onClick="MM_openBrWindow('upload_imageA.asp?ItemID=<%=(photogallery_list.Fields.Item("ItemID").Value)%>','Image','scrollbars=yes,width=300,height=150')">Update
Image</a> <img src="questionmark.gif" alt="Upload image" width="15" height="15"></td>
          </tr>
          <tr align="right" valign="top">
            <td class="tableheader">Image A:<br>
            (Thumbnail Size)</td>
  ...
  | <a href="javascript:;" onClick="MM_openBrWindow('upload_thumbimageA.asp?ItemID=<%=(photogallery_list.Fields.Item("ItemID").Value)%>','Image','scrollbars=yes,width=300,height=150')">Update
  Image</a> <img src="questionmark.gif" alt="Upload image" width="15" height="15"></td></tr>
		            <tr align="right" valign="top">
            <td class="tableheader">Image B:<br>
(Large Size)</td>
            <td align="left">              <% if photogallery_list.Fields.Item("ImageFileB").Value <> "" then %>
              ...
              | <a href="javascript:;" onClick="MM_openBrWindow('upload_imageB.asp?ItemID=<%=(photogallery_list.Fields.Item("ItemID").Value)%>','Image','scrollbars=yes,width=300,height=150')">Update
Image</a> <img src="questionmark.gif" alt="Upload image" width="15" height="15"></td>
          </tr>
          <tr align="right" valign="top">
            <td class="tableheader">Image B:<br>
  ...
  | <a href="javascript:;" onClick="MM_openBrWindow('upload_thumbimageB.asp?ItemID=<%=(photogallery_list.Fields.Item("ItemID").Value)%>','Image','scrollbars=yes,width=300,height=150')">Update
  Image</a> <img src="questionmark.gif" alt="Upload image" width="15" height="15"></td></tr>
          <tr align="right" valign="top">
