                ...
                function ShowUserList()
                        {
                                ...
                                ?>
                                        ...
                                        <?php include(realpath("includes/jscript/adminuser.js")); ?>
												...
												<tr>
														...
														<td>
															<table width="100%" border="0">
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="view_config" value="ON" CHECKED >
																		<span class="BodyText">Configuration</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="about_us" value="ON" CHECKED >
																		<span class="BodyText">About Us</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="contact_us" value="ON" CHECKED >
																		<span class="BodyText">Contact Us</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="view_privacy" value="ON" CHECKED >
																		<span class="BodyText">Privacy</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="view_users" value="ON" CHECKED >
																		<span class="BodyText">View Users</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="add_users" value="ON" CHECKED >
																		<span class="BodyText">Add Users</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="edit_users" value="ON" CHECKED >
																		<span class="BodyText">Edit Users</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_users" value="ON" CHECKED >
																		<span class="BodyText">Delete Users</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="view_articles" value="ON" CHECKED >
																		<span class="BodyText">View Articles</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="add_articles" value="ON" CHECKED >
																		<span class="BodyText">Add Articles</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="edit_articles" value="ON" CHECKED >
																		<span class="BodyText">Edit Articles</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_articles" value="ON" CHECKED >
																		<span class="BodyText">Delete Articles</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="activate_articles" value="ON" CHECKED >
																		<span class="BodyText">Activate Articles</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="view_topics" value="ON" CHECKED >
																		<span class="BodyText">View Topics</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="add_topics" value="ON" CHECKED >
																		<span class="BodyText">Add Topics</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="edit_topics" value="ON" CHECKED >
																		<span class="BodyText">Edit Topics</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_topics" value="ON" CHECKED >
																		<span class="BodyText">Delete Topics</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="view_news" value="ON" CHECKED >
																		<span class="BodyText">View News</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="add_news" value="ON" CHECKED >
																		<span class="BodyText">Add News</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="edit_news" value="ON" CHECKED >
																		<span class="BodyText">Edit News</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_news" value="ON" CHECKED >
																		<span class="BodyText">Delete News</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="edit_2cents" value="ON" CHECKED >
																		<span class="BodyText">Edit 2Cents</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="edit_tips" value="ON" CHECKED >
																		<span class="BodyText">Edit Tips</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="view_books" value="ON" CHECKED >
																		<span class="BodyText">View Books</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="add_books" value="ON" CHECKED >
																		<span class="BodyText">Add Books</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="edit_books" value="ON" CHECKED >
																		<span class="BodyText">Edit Books</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_books" value="ON" CHECKED >
																		<span class="BodyText">Delete Books</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="view_images" value="ON" CHECKED >
																		<span class="BodyText">View Images</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="add_images" value="ON" CHECKED >
																		<span class="BodyText">Add Images</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_images" value="ON" CHECKED >
																		<span class="BodyText">Delete Images</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="view_affiliates" value="ON" CHECKED >
																		<span class="BodyText">View Affiliates</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="add_affiliates" value="ON" CHECKED >
																		<span class="BodyText">Add Affiliates</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="edit_affiliates" value="ON" CHECKED >
																		<span class="BodyText">Edit Affiliates</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="delete_affiliates" value="ON" CHECKED >
																		<span class="BodyText">Delete Affiliates</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="view_newsletter" value="ON" CHECKED >
																		<span class="BodyText">View Newsletter</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_newsletter" value="ON" CHECKED >
																		<span class="BodyText">Delete Newsletter</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="export_newsletter" value="ON" CHECKED >
																		<span class="BodyText">Export Newsletter</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="view_polls" value="ON" CHECKED >
																		<span class="BodyText">View Polls</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="add_polls" value="ON" CHECKED >
																		<span class="BodyText">Add Polls</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="edit_polls" value="ON" CHECKED >
																		<span class="BodyText">Edit Polls</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_polls" value="ON" CHECKED >
																		<span class="BodyText">Delete Polls</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="poll_results" value="ON" CHECKED >
																		<span class="BodyText">Poll Results</span>
																	</td>
																</tr>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="view_comments" value="ON" CHECKED >
																		<span class="BodyText">View Comments</span
																	></td>
																	<td width="33%">
																		<input type="checkbox" name="approve_comments" value="ON" CHECKED >
																		<span class="BodyText">Approve Comments</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_comments" value="ON" CHECKED >
																		<span class="BodyText">Delete Comments</span>
																	</td>
																</tr>
															</table>
														</td>
                                                                ...
                                                                if($dbConn)
                                                                        {
																				...
																				$config_output = "sitedetails,users,articles,topics,news,personalContent,books,images,affiliates,newsletter,polls,comments,old_setup";
                                                                                ...
                                                                                $strQuery  = "INSERT INTO tbl_AdminLogins(pk_alId, alUserName, alPass, alEmail, alFName, alLName, alBio, alPic, alPermissions) ";
                                                                                $strQuery .= "VALUES(0, '$strUserId', '$strPass', '$strEmail', '$strFName', '$strLName', '$strBio', '$strBinPic', '$config_output')";
														...
														<td>
															<table width="100%" border="0">
																<?php
																	...
																	$publisherAccess = explode(",", $row['alPermissions']);

																?>
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="view_config" value="ON" <?php if(in_array("view_config", $publisherAccess)) { echo " CHECKED "; } ?>>
																		<span class="BodyText">Edit Config</span>
																	</td>
																	<td width="33%">
																...
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="view_privacy" value="ON" <?php if(in_array("view_privacy", $publisherAccess)) { echo " CHECKED "; } ?>>
																		<span class="BodyText">Privacy</span>
																	</td>
																	<td width="33%">
																...
																<tr>
																	<td width="33%">
																		<input type="checkbox" name="view_comments" value="ON" <?php if(in_array("view_comments", $publisherAccess)) { echo " CHECKED "; } ?>>
																		<span class="BodyText">View Comments</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="approve_comments" value="ON" <?php if(in_array("approve_comments", $publisherAccess)) { echo " CHECKED "; } ?>>
																		<span class="BodyText">Approve Comments</span>
																	</td>
																	<td width="33%">
																		<input type="checkbox" name="delete_comments" value="ON" <?php if(in_array("delete_comments", $publisherAccess)) { echo " CHECKED "; } ?>>
																		<span class="BodyText">Delete Comments</span>
																	</td>
																</tr>
															</table>
                                                                ...
                                                                if($dbConn)
                                                                        {
                                                                                ...
                                                                                if($chkUseCurrentPic == "")
                                                                                        { // We are uploading a new image
                                                                                          ...
                                                                                          $strQuery .= "    alPermissions = '$config_output' ";
