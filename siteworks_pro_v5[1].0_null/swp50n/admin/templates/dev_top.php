...
///////////////////////////////////////////////////////////////////////////////
    ...
    elseif($isSetup == "no" && !is_numeric(strpos($_SERVER["SCRIPT_NAME"], "setup.php")))
...
?>
        ...
        <head>
        <title><?php echo $appName; ?> :: The driving force behind <?php echo $siteName; ?>!</title>
                    ...
                    <td width="21%" bgcolor="#CECFCE" valign="top" rowspan="2" height="241">
                      <table border="0" width="100%" cellspacing="0" cellpadding="0" height="87">
                        <tr>
                          <td width="100%" bgcolor="#C7E5C7" valign="top">
                                ...
                                <?php if(!$accessLevel) { ?>
                                    ...
                                    <?php if(@in_array("view_config", $publisherAccess)) { ?>
                                        <tr>
                                                <td width="100%" bgcolor="#C6E7C6" valign="middle" height="21">
                                                        <p class="BodyText" style="margin-left:10; margin-right:10">
                        ...
                        if($accessLevel)
                        {
                                                ...
                                                if($accessLevel == 3 || in_array("about_us", $publisherAccess))
                                                {
                                                ?>
                                                        <tr>
                                                                <td width="100%" bgcolor="#C6E7C6" valign="middle" height="21">
                                                ...
                                                if($accessLevel == 3 || in_array("contact_us", $publisherAccess))
                                                {
                                                ?>
                                                        <tr>
                                                                <td width="100%" bgcolor="#C6E7C6" valign="middle" height="21">
                                                ...
                                                if($accessLevel == 3 || in_array("view_privacy", $publisherAccess))
                                                {
                                                ?>
                                                        <tr>
                                                                <td width="100%" bgcolor="#C6E7C6" valign="middle" height="21">
                                                ...
                                                ?>
                                                        <tr>
                                                                <td width="100%" bgcolor="#C6E7C6" valign="middle" height="21">
                                                                        <p class="BodyText" style="margin-left:10; margin-right:10">
                                                                                · <a href="personalcontent.php?strMethod=show2cents">Update "<?php echo $showMy2c; ?>"</a>
                                                                        </p>
                                                                </td>
                                                        </tr>
                                                <?php
                                                ...
                                                ?>
                                                        <tr>
                                                                <td width="100%" bgcolor="#C6E7C6" valign="middle" height="21">
                                                                        <p class="BodyText" style="margin-left:10; margin-right:10">
                                                                                · <a href="personalcontent.php?strMethod=showtip">Update <?php echo $showHandy; ?></a>
                                                                        </p>
                                                                </td>
                                                        </tr>
                                                <?php
                                                ...
                                                if($accessLevel == 3 || in_array("comments", $publisherAccess))
                                                {
                                                ?>
                                                        <tr>
                                                                <td width="100%" bgcolor="#8CD78C" valign="bottom" height="21">
                                                                        <p style="margin-left:10">
                                                                                <span class="MenuHeading">Comments</span>
                                                                        </p>
                                                                </td>
                                                        </tr>
                                                <?php
                                                }
                                                if($accessLevel == 3 || in_array("view_comments", $publisherAccess))
                                                {
                                                ?>
                                                        <tr>
                                                                <td width="100%" bgcolor="#C6E7C6" valign="middle" height="21">
