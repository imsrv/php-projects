<?
function sql_baglan() {
	@mysql_connect("localhost","oyunturk_toyun","123123");
	@mysql_select_db("oyunturk_oyun");
}
function sql_durdur() {
	@mysql_close();
}
...
function block_menu() {
	...
	echo '<a href="http://program.turkmania.com" target="_blank" class="ktgr">Program</a> - <br>'."\n";
	echo '<a href="http://haber.turkmania.com" target="_blank" class="ktgr">Haber</a> - <br>'."\n";
	echo '<a href="http://video.turkmania.com" target="_blank" class="ktgr">Video</a> - <br>'."\n";
}
function orta() {
