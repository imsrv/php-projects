...
$emb	= '<iframe src="http://www.seyret.us/wm/'.$veri['k_link'].'/'.$veri['v_link'].'/'.$veri['kod'].'>.html" name="frame" scrolling="No" width="400" height="300" marginwidth=0 marginheight=0 frameborder="No"></iframe>';
?>
</div>
</td>
</tr>
...
<input onfocus="this.select();" name="lnk" type="text" style="width: 570;color: #555555; font-size: 10px; font-family: Verdana; border: 1px solid #DDDDDD;"
	value="http://www.seyret.us/izle/<?=$veri['k_link'];?>/<?=$veri['v_link'];?>/<?=$veri['kod'];?>.html"><!--<br>
<b>Embed Kodu :</b><br>
