...
function depthtime(&$ppagegid,&$previd,&$currid,&$rtimes,$quantity,$prevtime,$vflag) {          // update aa_depthes
  global $err,$conf;
  //$previd['id']='id|hits|hosts|vt|v30|v7|v';   - "предыдущий массив"
  //$currid['id']='id|hits|hosts|vt|v30|v7|v';   - "текущий массив"
  //$ppagegid['id']='id|time|tlen|num|hits|hosts|vt|v30|v7|v';   - "посещенные группы"
  //$vflags=1/0;
  //$rtimes['id']=time;
