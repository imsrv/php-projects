...
' Send Email to Member 
	Set objMailMember = Server.CreateObject("CDONTS.NewMail")
...
'' Send Email to Admin
	...
	objMailAdmin.Body = Request.Form("EmailAddress") & " - has subscribed to mailing list - " & (preferences.Fields.Item("MailingListTitle").Value)
	objMailAdmin.Send()
...
'' Send Email to Admin
	...
	objMailAdmin.Body = Request.Form("EmailAddress") & " - has UNSUBSCRIBED from mailing list - " & (preferences.Fields.Item("MailingListTitle").Value)
	objMailAdmin.Send()
Set objMailAdmin = Nothing
%>
<% End If%>
