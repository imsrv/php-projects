# Mod Lycos MP3-1
sub Lycos_MP3_1 {my($title,$url,$description,$reliability,$date,$source_url,$source);
...
sub url_Lycos_MP3_1{return "http://music.lycos.com/default.asp?DA=0&QT=S&QW=$_[0]&MFI=10&MFS=&AID=";}
sub match_Lycos_MP3_1{return "1";}sub remove_garbage {my $html=shift;$html=~s/\|//g;$html=~s/\n/ /g;$html=~s/\r/ /g;$html=~s/\t//g;$html=~s/\f//g;$html=~s/\n\n//g;$html=~s/\r\r//g;$html=~s/^\s+//g;$html=~s/\s+$//g;$html=~s/\s+/ /g;$html;}$TOUT=3;
1;