...
$searchbannerhtml = ''; ## HTML from the 'searchresultsb.tpl' file.
$searchresultspage = ''; ## HTML from the 'searchresultsp.tpl' file.
$searchresultscat = ''; ## HTML from the 'searchresultsc.tpl' file.
$searchresultstopsite = ''; ## HTML from the 'searchresultst.tpl' file.
$searchresultssite = ''; ## HTML from the 'searchresultss.tpl' file.

$data = "searchindex"; ## System path to data folder
$programurl = "http://www.yourserver.com/cgi-bin"; ## URL of where the program is
$data_url = "http://www.yourserver.com/cgi-bin/searchindex"; ## URL of data folder
$maxcatshow = 10; ## Maximum number of categories to show per page
$maxsiteshow = 10; ## Maximum number of sites to show per page
$coolsitelogo = "COOL!"; ## HTML for coolsite logo
$nextresultslink = '<a href="::url::">Next Results</a>'; ## HTML for next results link
