...
echo '<div align="right"><font face="verdana" size="3"><b>'.$lPubliNews.'</b></font><br><font size="2"><a href="index.php">'.$lSommaire.'</a></font></div>';
...
$query = "INSERT INTO mcnews_news VALUES(NULL, '$date', '$titre', '$auteur', '', '$email', '$texte', '$lien1', '$descr1', '$lien2', '$descr2', '$lien3', '$descr3', 'Y')";
...
<tr>
<td bgcolor="<? echo $BodyBgcolor; ?>" colspan="2" align="center"><font face="<? echo $FontFace; ?>" size="<? echo $FontSizeTitre; ?>" color="<? echo $FontColorTitre; ?>">
         &nbsp;</font>
</td>
</tr>
<tr>
