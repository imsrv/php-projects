...
$LOCALE[WHOIS_Title] = "¡El perfil del usuario de MWChat!";

$LOCALE[WHOIS_No_Profile] = "No es un usuario registrado y tiene no perfil.";

$LOCALE[WHOIS_Not_Specified] = "No especificado";
