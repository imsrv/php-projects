...
$LOCALE[WHOIS_Title] = "Le profil d'utilisateur de MWChat!";

$LOCALE[WHOIS_No_Profile] = "N'est pas un utilisateur enregistré et n'a pas de profil.";

$LOCALE[WHOIS_Not_Specified] = "Pas spécifié";
