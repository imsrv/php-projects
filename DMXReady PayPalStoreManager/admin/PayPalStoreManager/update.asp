...
If (CStr(Request("MM_update")) = "update" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "Activated|value|ImageFileThumbValue1|value|ImageFileValue1|value|DateAdded|value|CategoryID|value|ItemName|value|ItemPriceValue1|value|ItemUOM|value|ItemDesc|value|txtContent|value"
  MM_columnsStr = "Activated|',none,''|ImageFileThumbValue1|',none,''|ImageFileValue1|',none,''|DateAdded|',none,NULL|CategoryIDkey|none,none,NULL|ItemName|',none,''|ItemPriceValue1|none,none,NULL|ItemUOM|',none,''|ItemDesc|',none,''|ItemMemo|',none,''"
    ...
    <td valign="top"> 
	  <form ACTION="<%=MM_editAction%>" METHOD="POST" name="update" id="update">
        <table width="100%" align="center" class="tableborder">
          ...
          <tr>
            <td width="10%" height="21" valign="middle" class="tableheader">Activated: </td> 
...
| <a href="/applications/PayPalStoreManager/inc_paypalstoremanager.asp?ItemID=<%=(rsItems.Fields.Item("ItemID").Value)%>&CategoryID=<%=(rsItems.Fields.Item("CategoryID").Value)%>" target="_blank">live preview</a> </p>
            </td>
            <td width="41%" rowspan="6" valign="top"><font color="#FF0000"><strong>*Save
                    your changes prior to uploading images</strong></font> <br>              
                    <table width="100%" border="0" cellping="3" cellspacing="1" class="tableborder">
              <% IF rsItems.Fields.Item("ImageFileThumbValue1").Value <> "" THEN %>
              <tr>
                <td width="27%" valign="middle"><strong>Thumbnail
                  Image:<br>
                  </strong>(displayed as 150 x 150)             </td>
                <td width="58%" height="36" valign="top"><%If instr(rsItems.Fields.Item("ImageFileThumbValue1").Value,"http") Then %>
      Using External Link:
        <%else%>
      Using Uploaded File:
      <%end if%>
      <input name="ImageFileThumbValue1" type="text" id="ImageFileThumbValue1" value="<%=(rsItems.Fields.Item("ImageFileThumbValue1").Value)%>" size="30">
      <br>
      To Edit, enter URL address to external image:http://www.website.com/images/image.gif
      OR <a href="javascript:;" onClick="MM_openBrWindow('file_upload.asp?filenum=1&amp;filetype=Image&amp;fileattribute=Thumb&amp;ItemID=<%=(rsItems.Fields.Item("ItemID").Value)%>','Image','width=300,height=150')">Upload
      Image to Server</a></td>
                <td width="15%">				<% if instr(rsItems.Fields.Item("ImageFileThumbValue1").Value,"http") Then %>
				<a href="javascript:;"><img src="<%=(rsItems.Fields.Item("ImageFileThumbValue1").Value)%>" alt="Click to Zoom" width="50" hspace="5" vspace="5" border="0" onClick="MM_openBrWindow('<%=(rsItems.Fields.Item("ImageFileThumbValue1").Value)%>','image','scrollbars=yes,width=500,height=500')"></a>
                    <%else%>
					<a href="javascript:;"><img src="../../applications/PayPalStoreManager/assets/images/<%=(rsItems.Fields.Item("ImageFileThumbValue1").Value)%>" alt="Click to Zoom" width="50" hspace="5" vspace="5" border="0" onClick="MM_openBrWindow('../../applications/PayPalStoreManager/assets/images/<%=(rsItems.Fields.Item("ImageFileThumbValue1").Value)%>','image','scrollbars=yes,width=500,height=500')"></a></a>
                    <% end if %>
                </td>
              </tr>
              <%else%>
              <tr bgcolor="#FFFF99">
                <td height="20" colspan="3" valign="middle"><strong><font color="#FF0000">Thumbnail
                      Size Image Required </font></strong>:                  
                    <a href="javascript:;" onClick="MM_openBrWindow('file_upload.asp?filenum=1&amp;filetype=Image&amp;fileattribute=Thumb&amp;ItemID=<%=(rsItems.Fields.Item("ItemID").Value)%>','Image','width=300,height=150')"> Upload
                  Image  to Server </a>&nbsp; OR &nbsp;<a href="javascript:;" onClick="MM_openBrWindow('file_link.asp?filenum=1&filetype=Image&amp;fileattribute=Thumb&ItemID=<%=(rsItems.Fields.Item("ItemID").Value)%>','File','width=300,height=150')">Link
                  to External Image Source</a> <br> 
                  (thumbnail image display size = 150 x 150)</td>
                </tr>
              <%end if%>
            </table>
              <br>
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
                <% IF rsItems.Fields.Item("ImageFileValue1").Value <> "" THEN %>
                <tr>
                  <td width="27%" valign="middle"><strong>Large Size
                      Image:<br>
                  </strong>(displayed as 500 x 500)                  </td>
                  <td width="57%" height="36" valign="top"><%If instr(rsItems.Fields.Item("ImageFileValue1").Value,"http") Then %>
      Using External Link:
        <%else%>
      Using Uploaded File:
      <%end if%>
      <input name="ImageFileValue1" type="text" id="ImageFileValue1" value="<%=(rsItems.Fields.Item("ImageFileValue1").Value)%>" size="30">
      <br>
      To Edit, enter URL address to external image:http://www.website.com/images/image.gif
      OR <a href="javascript:;" onClick="MM_openBrWindow('file_upload.asp?filenum=1&amp;filetype=Image&amp;ItemID=<%=(rsItems.Fields.Item("ItemID").Value)%>','Image','width=300,height=150')">Upload
      Image to Server</a></td>
                  <td width="16%">
				<% if instr(rsItems.Fields.Item("ImageFileValue1").Value,"http") Then %>
				<a href="javascript:;"><img src="<%=(rsItems.Fields.Item("ImageFileValue1").Value)%>" alt="Click to Zoom" width="50" hspace="5" vspace="5" border="0" onClick="MM_openBrWindow('<%=(rsItems.Fields.Item("ImageFileValue1").Value)%>','image','scrollbars=yes,width=500,height=500')"></a>
                    <%else%>
                    <a href="javascript:;"><img src="../../applications/PayPalStoreManager/assets/images/<%=(rsItems.Fields.Item("ImageFileValue1").Value)%>" alt="Click to Zoom" width="50" hspace="5" vspace="5" border="0" onClick="MM_openBrWindow('../../applications/PayPalStoreManager/assets/images/<%=(rsItems.Fields.Item("ImageFileValue1").Value)%>','image','scrollbars=yes,width=500,height=500')"></a></a>
                    <% end if %>
                  </td>
                </tr>
                <%else%>
                <tr bgcolor="#FFFF99">
                  <td height="20" colspan="3" valign="middle"><strong><font color="#FF0000">Large
                        Size Image
                        Required </font></strong>:                         <a href="javascript:;" onClick="MM_openBrWindow('file_upload.asp?filenum=1&amp;filetype=Image&amp;ItemID=<%=(rsItems.Fields.Item("ItemID").Value)%>','Image','width=300,height=150')"> Image
                      Uploaded to Server </a>&nbsp; OR &nbsp;<a href="javascript:;" onClick="MM_openBrWindow('file_link.asp?filenum=1&filetype=Image&ItemID=<%=(rsItems.Fields.Item("ItemID").Value)%>','File','width=300,height=150')">Link
                  to External Image Source</a><br>
                  (large  image displayed size = 500 x 500)</td>
                </tr>
                <%end if%>
              </table>
</td>
          ...
          <tr>
            <td width="10%" valign="middle" class="tableheader">Category: </td>
...
%>
          ...
          <tr>
            <td valign="middle" class="tableheader">Item Name:</td>
            <td colspan="3" valign="middle"><input name="ItemName" type="text" id="ItemName" value="<%=(rsItems.Fields.Item("ItemName").Value)%>" size="70"></td>
          </tr>
          <tr>
            <td valign="middle" class="tableheader">Item Price:</td>
            <td width="11%" valign="middle"><input name="ItemPriceValue1" type="text" id="ItemPriceValue1" value="<%=(rsItems.Fields.Item("ItemPriceValue1").Value)%>" size="10"> 
            </td>
            <td width="10%" valign="middle"><div align="right">Unit Of Measure:</div></td>
            <td width="28%" valign="middle"><select name="ItemUOM" id="ItemUOM">
            <option value="Unit" <%If (Not isNull((rsItems.Fields.Item("ItemUOM").Value))) Then If ("Unit" = CStr((rsItems.Fields.Item("ItemUOM").Value))) Then Response.Write("SELECTED") : Response.Write("")%>>Unit</option>
          ...
          <tr>
            <td width="10%" valign="middle" class="tableheader"> Item Description:</td>
          ...
          <tr>
            <td valign="middle" class="tableheader">Additional Item Details:</td>
