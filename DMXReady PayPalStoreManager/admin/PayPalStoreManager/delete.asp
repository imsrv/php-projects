...
if (CStr(Request("MM_delete")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "list.asp?action=update"
...
deletelistitem.ActiveConnection = MM_paypalstoremanager_STRING
deletelistitem.Source = "SELECT *  FROM tblItems  WHERE ItemID = " + Replace(deletelistitem__MMColParam, "'", "''") + ""
