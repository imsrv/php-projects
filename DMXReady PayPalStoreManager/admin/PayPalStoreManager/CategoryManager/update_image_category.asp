...
If (CStr(UploadFormRequest("MM_update")) <> "" And CStr(UploadFormRequest("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "CategoryImageFile|value"
  MM_columnsStr = "CategoryImageFile|',none,''"
...
Category.ActiveConnection = MM_paypalstoremanager_STRING
...
<html>
<head>
<title>Catalog Category Manager</title>
...
<form ACTION="<%=MM_editAction%>" METHOD="post" enctype="multipart/form-data" name="form1" onSubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','');return document.MM_returnValue" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="tableborder">
    <tr>
    <td height="28" colspan="2"><strong><font size="2">Update: <%=(Category.Fields.Item("CategoryValue").Value)%></font></strong></td>
    </tr>
    <tr>
      <td width="2%" nowrap>&nbsp;</td>
      <td width="98%" valign="baseline"> 
        <input name="CategoryImageFile" type="file" onChange="checkOneFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','')">
      </td>
    </tr>
    <tr>
      <td align="right" valign="baseline" nowrap>&nbsp;</td>
      <td valign="baseline"><input name="submit" type="submit" value="Save"></td>
    </tr>
  </table>
