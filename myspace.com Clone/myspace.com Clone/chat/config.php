...
/** MySQL Configuration */
$database = "alstraso_efr";	// MySQL database name
$dbuser = "alstraso_efr";	// MySQL username
$dbpass = "efr";	// MySQL password
$host = "localhost";		// MySQL host name

$moderatorPassword = "admin123";	// to login as a moderator
$spyPassword = "admin123";		// to login as a spy (disabled when using XOOPS)
