  ...
  <tr>
    <td> 
      <table width="480" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td colspan="2" class="caption"><u><? echo $date . " at " . $time; ?></u></td>
              </tr>
              <tr> 
                <td width="195" height="25" class="bold">&nbsp;</td>
              ...
              <?php } ?>
              <tr> 
                <td height="20" class="bold">&nbsp;Event Title :</td>
                <td height="20" class="body"> 
                  <?=$info->event_title?>
                </td>
              </tr>
              <tr> 
                <td height="20" class="bold">&nbsp;Created by :</td>
                <td height="20" class="body"> 
                  <?=show_online($info->event_mem);?>
                </td>
              </tr>
              <tr> 
                <td height="20" class="bold">&nbsp;Date :</td>
                <td height="20" class="body"> <? echo $date . " at " . $time; ?> 
                </td>
              </tr>
              <tr> 
                <td height="20" class="bold">&nbsp;Duration :</td>
              ...
              <tr> 
                <td height="20" class="bold">&nbsp;Priority :</td>
                <td height="20" class="body"> 
                  <?=$info->event_priority?>
                </td>
              </tr>
              <tr> 
                <td height="20" class="bold">&nbsp;Access :</td>
                <td height="20" class="body"> 
                  <?=$info->event_access?>
                </td>
              </tr>
              <tr> 
                <td height="20" class="bold">&nbsp;Participants :</td>
                <td height="20" class="body"> 
                  <?=$info->event_part?>
                </td>
              </tr>
              <tr> 
                <td height="20" class="bold">&nbsp;Updated :</td>
                <td height="20" class="body"> 
