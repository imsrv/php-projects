  ...
  <tr>
    <td>  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr align="center" valign="middle"> 
          <td width="82" height="25" align="left" valign="bottom"><font size="-1"><b>&nbsp;&nbsp;<a href="calendar.php?mode=week&wee=<?=date ("n/j/Y", mktime(0,0,0,$month,$date-7,$year))?>&done=done"><< 
            Previous</a></b></font></td>
          <td class="datehead"><? echo date ("F d, Y", mktime(0,0,0,$month,$date,$year)); ?> 
            - <? echo date ("F d, Y", mktime(0,0,0,$month,$date+6,$year)); ?></td>
          <td width="58" height="25" align="right" valign="bottom"><font size="-1"><b><a href="calendar.php?mode=week&wee=<?=date ("n/j/Y", mktime(0,0,0,$month,$date+7,$year))?>&done=done">Next 
            >></a>&nbsp;&nbsp;</b></font></td>
        </tr>
        <tr> 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td> <form name="form1" method="post" action="calendar.php">
                      ...
                      <td align="right"> <form name="form2" method="post" action="calendar.php">
...
function even($date,$month,$year,$i)	{
	$query = "SELECT * FROM calendar_events WHERE event_day='$date' and event_month='$month' and event_year='$year'";
...
function even_col($date,$month,$year,$db_table,$i)	{
	$query = "SELECT * FROM $db_table WHERE event_day='$date' and event_month='$month' and event_year='$year'";
	$query_result = mysql_query ($query);
	$row	=	mysql_fetch_object($query_result);
	if($row->event_time == $i)	{
