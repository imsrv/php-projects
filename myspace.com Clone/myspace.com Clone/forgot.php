...
<tr><td colspan="2" align=center>Enter e-mail, which you used to register.</td>
<tr><td align=right width=40%>E-mail</td><td align=left><input type="text" size="20" name="email" class="textfield"></td>
<tr><td>&nbsp</td><td align=left><input type="submit" class="textfield" name="Submit" value="Go"></td>
</form>
</table>
<?
show_footer();
