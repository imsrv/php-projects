...
<? if(($mode='listings_manager')&&($act=='edi')) {?>
...
function photo_album($mem_id,$page,$mod){
    ...
    for($i=$start;$i<$end;$i++){
        ...
        <tr><td><a href='index.php?mode=photo_album&act=view&pho_id=$i&p_id=$mem_id'><img src='$photos[$i]' border=0></a></td>
        <tr><td align=center>$captures[$i]</td>";
        if($mod=='edi'){
          echo "<tr><td align='center'><a href='index.php?mode=photo_album&act=del&pho_id=$i'>Delete</a></td>";
        }
        echo "</table></td>";
