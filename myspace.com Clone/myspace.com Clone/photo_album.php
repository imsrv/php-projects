...
?>
            ...
            <table width=100% class='body'>
              <tr><td class="lined title"><? echo name_header($p_id,$m_id); ?>'s Photo Album</td>
              <tr><td class="lined"><table align=center class='body'>
              <? photo_album($p_id,"$page",''); ?>
              </table></td>
              <tr><td class=lined align=center><? pages_line($p_id,"photo_album","$page","10"); ?></td>
            </table>
<?
  show_footer();
}//if
...
$m_id=cookie_get("m_id");
    ...
    <tr><td class='lined title'>".name_header($p_id,$m_id)."</td>
    <tr><td class='lined'>";
    echo "<table align=center class='body'>
    <tr><td><img src='$photos[$pho_id]' border=0></td>
    <tr><td align=center>$captures[$pho_id]</td>
    </table></td></table>";
    show_footer();
...
?>
            ...
            <table width=100% class='body'>
              <tr><td class="lined title"><? echo $name->name; ?> Photo Album</td>
              <tr><td class="lined"><table align=center class='body'>
...
$sql_query="select name from tribes where trb_id='$trb_id'";
  $name=sql_execute($sql_query,'get');
    ...
    show_header();
    echo "<table width=100% class='body'>
    <tr><td class='lined title'>".$name->name."</td>
    <tr><td class='lined'>";
    echo "<table align=center class='body'>
    <tr><td><img src='$photos[$pho_id]' border=0></td>
    <tr><td align=center>$captures[$pho_id]</td>
