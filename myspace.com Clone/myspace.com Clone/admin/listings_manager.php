   ...
   <table class='body' width=100% cellpadding=10 cellspacing=1>
        ...
        $start=($page-1)*20;
          ...
          echo "<form action='admin.php' method=post>
           ...
           <tr><td>Select</td><td>Title</td><td>Listing</td><td>Lister</td><td>Category</td>";
          ...
          echo "<tr><td colspan=5 align=center class='lined'>";pages_line("$adsess","ad_listings","$page","20"); echo "</td>";
