...
?>
   ...
   <?
      ...
      <tr><td>Select</td><td>Posts</td><td>Forum Creator</td><td>Type</td><td>Category</td>";
...
?>
   ...
   <tr><td class='lined padded-6' align=left>
   <form action='admin.php' method=post>
   <input type='hidden' name='mode' value='forums_manager'>
   <input type='hidden' name='act' value='c_add'>
   <input type='hidden' name='adsess' value='<? echo $adsess; ?>'>
   Name : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=text name='new_cat'><br>Description : <input type=text name='new_cat_desc'>&nbsp<input type=submit value='Add New Category'>
   </td></form>
   <tr><td class='lined padded-6'>
