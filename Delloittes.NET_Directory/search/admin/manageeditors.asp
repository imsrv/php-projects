...
<!--#include file="includes/manageeditorsfunctions.asp"-->
...
<html>
<head>
	<title>deloittes.NET Directory - Manage Editors</title>
...
Header()
DrawModifyProfileForm request.querystring("id")
ElseIf Request.Querystring("action") = "update" then
UpdateProfile()
Header()
ShowConfirmation "User Details Updated."
ShowUsers()
