...
<!--#include file="includes/newcatfunctions.asp"-->
...
<html>
<head>
	<title>deloittes.NET Directory - Create New Category</title>
...
Header()
ShowNewCategoryForm()
elseif request.querystring("action") = "addcategory" then
Header()
AddCategory()
end if
