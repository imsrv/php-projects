...
<tr> 
<td bgcolor="{T_TD_COLOR2}"><img src="templates/aqua/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
</tr>
</table>
</td>
</tr>
...
<!-- BEGIN listrow -->
<tr> 
<td class="{listrow.ROW_CLASS}" width="5%" align="center" valign="middle"><img src="{listrow.PRIVMSG_FOLDER_IMG}" width="17" height="17" alt="{listrow.L_PRIVMSG_FOLDER_ALT}" title="{listrow.L_PRIVMSG_FOLDER_ALT}" /></td>
...
<tr> 
<td class="row1" colspan="5" height="28" align="right"> {S_HIDDEN_FIELDS} 
...
<td align="center"><b><span class="gensmall"><a href="javascript:select_switch(true);" class="gensmall">{L_MARK_ALL}</a> :: <a href="javascript:select_switch(false);" class="gensmall">{L_UNMARK_ALL}</a></span></b></td>
