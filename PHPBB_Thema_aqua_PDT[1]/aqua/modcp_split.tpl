...
<td width="33%" height="22" align="center"><span class="aquawords">{L_SPLIT_TOPIC}</span></td>
...
<tr> 
<td class="row2" colspan="3" align="center"><br><span class="gensmall">{L_SPLIT_TOPIC_EXPLAIN}</span></td>
</tr>
<tr> 
...
<tr> 
<td valign="middle"><img src="templates/aqua/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: 
...
<tr> 
<td colspan="3" height="1" class="row3"><img src="templates/aqua/images/spacer.gif" width="1" height="1" alt="."></td>
</tr>
<!-- END postrow -->
<tr> 
<td colspan="3"> 
