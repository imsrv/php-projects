...
<table class="forumline" width="90%" cellspacing="0" cellpadding="3" border="0" align="center">
<tr> 
...
<tr>
<td valign="middle" nowrap="nowrap" align="right"><span class="gen">{L_WEBSITE}:</span></td>
<td class="row1" valign="middle"><span class="gen">{WWW_IMG}</span></td>
</tr>
<tr> 
