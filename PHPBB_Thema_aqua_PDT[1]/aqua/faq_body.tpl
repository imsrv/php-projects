...
<td width="33%" height="22" align="center"><span class="aquawords">{L_FAQ_TITLE}</span></td>
...
<!-- BEGIN faq_block -->
<table class="forumline" width="90%" cellspacing="0" cellpadding="4" border="0" align="center">
<tr> 
<td class="aqua2" height="30" align="center"><span class="cattitle">{faq_block.BLOCK_TITLE}</span></td>
</tr>
<!-- BEGIN faq_row -->  
<tr> 
