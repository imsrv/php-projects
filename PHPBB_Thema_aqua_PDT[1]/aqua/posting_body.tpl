...
<tr align="center"> 
<td width="129" height="35" align="left"><img src="templates/aqua/images/aquaxul.gif" width="129" height="35"></td>
<td height="35" align="center" valign="bottom" background="templates/aqua/images/aquaxum.gif"><span class="aquawords">{L_POST_A}</span></td>
<td width="3" height="35" align="right"><img src="templates/aqua/images/aquaxur.gif" width="3" height="35"></td>
</tr>
</table>
...
<option style="color:black" value="{T_FONTCOLOR1}" class="genmed">{L_COLOR_DEFAULT}</option>
...
{POLLBOX} 
<tr> 
<td class="row1" colspan="2" align="center" height="25"> {S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="5" name="preview" class="mainoption" value="{L_PREVIEW}" />&nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" /></td>
</tr>
</table>
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="3" height="24" align="left"><img src="templates/aqua/images/aquaxdl.gif" width="3" height="24"></td>
    <td height="24" background="templates/aqua/images/aquaxdm.gif"><span class="gensmall">{S_TIMEZONE}</span></td>
    <td width="61" height="24" align="right"><img src="templates/aqua/images/aquaxdr.gif" width="61" height="24"></td>
  </tr>
</table>
</form>
