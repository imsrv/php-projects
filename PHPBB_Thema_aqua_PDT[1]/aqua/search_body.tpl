...
<form action="{S_SEARCH_ACTION}" method="POST"><table width="90%" cellspacing="0" cellpadding="0" border="0" align="center">
<tr> 
...
<tr> 
<td colspan="4" align="center" height="28">{S_HIDDEN_FIELDS}<input class="liteoption" type="submit" value="{L_SEARCH}" /></td>
</tr>
</table>
