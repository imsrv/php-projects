...
$title		= "phpListPro Install/Update-Tool V1.40<br><font face=arial size=2>Nullified by WTN Team `2000 - `2002";
...
#        echo "<form method=\"POST\" action=\"$PHP_SELF\"><input type=\"hidden\" name=\"action\" value=\"up1\"><input type=\"submit\" value=\"UPDATE DB from Version 1.xx to 1.20\"></form>";
    ...
    if ($action=="inst") {
        ...
        mysql_connect($server, $db_user, $db_pass) or die ("Database connect Error");
        echo "<b>phpListPro Database/Table install</b><br>Nullified by WTN Team `2000 - `2002";
	installdb();
        mysql_close();
