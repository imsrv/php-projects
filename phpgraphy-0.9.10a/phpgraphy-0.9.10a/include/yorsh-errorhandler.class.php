...
*
*  $Id: yorsh-errorhandler.class.php 130 2005-07-03 13:00:46Z jim $
*
*/
...
// Values defined for all variables here won't be set in PHP4, array will thoug .
    ...
    */
    ...
    function logError($errsev, $errstr, $errfile = null, $errline = null, $errcontext = null)
    {
        ...
        $errormsg=date("Y-m-d H:i:s")." ".$errsev." ".basename($errfile).":".$errline." ".$errstr."\n";
