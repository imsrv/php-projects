<?php
/* -----------------------------------------------------------------------------------------
   $Id: item.php,v 1.1 2003/09/06 21:54:34 fanta2k Exp $   
   ...
   (c) 2002-2003 osCommerce(item.php,v 1.5 2002/11/19); www.oscommerce.com 
...
define('MODULE_SHIPPING_ITEM_ALLOWED_TITLE' , 'Einzelne Versandzonen');
define('MODULE_SHIPPING_ITEM_ALLOWED_DESC' , 'Geben Sie <b>einzeln</b> die Zonen an, in welche ein Versand möglich sein soll. zb AT,DE');
