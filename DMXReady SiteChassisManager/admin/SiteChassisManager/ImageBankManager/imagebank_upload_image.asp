...
If (CStr(Request.QueryString("GP_upload")) <> "") Then
  ...
  pau_thePath = """../../../applications/SiteChassisManager/images"""
...
If (CStr(UploadFormRequest("MM_insert")) <> "") Then
  ...
  MM_fieldsStr  = "imagedesc|value|imagefile|value"

  MM_columnsStr = "ImageName|',none,''|ImageFile|',none,''"
...
list.ActiveConnection = MM_sitechassismanager_STRING

list.Source = "SELECT *  FROM tblImageBank"
...
<table width="100%" height="258" border="0" cellpadding="0" cellspacing="0" class="tableborder">
      ...
      <form ACTION="<%=MM_editAction%>" METHOD="post" enctype="multipart/form-data" name="form1" onSubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','');return document.MM_returnValue">
        ...
        <table align="center" width="100%">
          ...
          <tr valign="baseline"> 
            ...
            <td nowrap align="right" colspan="2" height="17" class="tableheader">Image 
          ...
          <tr valign="baseline"> 
            ...
            <td width="12%" align="right" nowrap class="tableheader">Image Name</td>

            <td width="88%" class="tablebody"> 

              <input name="imagedesc" type="text" value="">
          ...
          <tr valign="baseline"> 
            ...
            <td nowrap align="right" class="tableheader">Update Image:</td>

            <td class="tablebody"> 

              <input name="imagefile" type="file" onChange="checkOneFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','')" size="32">
          ...
          <tr valign="baseline"> 
            ...
            <td nowrap align="right" class="tableheader">&nbsp;</td>
...
End If
%>">
          <td><%=(list.Fields.Item("ImageName").Value)%></td>
          <td><%=(list.Fields.Item("ImageFile").Value)%></td>
          <td>            <% if list.Fields.Item("ImageFile").Value <> "" then %>
              <img src="../../../applications/SiteChassisManager/images/<%=(list.Fields.Item("ImageFile").Value)%>" width="50">
              <% end if %>
          </td><td><input name="Button" type="button" onClick="MM_goToURL('parent','imagebank_delete_image.asp?ImageID=<%=(list.Fields.Item("ImageID").Value)%>');return document.MM_returnValue" value="Delete">
          </td>
        </tr>
        <% 
...
%>
      ...
      <p align="center"><a href="closewindow_redirect.asp">CLOSE</a></p>
    </td>
