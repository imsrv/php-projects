...
If (Request.QueryString("mid")       <> "") Then 
  deletelistitem__MMColParam = Request.QueryString("mid")      
End If
%>
<%
...
deletelistitem.Source = "SELECT *  FROM tblSitePlanNavMenu  WHERE mid = " + Replace(deletelistitem__MMColParam, "'", "''") + ""
...
<input type="hidden" name="MM_recordId" value="<%= deletelistitem.Fields.Item("mid").Value %>">
</form>
<%
