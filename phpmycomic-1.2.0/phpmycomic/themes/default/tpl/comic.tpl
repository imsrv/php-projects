	...
	<tr><td class="topbar" align="left"><img src="{imgfolder}/bar_left.jpg"></td><td class="topbarhead" nowrap="nowrap">{lang_head_comic}</td><td class="topbar" align="right"><img src="{imgfolder}/bar_right.jpg"></td></tr><tr>
		<td class="windowborder" colspan="3">
			...
			<table cellpadding="1" cellspacing="1" class="inline">
	            ...
	            <INPUT TYPE="text" name="com_issue" class="passfield" value="{get_issue}">&nbsp;&nbsp;&nbsp;<INPUT TYPE="text" name="com_volume" class="passfield" value="{get_volume}">
	...
	<tr><td class="topbar" align="left"><img src="{imgfolder}/bar_left.jpg"></td><td class="topbarhead" nowrap="nowrap">{lang_head_artist}</td><td class="topbar" align="right"><img src="{imgfolder}/bar_right.jpg"></td></tr><tr>
		<td class="windowborder" colspan="3">
			...
			<table cellpadding="1" cellspacing="1" class="inline">
	            ...
	            <SELECT name="com_writer" class="formselect">
	            <!-- START BLOCK : addc_writer -->

	            <option{selected}>{pmc_writer}</option>

	            <!-- END BLOCK : addc_writer -->
	            </select>

	            </td></tr><tr><td width="60%" class="cell">{lang_type_penciler}</td>
	            <td width="40%" valign="middle" class="cell">
	
	            <SELECT name="com_penciler" class="formselect">
	            <!-- START BLOCK : addc_penciler -->
	
	            <option{selected}>{pmc_penciler}</option>
	
	            <!-- END BLOCK : addc_penciler -->
	            </select>
	
	            </td></tr><tr><td width="60%" class="cell">{lang_type_inker}</td>
	            <td width="40%" valign="middle" class="cell">
	
	            <SELECT name="com_inker" class="formselect">
	            <!-- START BLOCK : addc_inker -->
	
	            <option{selected}>{pmc_inker}</option>
	
	            <!-- END BLOCK : addc_inker -->
	            </select>
	
	            </td></tr><tr><td width="60%" class="cell">{lang_type_colorist}</td>
	            <td width="40%" valign="middle" class="cell">
	
	            <SELECT name="com_colorist" class="formselect">
	            <!-- START BLOCK : addc_colorist -->
	
	            <option{selected}>{pmc_colorist}</option>
	
	            <!-- END BLOCK : addc_colorist -->
	            </select>
	
				</td></tr><tr><td width="60%" class="cell">{lang_type_letterer}</td>
	            <td width="40%" valign="middle" class="cell">
	
	            <SELECT name="com_letterer" class="formselect">
	            <!-- START BLOCK : addc_letterer -->
	
	            <option{selected}>{pmc_letterer}</option>
	
	            <!-- END BLOCK : addc_letterer -->
	            </select>
	
	            </td></tr><tr><td width="60%" class="cell">{lang_type_cover}</td>
	            <td width="40%" valign="middle" class="cell">
	
	            <SELECT name="com_cover" class="formselect">
	            <!-- START BLOCK : addc_coverartist -->
	
	            <option{selected}>{pmc_coverartist}</option>
	
	            <!-- END BLOCK : addc_coverartist -->
	            </select>
...
<table class="window" cellspacing="0" cellpadding="0">
	<tr><td class="topbar" align="left"><img src="{imgfolder}/bar_left.jpg"></td><td class="topbarhead" nowrap="nowrap">{lang_head_other}</td><td class="topbar" align="right"><img src="{imgfolder}/bar_right.jpg"></td></tr><tr>
		<td class="windowborder" colspan="3">
			...
			<table cellpadding="1" cellspacing="1" class="inline">
				<tr><td width="60%" valign="middle" class="cell">{lang_quantity}</td>
				<td width="40% valign="middle" class="cell">
				
				<INPUT TYPE="text" name="com_qty" class="formfield" value="1">
	            ...
	            </td></tr><tr><td width="60%" valign="middle" class="cell">{lang_translator} (<i>{lang_translator_nfo}</i>)</td>
	            <td width="40%" valign="middle" class="cell">
	            ...
	            </td></tr><tr><td width="60%" valign="middle" class="cell">{lang_coverimage} (<i>{lang_coverimage_nfo}</i>)</td>
	            <td width="40%" valign="middle" class="cell">
