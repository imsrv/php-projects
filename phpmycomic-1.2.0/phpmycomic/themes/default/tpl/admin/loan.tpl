	...
	<tr><td class="topbar" align="left"><img src="{imgfolder}/bar_left.jpg"></td><td class="topbarhead" nowrap="nowrap">{lang_head_users}</td><td class="topbar" align="right"><img src="{imgfolder}/bar_right.jpg"></td></tr><tr>
		<td class="windowborder" colspan="3">
			...
			<table cellpadding="1" cellspacing="1" class="inline">
		        ...
		        <td width="25%" class="cellhead">{lang_loan_comic}</td>
		        <td width="25%" class="cellhead">{lang_loan_name}</td>
		        <td width="15%" class="cellhead">{lang_loan_date}</td>
		        <td width="10%" class="cellhead">{lang_loan_due}</td>
		        <td width="10%" class="cellhead">{lang_loan_notes}</td>
		        <td width="10%" class="cellhead">{lang_loan_option}</td></tr>
		        ...
		        <td width="15%" class="cell">{usr_mail}</td>
		        <td width="10%" class="cell">{usr_mail}</td>
