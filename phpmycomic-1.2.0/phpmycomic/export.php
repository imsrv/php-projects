...
$seriesname = str_replace(" ","_",$issue_title);
$seriesnamea = str_replace(":","",$seriesname);
$seriesnameb = str_replace("'","",$seriesnamea);
$seriesnamec = str_replace("-","",$seriesnameb);
 
$seriesnamed = mysql_real_escape_string($issue_title);

header('Content-type: text/richtext; charset=UTF-8');
header('Content-Length: '.strlen($backup) );
header("Content-Disposition: attachment; filename=$seriesnamec-$issue_number$issue_alpha.pmc");
