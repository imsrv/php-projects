...
<td width=5%>&nbsp;</td><td width=90%><center>&nbsp;</center></td><td width=5%>&nbsp;</td></tr><tr>
<td width=5%>&nbsp;</td>
...
<input type=\"text\" name=\"message\" Value=\"Hello everybody!\" size=20 class=\"box\"></td></tr></table></td>
<td width=5%>&nbsp;</td></tr><tr>

<td width=5%>&nbsp;</td><td width=90% align=\"right\"><input type=\"hidden\" name=\"chatlocale\" value=\"rm3\">
