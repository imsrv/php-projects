...
<FRAMESET ROWS=\"115,\*,60,45\">
        ...
        <FRAME SRC=$cgiurl/chatdocs/rm3/head.pl marginwidth=0 marginheight=0 scrolling=\"auto\" noresize frameborder=\"$chatroomborderyn\" border=$chatroombordersize bordercolor=$chatroombordercolor>
	<FRAME SRC=$cgiurl/chatdocs/rm3/rm3.pl marginwidth=0 marginheight=0 scrolling=\"auto\" noresize frameborder=\"$chatroomborderyn\" border=$chatroombordersize bordercolor=$chatroombordercolor>
