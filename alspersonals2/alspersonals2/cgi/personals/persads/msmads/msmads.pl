...
<td width=50>&nbsp;</td><td><br><font size=2 face=verdana><b>MEN SEEKING MEN</b></font><br><br></td>
<td>&nbsp;</td></tr></table>
...
opendir(DIR, "$persadscgidir/msmads/ads");
@docs=readdir(DIR);
closedir(DIR);
$numdocs=@docs;
$adnumdocs=$numdocs - 2;
...
open(IN, "$persadscgidir/msmads/ads/$doc");
@lines=<IN>;
close(IN);
$stlns = 250 * $adnumdocs;
$ttlns=@lines;
...
if($tlns > $end) {
print "<div align=\"center\"><b><a href=\"msmads.pl?begincthere=$end\">Next</a></b></div>\n";}

if($wherebeginct > 0) {
$prev = ($wherebeginct - $showthisnum);
print "<div align=\"center\"><b><a href=\"msmads.pl?begincthere=$prev\">Previous</a></b></div>\n";
}
