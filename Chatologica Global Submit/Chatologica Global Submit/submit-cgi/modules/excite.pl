...
%profile = (				# some basic information about this module
	'site_name' => 'Excite',			# site name
	'version' => '1',				# module version number
	'created_on' => '22 Apr 2000',			# date of creation
	'site_URL' => 'http://www.excite.com',	# url to the site
	'addurl_page' => 'http://www.excite.com/u?ft',	# AddURL page
	'host' => 'www.excite.com',			# remote host address
	'port' => '80',					# default remote port is 80
	'method' => 'post',				# POST or GET http method
	'remote_path' => '/cgi/add_url_new.cgi',		# path to the remote cgi script/page
);
...
,
 ...
 &get_best_match(\@options,'Other',@{$in{'all_keywords'}});
}
,
	'language' => eval{
 my @options = (
 ...
 &get_best_match(\@options,'Other',$in{'language'});
}
,
    );
    return \%variables;    
