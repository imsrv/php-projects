...
http://www.ddlnetwork.net/in.php?id=$ll[user]<br><br><b>This Information has been emailed you!</b><br><br>
...
<table>
  <td>";
		...
		while($row = mysql_fetch_array($get)) {
			...
			echo "<a href=\"ut.php?id=$row[id]\" target=\"_blank\">$row[title]</a><br>\n";
			$i++;
		}
		...
		while ($max >= $i) {
			...
			echo "<a href=\"join.php\" target=\"_blank\">Your Site Here?</a><br>\n";
			$i++;
		}
	}
}
