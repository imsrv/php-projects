...
If (CStr(Request.QueryString("GP_upload")) <> "") Then
  ...
  pau_thePath = """../../applications/BillboardManager/upload"""
  pau_Extensions = ""
  pau_Form = "form1"
  pau_Redirect = ""
  pau_storeType = "file"
...
If (CStr(UploadFormRequest("MM_update")) <> "" And CStr(UploadFormRequest("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "DownloadFile|value"
  MM_columnsStr = "DownloadFile|',none,''"
...
upload.ActiveConnection = MM_billboardmanager_STRING
upload.Source = "SELECT *  FROM Billboard  WHERE ItemID = " + Replace(upload__MMcolParam, "'", "''") + ""
upload.CursorType = 0
...
<form ACTION="<%=MM_editAction%>" METHOD="post" enctype="multipart/form-data" name="form1" onSubmit="checkFileUpload(this,'',true,'','','','','','','');return document.MM_returnValue">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
    <tr valign="baseline"> 
      ...
      <td width="96%"> Upload Docucument<strong>: <%=(upload.Fields.Item("ItemName").Value)%></strong></td>
    </tr>
    <tr valign="baseline"> 
      <td nowrap align="right" height="28">&nbsp;</td>
      <td height="28"> <input name="DownloadFile" type="file" id="DownloadFile" onChange="checkOneFileUpload(this,'',true,'','','','','','','')">
        </td>
    </tr>
    <tr valign="baseline"> 
