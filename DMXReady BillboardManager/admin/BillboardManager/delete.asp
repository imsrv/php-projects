...
if (Request.QueryString("ItemID")      <> "") then deletelistitem__MMColParam = Request.QueryString("ItemID")     
%>
<%
set deletelistitem = Server.CreateObject("ADODB.Recordset")
deletelistitem.ActiveConnection = MM_billboardmanager_STRING
deletelistitem.Source = "SELECT *  FROM Billboard  WHERE ItemID = " + Replace(deletelistitem__MMColParam, "'", "''") + ""
