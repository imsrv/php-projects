...
<table border="0" cellpadding="3" cellspacing="0" width="100%" class="forumline">
	...
	<!-- END switch_privmsg -->
	<tr> 
	  <td class="row1" width="22%" style="border-right:solid 1px #232323;"><span class="gen"><b>{L_SUBJECT}</b></span></td>
	  <td class="row2" width="78%"> <span class="gen"> 
		<input type="text" name="subject" size="45" maxlength="60" style="width:450px" tabindex="2" class="post" value="{SUBJECT}" />
		</span> </td>
	</tr>
	<tr> 
	  <td class="row1" valign="top" style="border-right:solid 1px #232323;"> 
	...
	<tr> 
	  <td class="row1" valign="top" style="border-right:solid 1px #232323;"><span class="gen"><b>{L_OPTIONS}</b></span><br /><span class="gensmall">{HTML_STATUS}<br />{BBCODE_STATUS}<br />{SMILIES_STATUS}</span></td>
