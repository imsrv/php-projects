...
<table class="forumline" width="100%" cellspacing="0" cellpadding="3" border="0">
	<tr align="right">
		<td style="border-style:none;" class="catHead" colspan="2" height="28"><span class="nav"><a href="{U_VIEW_OLDER_TOPIC}" class="nav">{L_VIEW_PREVIOUS_TOPIC}</a> :: <a href="{U_VIEW_NEWER_TOPIC}" class="nav">{L_VIEW_NEXT_TOPIC}</a> &nbsp;</span></td>
	</tr>
	{POLL_DISPLAY} 
	<tr>
	...
	<!-- BEGIN postrow -->
	<tr> 
		<td width="150" align="left" valign="top" class="{postrow.ROW_CLASS}" style="border-right:solid 2px #e0e0e0;"><span class="name"><a name="{postrow.U_POST_ID}"></a><b>{postrow.POSTER_NAME}</b></span><br /><span class="postdetails">{postrow.POSTER_RANK}<br />{postrow.RANK_IMAGE}{postrow.POSTER_AVATAR}<br /><br />{postrow.POSTER_JOINED}<br />{postrow.POSTER_POSTS}<br />{postrow.POSTER_FROM}</span><br /></td>
	...
	<tr> 
		<td class="{postrow.ROW_CLASS}" width="150" align="left" valign="middle" style="border-right:solid 2px #e0e0e0;"><span class="nav"><a href="#top" class="nav">{L_BACK_TO_TOP}</a></span></td>
