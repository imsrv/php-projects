...
<table class="forumline" width="100%" cellspacing="0" cellpadding="4" border="0">
	...
	<tr> 
		...
		<td class="row2"><span class="gen" style="font-size:13px;"><b>{GROUP_NAME}</b></span></td>
	</tr>
	<tr> 
...
<table width="100%" cellpadding="4" cellspacing="0" border="0" class="forumline">
	<tr> 
	  <td class="catSides" colspan="8" height="28" style="border-style:none;"><span class="cattitle">{L_GROUP_MODERATOR}</span></td>
	</tr>
	<tr> 
	...
	<tr> 
	  ...
	  <td class="row1" align="center" style="border-top:solid #232323 1px;">{MOD_WWW_IMG}</td>
	  <td class="row1" align="center"> &nbsp; </td>
	</tr>
	<tr> 
	  <td class="catSides" colspan="8" height="28" style="border-width:1px 0px 0px 0px;"><span class="cattitle">{L_GROUP_MEMBERS}</span></td>
	</tr>
	<tr> 
	  <th class="thCornerL" height="25">{L_PM}</th>
	  <th class="thTop">{L_USERNAME}</th>
