...
<table cellspacing="0" cellpadding="0" cellspacing="0" align="center" width="100%">
  <tr>
  ...
  <tr>
	<td align="center"> 
	  ...
	  <table width="175" cellspacing="0" cellpadding="2" border="1" class="bodyline">
		<tr> 
		  <td style="border-style:none;" colspan="3" width="175" class="row1" nowrap="nowrap"><span class="gensmall">{BOX_SIZE_STATUS}</span></td>
		</tr>
		<tr> 
		  <td colspan="3" width="175" class="row2">
			<table cellspacing="0" cellpadding="1" border="0">
			  <tr> 
				<td bgcolor="{T_TD_COLOR2}"><img src="templates/affiance/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
			  </tr>
			</table>
		  </td>
		</tr>
...
<table width="100%" align="center" cellpadding="2" cellspacing="0">
	<tr>
		<td class="pmtabL">{INBOX}</td>
		<td class="pmtab">{SENTBOX}</td>
		<td class="pmtab">{OUTBOX}</td>
		<td class="pmtabR">{SAVEBOX}</td>
	</tr>
</table>
