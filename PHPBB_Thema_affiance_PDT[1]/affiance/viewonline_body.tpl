...
<table width="100%" cellpadding="4" cellspacing="0" border="0" class="forumline">
  ...
  <tr> 
	<td class="catSides" colspan="3" height="28" style="border-width:1px 0px 0px 0px;"><span class="cattitle"><b>{TOTAL_REGISTERED_USERS_ONLINE}</b></span></td>
  </tr>
  <!-- BEGIN reg_user_row -->
  <tr> 
  ...
  <!-- END reg_user_row -->
  <tr> 
	<td colspan="3" height="1" class="row3"><img src="templates/affiance/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
  <tr> 
	<td class="catSides" colspan="3" height="28" style="border-width:1px 0px 0px 0px;"><span class="cattitle"><b>{TOTAL_GUEST_USERS_ONLINE}</b></span></td>
  </tr>
