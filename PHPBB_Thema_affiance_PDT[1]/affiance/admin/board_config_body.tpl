...
<form action="{S_CONFIG_ACTION}" method="post"><table width="99%" cellpadding="4" cellspacing="0" border="0" align="center" class="forumline">
	<tr>
...
<tr>
		<td class="row1">{L_ME01}</td>
		<td class="row2"><input class="post" type="text" name="me01" value="{ME01}" /></td>
	</tr>
	<tr>
		<td class="row1">{L_ME02}</td>
		<td class="row2"><input class="post" type="text" name="me02" value="{ME02}" /></td>
	</tr>
