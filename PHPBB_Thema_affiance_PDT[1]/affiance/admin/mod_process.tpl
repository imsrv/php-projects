...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline" width="100%">
	...
	<!-- BEGIN unprocessed -->
	<tr>
		<td class="{unprocessed.ROW_CLASS}" align="left" height=25><span class="gen">{unprocessed.LINE}</span></td>
	</tr>
	<!-- END unprocessed -->			
</table>
</td></tr></table>
...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline" width="100%">
	...
	<!-- BEGIN processed -->
	<tr>
		<td class="{processed.ROW_CLASS}" align="left" height=25><span class="gen">{processed.LINE}</span></td>
	</tr>
	<!-- END processed -->			
</table>
</td></tr></table>
