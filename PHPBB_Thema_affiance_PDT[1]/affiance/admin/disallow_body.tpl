...
<form method="post" action="{S_FORM_ACTION}"><table width="80%" cellspacing="0" cellpadding="4" border="0" align="center" class="forumline">
	<tr> 
		<th class="thHead" colspan="2">{L_ADD_DISALLOW}</th>
	</tr>
	<tr> 
		<td class="row1"><span class="gen">{L_USERNAME}</span><br /><span class="gensmall">{L_ADD_EXPLAIN}</span></td>
	...
	<tr> 
		<td class="row1"><span class="gen">{L_USERNAME}</span><br /><span class="gensmall">{L_DELETE_EXPLAIN}</span></td>
