...
<form method="post" action="{S_SMILEY_ACTION}"><table class="forumline" cellspacing="0" cellpadding="4" border="0" align="center">
	...
	<tr>
		<td class="row2"><span class="gen">{L_SMILEY_CODE}</span></td>
		<td class="row2"><input class="post" type="text" name="smile_code" value="{SMILEY_CODE}" /></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_SMILEY_URL}</span></td>
	...
	<tr>
		<td class="row2"><span class="gen">{L_SMILEY_EMOTION}</span></td>
