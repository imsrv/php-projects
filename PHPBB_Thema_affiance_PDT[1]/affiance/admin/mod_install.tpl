  ...
  <tr>
	...
	<td class="{unprocessed.ROW_CLASS}" align="center">
	  <table width="100%">
	    ...
	    <tr>
		<td align="center"><span class="gen"><a href="{unprocessed.MOD_URL}" class="gen" target="_blank">{unprocessed.MOD_URL}</a></span></td>
	    </tr>
	    <tr>
		<td align="center"><span class="gen">
<!--			<a href="{unprocessed.MOD_URL}" class="gen">{L_SUPPORT}</a></span> -->
		</td>
	    </tr>
	  </table>
	</td>
