...
<p><span class="gen">{GROUP_MEMBERSHIP}</span></p>
...
<p>{L_AUTH_EXPLAIN}</p>
  ...
  <table cellspacing="0" cellpadding="4" border="0" align="center" class="forumline">
	...
	<!-- BEGIN forums -->
	<tr> 
	  <td class="{forums.ROW_CLASS}" align="center"><span class="gen">{forums.FORUM_NAME}</span></td>
	  <!-- BEGIN aclvalues -->
	  <td class="{forums.ROW_CLASS}" align="center"><span class="gen">{forums.aclvalues.S_ACL_SELECT}</span></td>
	  <!-- END aclvalues -->
