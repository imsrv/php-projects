...
$sql0="select * from sbwmd_member_feedback where title<>''  ";
...
?>
          <tr bgcolor='<? if ($cnt%2==0) echo "#FFFFFF"; else echo "#EEEEEE"?>'> 
            ...
            <td width="30%"><strong><font color="#004080" size="1" face="Verdana, Arial, Helvetica, sans-serif"><? echo $rs_query["fname"];?><? echo " ".$rs_query["lname"];?>( <? $rs_t0=mysql_fetch_array(mysql_query("select username from sbwmd_members where id=".$rs_query["uid"])); echo $rs_t0[0];?> - <? echo $rs_query["email"]?> )</font></strong></td>
            ...
            <td width="10%"><font size="1"><font size="1"><a target=other href="viewmem_fb.php?id=<? echo $rs_query["id"];?>&pg=<? echo $pg; ?>"><font color="#0066ff" face="Verdana, Arial, Helvetica, sans-serif">View</font></a></font></font></td>
            <td width="14%"><font size="1"><font size="1"><a href="deletemem_fb.php?id=<? echo $rs_query["id"];?>&pg=<? echo $pg; ?>"><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif">Delete</font></a></font></font></td>
          </tr>
          <?
	  $cnt=$cnt+1;
	  $jmpcnt=$jmpcnt+1;
...
{
?>
                <a href="mem_feedback.php?pg=<? echo ($pg-1); ?>"> <font size="2"> 
                <?
}//end if
if ($pages<>1)
echo "Previous";
...
for ($i=1; $i<=$pages; $i++)
{
	...
	{
	?>
                <a href="mem_feedback.php?pg=<? echo $i;?>"> <font size="2"> 
                <?
 }//end if
?>
                <? echo $i; ?> 
