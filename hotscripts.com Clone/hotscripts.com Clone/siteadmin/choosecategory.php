...
<form action="choosecategory.php" method="post" name="frm123">
  <table width="400" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><font size="2" face="Arial, Helvetica, sans-serif"><strong>Choose Category</strong></font></td>
    </tr>
    <tr> 
...
if ($rs=mysql_fetch_array($rs_query))
  ...
  <table width="400" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <?php } ?>
      <td><font size="2" face="Arial, Helvetica, sans-serif"> <a href="choosecategory.php?box=<?php echo $_REQUEST["box"] ;?>&cid=<?php echo $rs_t["id"] ;?>"><?php echo $rs_t["cat_name"] ;?></a> 
        </font></td>
      <?php if ($cnt%2==0) { ?>
    </tr>
    <?php } ?>
