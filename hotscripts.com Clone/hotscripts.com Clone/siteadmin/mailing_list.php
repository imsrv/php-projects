...
$sql0="select * from sbwmd_mailing_list ";
...
<table width="700" border="0" align="center" cellpadding="5" cellspacing="0">
  ...
  <tr> 
    <td width="615" bgcolor="#FFFFFF"><font color="#666666" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Mailing 
      List </strong></font></td>
...
?>
          <tr bgcolor='<? if ($cnt%2==0) echo "#FFFFFF"; else echo "#EEEEEE"?>'> 
            ...
            <td width="28%"><strong><font color="#004080" size="1" face="Verdana, Arial, Helvetica, sans-serif"><? echo $rs_query["username"];?></font></strong></td>
            <td width="32%"><strong><font color="#004080" size="1" face="Verdana, Arial, Helvetica, sans-serif"><? echo $rs_query["useremail"];?></font></strong></td>
            <td width="10%"><font size="1"><font size="1"><a  href="email.php?id=<? echo $rs_query["useremail"];?>"><font color="#0066ff" face="Verdana, Arial, Helvetica, sans-serif">Email</font></a></font></font></td>
            <td width="14%"><font size="1"><font size="1"><a href="delete_mailinglist.php?id=<? echo $rs_query["id"];?>&pg=<? echo $pg; ?>"><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif">Delete</font></a></font></font></td>
          </tr>
          <?
	  $cnt=$cnt+1;
	  $jmpcnt=$jmpcnt+1;
...
{
?>
                <a href="mailing_list.php?pg=<? echo ($pg-1); ?>"> <font size="2"> 
                <?
}//end if
if ($pages<>1)
echo "Previous";
...
for ($i=1; $i<=$pages; $i++)
{
	...
	{
	?>
                <a href="mailing_list.php?pg=<? echo $i;?>"> <font size="2"> 
                <?
 }//end if
?>
                <? echo $i; ?> 
