...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;<%=(allcategories.Fields.Item("CategoryName").Value)%></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="30%">            <% if allcategories.Fields.Item("SubCategoryImageFile").Value <> "" then %>
              ...
              Image</a>
              <% end if ' image check %>
</td><td><a href="delete_subcategory.asp?scid=<%=(allcategories.Fields.Item("SubCategoryID").Value)%>">Delete </a>
            <%end if%>
</td>
        </tr>
      </table>
