...
If (CStr(Request.QueryString("GP_upload")) <> "") Then
  ...
  pau_thePath = """../../applications/CatalogManager/images"""
  pau_Extensions = ""
  pau_Form = "form1"
  pau_Redirect = ""
  pau_storeType = "file"
...
%>
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
          ...
          <tr>
            ...
            <td>
              <textarea name="ItemDescShort" cols="40" rows="3"></textarea>            </td>
          </tr>
        </table>
        <br>
      ...
      <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
        ...
        <tr>
          ...
          <td height="13" valign="baseline">
            <input name="ImageFile" onChange="checkOneFileUpload(this,'',false,'','','','','','','')" type="file" size="15">
            <br>
      (Display Size = 400 pixels x 400 pixels) </td>
          <td width="8%" class="tableheader"> <strong>Large Size</strong><br>
          </td>
          <td valign="baseline"><input name="ImageFile2" type="file" onChange="checkOneFileUpload(this,'',false,'','','','','','','')" size="15">
              <br>
      (Display Size = 400 pixels x 400 pixels)</td>
        </tr>
        <tr>
          ...
          <td height="13" valign="baseline"><input name="ImageFileThumb" type="file" id="ImageFileThumb3" onChange="checkOneFileUpload(this,'',false,'','','','','','','')" size="15">
              <br>
      (Display Size = 150 pixels x 150 pixels)</td>
          <td width="8%" class="tableheader"><strong>Thumbnail</strong><br>
          </td>
          <td valign="baseline"><input name="ImageFileThumb2" type="file" id="ImageFileThumb22" onChange="checkOneFileUpload(this,'',false,'','','','','','','')" size="15">
              <br>
      (Display Size = 150 pixels x 150 pixels)</td>
        </tr>
        <tr>
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
          <tr>
            ...
            <td width="74%">enter URL address 
              <input name="DownloadFile" type="file" id="DownloadFile3" onChange="checkOneFileUpload(this,'',false,'','','','','','','')" size="32">
              <br>
              or 
          ...
          <tr>
            ...
            <td>enter URL address
              <input name="DownloadFile2" type="file" id="DownloadFile23" onChange="checkOneFileUpload(this,'',false,'','','','','','','')" size="32">
              <br>
              or 
