...
<form method="POST" action="catalogpics.php">
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="4">
        ...
        <tr> 
          <td align="center"> 
            <p><input type="submit" name="Delpic" value="<?php print "$admin_yes"; ?>">&nbsp;
            <input type="submit" name="Delpic" value="<?php print "$admin_no"; ?>"></p>            
          </td>
        </tr>
      </table>
