...
$result = $db->getpicsbycatid($page,$record,$catid);
?>
<html>
<head>
          ...
          <td align="center"> 
	        ...
	        $cataname = $db->getcatalognamebyid($catalogid);
              ...
              <td><?php print "$picid"; ?></td>
                ...
                <td><a href="editcatapic.php?picid=<?php print "$picid"; ?>&catid=<?php print "$catid"; ?>" class="en_b"><?php print "$admin_edit"; ?></a></td>
                <td><a href="delcatapic.php?picid=<?php print "$picid"; ?>&catid=<?php print "$catid"; ?>" class="en_b"><?php print "$admin_del"; ?></a></td>                              
              </tr>
              <?php
              }
              }
            ...
            <?php
              $pagenext = $page+1;
		$result1 = $db->getpicsbycatid($pagenext,$record,$catid);
		if ($page!=0)
		{
		$pagepre = $page-1;		
