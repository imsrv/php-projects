...
$LANG21 = array(
    ...
    31 => "Fejl i PHP kasse. Funktionen, $function, findes ikke.",
...
#admin/word.php
$LANG_WORDS = array(
    editor => "Orderstatningseditor",
    wordid => "Ord ID",
    intro => "For at redigere eller slette et ord, skal du klikke på ordet. Vil du oprette et nyt ord, klik da på Nyt Ord knappen til venstre.",
    wordmanager => "Ord Manager",
    word => "Ord",
