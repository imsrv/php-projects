...
$LANG06 = array(
	1 => "Връзки",
	2 => "Няма никакви добавени връзки.",
	3 => "Добави сайт"
);
...
$LANG07 = array(
	1 => "Гласуването прието",
	2 => "Вашият глас е отчетен",
	3 => "Гласувай",
	4 => "Анкети в сайта",
	5 => "Гласове",
	6 => "Вижте другите анкети"
);
...
$LANG08 = array(
	...
	23 => "Този e-mail е изпратен за вас от $from at $fromemail заради породеният интерес от публикацията ви в {$_CONF["site_url"]}.  Това не е спам и дадения e-mail не е запазен в списък за по-нататъшна употреба.",
...
$LANG12 = array(
	...
	25 => "Вашите $type данни бяха запазени успешно.",
	26 => "Speed Limit",
	27 => "Име",
	28 => "Раздел",
	29 => "Публикация",
...
$LANG21 = array(
    ...
    31 => 'Грешка при PHP блока.  Функцията, $function, не съществува.',
...
$LANG23 = array(
	...
	11 => "Link мениджър",
	12 => "За да модифицирате или изтриете връзка кликнете върху нея долу. За да създадете нова кликнете на 'нова връзка' от горе.",
	13 => "Име на връзката",
	14 => "Категория",
	15 => "URL на връзката",
	16 => "Достъпът отказан",
	17 => "Опитвате се да влезете във връзка, до която нямате достъп. Този опит бе записан. Моля <a href=\"{$_CONF["site_admin_url"]}/link.php\">върнете се на администраторския екран</a>.",
	18 => 'Нова връзка',
	19 => 'Admin Home',
...
$LANG25 = array(
	1 => "Мод",
	2 => 'Моля напишете въпрос и поне един отговор.',
	3 => "Анкетата е създадена",
	4 => "Анкетата $qid запазена",
	5 => "Редактирай",
	6 => "Номер на анкетата",
	7 => "(не използвайте интервали)",
	8 => "Появява се на стартовата страница",
	9 => "Въпрос",
	10 => "Отговори / Гласове",
	11 => "Получи се грешка при разчитането на данните при отговорите за $qid",
	12 => "Получи се грешка при разчитането на данните при въпроса за $qid",
	13 => "Създай анкета",
	14 => "запази",
	15 => "откажи",
	16 => "изтрий",
	17 => 'Моля въведете номера на анкетата',
	18 => "Списък с анкетите",
	19 => "За да редактирате или изтриете дадена анкета, просто кликнете на нея.  За да създадете нова анкета кликнете по-горе на бутона 'нова анкета'.",
	20 => "Гласували",
	21 => "Достъпът отказан",
	22 => "Опитвате се да влезете в анкета, за която нямате достъп.  Това беше регистрирано и запазено. Моля <a href=\"{$_CONF["site_admin_url"]}/poll.php\">върнете се на администраторския екран</a>.",
	23 => 'Нова анкета',
	24 => 'Admin Home',
	25 => 'Да',
	26 => 'Не'
...
$LANG28 = array(
    ...
    30 => 'Import',
    31 => 'New Users',
    32 => 'Done proccessing. Imported $successes and encountered $failures failures',
    33 => 'submit',
