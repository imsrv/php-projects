...
define('BOX_AFFILIATE_BANNERS', 'Affiliate Links');
define('BOX_AFFILIATE_BANNERS_BANNERS', 'Banner Links');
define('BOX_AFFILIATE_BANNERS_BUILD', 'Build a Link');
define('BOX_AFFILIATE_BANNERS_PRODUCT', 'Product Links');
