...
&nbsp;&nbsp; - Press Only Once!! Submission May Take A While</td></tr></form></table>";
  ...
  function main($user) {
    ...
    If you have any difficulties or questions don't hesitate to contact me.<br><br>";
...
<a href=\"admin.php?go=stats&id=$row[id]\">Edit</a> | <a href=\"".$row[url]."\" target=\"_blank\">".$row[title]."</a> ($row[reports] ";
  ...
  function edit_blacklist() {
    ...
    <br>One url per line<br><b>Remeber to enter url with trailing slash at the end (example: http://www.kaoz.n0t/)</b></form>\n";
  }
}
?>