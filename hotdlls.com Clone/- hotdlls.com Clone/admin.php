...
<table border="0" cellspacing="0" cellpadding="0">
				<tr>
								<td valign="top" height="100%"><table border="0" cellspacing="0" cellpadding="0">
																<tr>
																				<td width="150" colspan="2" height="70"><img src="admin.gif" alt="QualityDDL.com" border="0"></td>
																</tr>
																<tr>
																				<td height="1" bgcolor="#F1F1F1" colspan="2"></td>
																</tr>
																<tr>
																				<td width="10" bgcolor="#F1F1F1"></td>
																				<td width="140" bgcolor="#F1F1F1" class="meny" valign="top" align="left"><table border="0" width="100%">
																												<tr>
																																<td width="100%"><a href="admin.php" class="meny"><font face="Verdana" size="1"><img border="0" src="shape.gif" align="left"><font color="#000000">Home</font></font></a></td>
																												</tr>
																												<tr>
																												...
																												<tr>
																																<td width="100%"><a href="admin.php?go=report" class="meny"><img border="0" src="shape.gif" align="left"><font color="#000000">Reported
																																												Links</font></a></td>
																												</tr>
																												<tr>
																																<td width="100%"><a href="admin.php?go=add" class="meny"><img border="0" src="shape.gif" align="left"><font color="#000000">Add
																																												Download</font></a></td>
																												</tr>
																												<tr>
																												...
																												<tr>
																																<td width="100%"><a href="admin.php?go=link&s=stats" class="meny"><img border="0" src="shape.gif" align="left"><font color="#000000">View/Edit
																																												Links</font></a></td>
																												</tr>
																												<tr>
																																<td width="100%"><a href="admin.php?go=link&s=add" class="meny"><img border="0" src="shape.gif" align="left"><font color="#000000">Add
																																												Link</font></a></td>
																												</tr>
																												<tr>
																												...
																												<tr>
																																<td width="100%"><a href="admin.php?go=email" class="meny"><img border="0" src="shape.gif" align="left"><font color="#000000">E-Mail
																																												Webmasters</font></a></td>
																												</tr>
																												<tr>
																																<td width="100%"><a href="admin.php?go=logout" class="meny"><img border="0" src="shape.gif" align="left"><font color="#000000">Log
																																												out</font></a></td>
																												</tr>
																								</table></td>
																</tr>
																<tr>
																				<td height="2" bgcolor="#C0C0C0" colspan="2"></td>
																</tr>
																<tr>
																...
																<tr>
																				<td></td>
																				<td><font color="#000000"> <small>2002 </font> DDLNetwork.net</td>
																</tr>
												</table></td>
								<td width="8"></td>
								<td valign="top"><br>
...
?>
												<table border="0" cellspacing="2" cellpadding="2">
																...
																<tr>
																				<td class="form2">Username: </td>
																				<td><input type="text" class="form" name="l[user]" size="20"></td>
																</tr>
																<tr>
																				<td class="form2">Password: </td>
																				<td><input type="password" class="form" name="l[pass]" size="20"></td>
																</tr>
																<tr>
																				<td></td>
																				<td><input type="Submit" value="Log In" class="form"></td>
																</tr>
												</table>
												<? } $e->close(); ?>
								</td>
