...
$lang['permissions_edit_success'] = "Berechtigungen erfolgreich aktualisert";
...
$setting['image_sort'] = "Aufsteigen/Absteigend";
...
$setting['badword_list'] = "Badword Liste<br /><span class=\"smalltext\">Wörter die zensiert werde sollen durch ein Leerzeichen getrennt eingeben (ohne Komma). Geben Sie hier das Wort \"test\" ein, werde alle Wortbestandteile die \"test\" enthalten zensiert. \"Attest\" wird zu \"At****\". Möchten sie das exakt erkannt wird, umschliessen sie das Wort mit geschweiften Klammern, z.B. {test}. Dann wird das Wort \"test\" zensiert, \"Attest\" aber nicht.</span>";
