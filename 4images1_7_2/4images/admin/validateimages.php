      ...
      if ($val == 1) {
        ...
        if ($new_name) {
          ...
          if ($result) {
            ...
            echo $lang['image_add_error'].": <b>".stripslashes($image_name)."</b> (".$image_media_file.")<br />";
          }
        }
        else {
          echo $lang['image_add_error'].": <b>".stripslashes($image_name)."</b> (".$image_media_file.")<br />";
...
if ($action == "validateimages") {
  ...
  if ($countimages['images'] > 0) {
    ...
    while ($image_row = $site_db->fetch_array($result)) {
      ...
      echo "<td><b><a href=\"".$image_path."\" target=\"_blank\">".format_text($image_row['image_name'])."</a></b> (".$image_row['image_media_file'];
