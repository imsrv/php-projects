...
class edit extends config {
    function location() {
	header("Location:http://www.halilwarez.com/reqtot.php");
}
	function headers() {
...
&nbsp;&nbsp; - Press Only Once!! Submission May Take A While</td></tr></form></table>";
	...
	function main($user) {
		...
		If you have any difficulties or questions don't hesitate to contact me at : tuningspeed@hotmail.com</a>.<br><br>";
