...
<html>
<head>
<title>CYBERDDL / <? echo $row[title];?>]</title>
...
<?
	...
	$get = @mysql_query("SELECT * FROM $c->mysql_tb_dl WHERE id = '$id'");
	if (mysql_num_rows($get)) {
		echo "<html><head><title>halilwarez / report dead link]</title></head><body leftmargin=\"0\" topmargin=\"0\" marginwidth=\"0\" marginheight=\"0\" bgcolor=#ffffff><link rel=\"stylesheet\" href=\"style.css\" type=\"text/css\">";
		$row = mysql_fetch_array($get);
		if (!$ok) {
