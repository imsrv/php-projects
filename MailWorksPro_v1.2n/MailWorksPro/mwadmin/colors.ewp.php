...
<script language="JavaScript">
	...
	function sendColor()
	{
		if(opener.document.all.__data<?php echo $ControlId; ?>.value == 'foreColor')
		{
			opener.iView<?php echo $ControlId; ?>.document.execCommand('foreColor', false, document.all.col.value);
			opener.iView<?php echo $ControlId; ?>.focus();
			window.close();
		}
		else if(opener.document.all.__data<?php echo $ControlId; ?>.value == 'backColor')
		{
			opener.iView<?php echo $ControlId; ?>.document.execCommand('backColor', false, document.all.col.value);
			opener.iView<?php echo $ControlId; ?>.focus();
			window.close();
		}
	}
...
<img src="ewp_images/colors.gif" border="0" usemap="#colorMap">
