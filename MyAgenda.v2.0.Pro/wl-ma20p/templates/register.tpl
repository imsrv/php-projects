...
<table border=0 cellpadding=1 cellspacing=0 width="400" align="center">
 <tr>
	<td><font class="text">{strSignup}</font></td>
 </tr>
</table>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
 <tr>
	...
	<td><input type="text" name="SURNAME" value="{SURNAME_value}"  size="25" maxlength="10"></td>
</tr><tr>
	...
	<td><input type="text" name="USERNAME" value="{USERNAME_value}" size="25" maxlength="10"></td>
</tr><tr>
	<td align="right"><b>{strPassword}</b> </td>
	<td><input type="password" name="PASSWORD" size="25" maxlength="10"></td>
</tr><tr>
	<td align="right"><b>{strPassword} ({strRepeate})</b> </td>
