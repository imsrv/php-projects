...
if ($_REQUEST['switch']=="bearbeiten") {
	...
	if ($_REQUEST['action']=="changefeld") {
		...
		$sql->Close();
		RenderPages();
		eLog("user", "$_SESSION[u_user] дndert Feld $_REQUEST[feld]");
	}	
...
<br> 
<input type="button" class="button" value="<<zurьck" onClick="location.href='rubrik.php?mode=edit&id=<?=$ed_id;?>&d4sess=<?=$sessid;?>'">
