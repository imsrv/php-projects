...
<table width="98%" border="0" cellpadding="0" cellspacing="1" bgcolor="#666666">
                    ...
                    <tr> 
                      ...
                      <td height="17" bgcolor="#ffffff" align="center"><a href="javascript:doin('d');" class="subnav">Einfьgen</a></td>
                    </tr>
                    <tr> 
                      <td height="17" bgcolor="#ffffff">&nbsp;{m}</td>
                      <td height="17" bgcolor="#ffffff">&nbsp;Monat</td>
                      <td height="17" bgcolor="#ffffff" align="center"><a href="javascript:doin('m');" class="subnav">Einfьgen</a></td>
                    </tr>
                    <tr> 
                      <td height="17" bgcolor="#ffffff">&nbsp;{y}</td>
                      <td height="17" bgcolor="#ffffff">&nbsp;Jahr</td>
                      <td height="17" bgcolor="#ffffff" align="center"><a href="javascript:doin('y');" class="subnav">Einfьgen</a></td>
                    </tr>        
                    <tr> 
                      <td height="17" bgcolor="#ffffff">&nbsp;{h}</td>
                      <td height="17" bgcolor="#ffffff">&nbsp;Stunde</td>
                      <td height="17" bgcolor="#ffffff" align="center"><a href="javascript:doin('h');" class="subnav">Einfьgen</a></td>
                    </tr> 
                    <tr> 
                      <td height="17" bgcolor="#ffffff">&nbsp;{i}</td>
                      <td height="17" bgcolor="#ffffff">&nbsp;Minute</td>
                      <td height="17" bgcolor="#ffffff" align="center"><a href="javascript:doin('i');" class="subnav">Einfьgen</a></td>
                    </tr>    
                    <tr> 
                      <td height="17" bgcolor="#ffffff">&nbsp;{s}</td>
                      <td height="17" bgcolor="#ffffff">&nbsp;Sekunde</td>
                      <td height="17" bgcolor="#ffffff" align="center"><a href="javascript:doin('s');" class="subnav">Einfьgen</a></td>
                    </tr>  
                    <tr> 
                      <td height="17" bgcolor="#ffffff">&nbsp;{u_name}</td>
                      <td height="17" bgcolor="#ffffff">&nbsp;Name des Redakteurs</td>
                      <td height="17" bgcolor="#ffffff" align="center"><a href="javascript:doin('u_name');" class="subnav">Einfьgen</a></td>
                    </tr>   
                    <tr> 
                      <td height="17" bgcolor="#ffffff">&nbsp;{u_user}</td>
                      <td height="17" bgcolor="#ffffff">&nbsp;Benutzername des Redakteurs</td>
                      <td height="17" bgcolor="#ffffff" align="center"><a href="javascript:doin('u_user');" class="subnav">Einfьgen</a></td>
                    </tr>                                                                                           
  </table>
                  <br>
