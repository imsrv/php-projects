...
<?  } if($_REQUEST['act']=="show"){
	...
	eLog("user", "$_SESSION[u_user]  lцscht Newskommentar");	
	}
...
Kommentar <br>
  ...
  <input type="reset" class="button" value="zurьcksetzen">
...
<tr>
        ...
        <br>
        <input name="Senden" type="submit" class="button" value="дndern">
...
eLog("user", "$_SESSION[u_user]  lцscht News ($_REQUEST[titel])");	
