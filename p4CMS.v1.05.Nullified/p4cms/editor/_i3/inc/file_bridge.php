        ...
        case "init":
                ...
                $filereturn = $HTTP_GET_VARS["filereturn"];
                        if($fp = fopen("../../".$filename,"r")) {
                                ...
                                echo "<script language=\"Javascript\">alert('Ошибка: Не могу открыть файл ".$filename.".');</script>";
                        }
                ...
                $filereturn = $HTTP_POST_VARS["filereturn"];
                        ...
                        if($fp = fopen($filename,"w+")) {
                                ...
                                if(fwrite($fp,$edited)) {
                                        ...
                                        echo "<script language=\"Javascript\">alert('Ошибка: Не могу записать в файл. Проверьте разрешение, файл должен иметь CHMOD 0777');</script>";
                                }
