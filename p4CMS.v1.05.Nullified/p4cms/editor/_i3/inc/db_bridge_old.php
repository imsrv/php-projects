                ...
                if($dbrecord == "") {
                        ...
                        if($db = mysql_connect($dbhost,$dbuser,$dbpass)) {
                                if(mysql_select_db($dbname,$db)) {
                                        ...
                                        } else { echo "<script language=\"Javascript\">alert('Ошибка: Cannot perform the query check name of the table, field, record number and name of autoincremented field.');</script>";
                                        }

                                } else {
                                        echo "<script language=\"Javascript\">alert('Ошибка: Не могу найти базу данных ".$dbname.".');</script>";
                                }

                        } else {
                                echo "<script language=\"Javascript\">alert('Ошибка: Не могу соединиться с базой данных, проверьте правильность указания имени и пароля.');</script>";
                        }
                        ...
                        if(mysql_select_db($dbname,$db)) {
                                ...
                                if($dbrecord == "") {
                                        ...
                                        if($query = mysql_query("INSERT INTO ".$dbtable." (".$dbfield.") VALUES ('".$edited."')",$db)) {
                                                ...
                                                echo "<script language=\"Javascript\">alert('Ошибка: Не могу создать новый отчет ...');</script>";
                                        }
                                        ...
                                        if($query = mysql_query("UPDATE ".$dbtable." SET ".$dbfield."='".$edited."' WHERE ".$dbai."=".$dbrecord."",$db)) {
                                                ...
                                                echo "<script language=\"Javascript\">alert('Ошибка: Не могу модернизировать ID=".$dbrecord." ...');</script>";
                                        }
                                }
