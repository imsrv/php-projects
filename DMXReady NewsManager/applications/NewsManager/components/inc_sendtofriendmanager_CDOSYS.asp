...
'Set the response buffer to false as we may need to pause while the e-mails are being sent
Response.Buffer = False
  theSchema="http://schemas.microsoft.com/cdo/configuration/" 
  Set cdoConfig=server.CreateObject("CDO.Configuration") 
  cdoConfig.Fields.Item(theSchema & "sendusing")= 2
  cdoConfig.Fields.Item(theSchema & "smtpserver")= "mail.yourdomain.com" ' use your smtp server name
  cdoConfig.Fields.Update 
Set sendmail = Server.CreateObject("CDO.Message")
sendmail.Configuration = cdoConfig 
