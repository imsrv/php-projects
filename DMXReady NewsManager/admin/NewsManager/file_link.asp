...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="FileForm" id="FileForm">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
    ...
    <tr>
      <td width="11%" height="14">Enter
        Label/Description of <%=filetype%> <br>
      </td>
      <td width="89%" height="14"><textarea name="FileLabel" rows="2" id="FileLabel"></textarea>
      </td>
    </tr>
    <tr>
      <td height="21"> Enter URL address
        to external <%=filetype%>:</td>
      <td height="21" valign="top">
        <input name="File" type="text" id="File" size="32">
      i.e. <font color="#FF0000">http://www.sample.com/page.zip</font> <input name="submit" type="submit" value="Save" onClick="CallJS('pbar()')"></td>
    </tr>
  </table>
