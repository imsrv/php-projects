...
If filetype = "Image" Then
  pau_thePath = """../../applications/assets/images"""
  pau_Extensions = "GIF,JPG,JPEG,BMP,PNG"
else 
  pau_thePath = """../../applications/assets/documents"""
  pau_Extensions = ""
End if 
  pau_Form = "FileForm"
  pau_Redirect = ""
...
If (CStr(UploadFormRequest("MM_update")) <> "" And CStr(UploadFormRequest("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "FileLabel|value|File|value"
  MM_columnsStr = filetype & "FileLabel" & filenum & "|',none,''|" & filetype & fileattribute & "File" & filenum & "|',none,''"
...
items.ActiveConnection = MM_newsmanager_STRING
items.Source = "SELECT *  FROM tblNM_News  WHERE ItemID = " + Replace(items__value1, "'", "''") + ""
items.CursorType = 0
...
<body>
<form ACTION="<%=MM_editAction%>" METHOD="post" enctype="multipart/form-data" name="FileForm" id="FileForm" onSubmit="checkFileUpload(this,'',true,'','','','','','','');return document.MM_returnValue">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
    <tr> 
      <td colspan="2" valign="baseline">Upload <%=filetype%>: <strong><%=(items.Fields.Item("ItemName").Value)%>&nbsp;</strong></td>
    </tr>
    <tr>
      <td width="4%" height="14" align="left"><%=filetype%> <br>
      Label or Description:</td>
      <td width="96%" height="14"><textarea name="FileLabel" rows="2" id="FileLabel"></textarea></td>
    </tr>
    <tr> 
      <td height="21" align="left"><%=filetype%> File</td>
      <td height="21" valign="baseline"> 
	  <input name="File" type="file">
	  	  </td>
    </tr>
    <tr> 
      <td align="right" valign="baseline">&nbsp;</td>
      <td valign="baseline"> <input name="submit" type="submit" value="Upload File" onClick="CallJS('pbar()')">
      </td>
    </tr>
  </table>
