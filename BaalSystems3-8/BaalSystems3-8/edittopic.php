<?php
include("common.php");
if ((session_is_registered("whossession") && (($_SESSION['who']) == "admin" || $_SESSION['who'] == "moderator"))) {
    if (!empty($_POST['sbm'])) {
        $sticky = 0;
        ...
        // print_r($_POST);
        header("location:subtopic.php?fid=" . $_POST['fid']);
    } else {
...
<FORM action=edittopic.php method=post name=y onsubmit="return check1form('All fields are required...')">
