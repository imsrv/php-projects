...
if (session_is_registered("whossession")) {
    if (($_SESSION['who']) == "user" || $_SESSION['who'] == "moderator") {
        if (!empty($_POST['title'])) {
            ...
            if ($sticky && $_SESSION['who'] == "moderator") {
            ...
            $detail = eregi_replace("<?php", "", $detail);
            $result = db_query("insert into {$tableprefix}tblforum(forumid,groupname,subject,authorname,detail,lastpost" . (($_SESSION['who'] == "moderator") ? ",sticky" : "") . ") values('" . intval($forumid) . "','" . $groupname . "','" . $subject . "','" . $author . "','" . $detail . "',SYSDATE()" . (($_SESSION['who'] == "moderator") ? ",'" . intval($sticky) . "'" : "") . ")");
            $result2 = db_query("insert into {$tableprefix}tblsubforum(forumid,subject,groupname,authorname,detail,dateposted" . (($_SESSION['who'] == "moderator") ? ",sticky" : "") . ") values('" . intval($forumid) . "','" . $subject . "','" . $groupname . "','" . $author . "','" . $detail . "',SYSDATE()" . (($_SESSION['who'] == "moderator") ? ",'" . intval($sticky) . "'" : "") . ")");
...
<FORM action=newtopic1.php method=post name=y
