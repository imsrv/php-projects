...
HTMLArea.Config = function () {
	...
	this.toolbar = [
		...
		[ "justifyleft", "justifycenter", "justifyright", "justifyfull", "separator",
		  ...
		  "copy", "cut", "paste", "space", "undo", "redo", "superscript" ]
		];
	...
	this.btnList = {
		bold: [ "Bold", "../images/wysiwyg/ed_format_bold.png", false, function(e) {e.execCommand("bold");} ],
		italic: [ "Italic", "../images/wysiwyg/ed_format_italic.png", false, function(e) {e.execCommand("italic");} ],
		underline: [ "Underline", "../images/wysiwyg/ed_format_underline.png", false, function(e) {e.execCommand("underline");} ],
		strikethrough: [ "Strikethrough", "../images/wysiwyg/ed_format_strike.png", false, function(e) {e.execCommand("strikethrough");} ],
		subscript: [ "Subscript", "../images/wysiwyg/ed_format_sub.png", false, function(e) {e.execCommand("subscript");} ],
		superscript: [ "Superscript", "../images/wysiwyg/ed_format_sup.png", false, function(e) {e.execCommand("superscript");} ],
		justifyleft: [ "Justify Left", "../images/wysiwyg/ed_align_left.png", false, function(e) {e.execCommand("justifyleft");} ],
		justifycenter: [ "Justify Center", "../images/wysiwyg/ed_align_center.png", false, function(e) {e.execCommand("justifycenter");} ],
		justifyright: [ "Justify Right", "../images/wysiwyg/ed_align_right.png", false, function(e) {e.execCommand("justifyright");} ],
		justifyfull: [ "Justify Full", "../images/wysiwyg/ed_align_justify.png", false, function(e) {e.execCommand("justifyfull");} ],
		insertorderedlist: [ "Ordered List", "../images/wysiwyg/ed_list_num.png", false, function(e) {e.execCommand("insertorderedlist");} ],
		insertunorderedlist: [ "Bulleted List", "../images/wysiwyg/ed_list_bullet.png", false, function(e) {e.execCommand("insertunorderedlist");} ],
		outdent: [ "Decrease Indent", "../images/wysiwyg/ed_indent_less.png", false, function(e) {e.execCommand("outdent");} ],
		indent: [ "Increase Indent", "../images/wysiwyg/ed_indent_more.png", false, function(e) {e.execCommand("indent");} ],
		forecolor: [ "Font Color", "../images/wysiwyg/ed_color_fg.png", false, function(e) {e.execCommand("forecolor");} ],
		hilitecolor: [ "Background Color", "../images/wysiwyg/ed_color_bg.png", false, function(e) {e.execCommand("hilitecolor");} ],
		inserthorizontalrule: [ "Horizontal Rule", "../images/wysiwyg/ed_hr.png", false, function(e) {e.execCommand("inserthorizontalrule");} ],
		createlink: [ "Insert Web Link", "../images/wysiwyg/ed_link.png", false, function(e) {e.execCommand("createlink", true);} ],
		insertimage: [ "Insert Image", "../images/wysiwyg/ed_image.png", false, function(e) {e.execCommand("insertimage");} ],
		inserttable: [ "Insert Table", "../images/wysiwyg/insert_table.png", false, function(e) {e.execCommand("inserttable");} ],
		htmlmode: [ "Toggle HTML Source", "../images/wysiwyg/ed_html.png", true, function(e) {e.execCommand("htmlmode");} ],
		popupeditor: [ "Enlarge Editor", "../images/wysiwyg/fullscreen_maximize.png", true, function(e) {e.execCommand("popupeditor");} ],
		about: [ "About this editor", "../images/wysiwyg/ed_about.png", true, function(e) {e.execCommand("about");} ],
		showhelp: [ "Help using editor", "../images/wysiwyg/ed_help.png", true, function(e) {e.execCommand("showhelp");} ],
		undo: [ "Undoes your last action", "../images/wysiwyg/ed_undo.png", false, function(e) {e.execCommand("undo");} ],
		redo: [ "Redoes your last action", "../images/wysiwyg/ed_redo.png", false, function(e) {e.execCommand("redo");} ],
		cut: [ "Cut selection", "../images/wysiwyg/ed_cut.png", false, cut_copy_paste ],
		copy: [ "Copy selection", "../images/wysiwyg/ed_copy.png", false, cut_copy_paste ],
		paste: [ "Paste from clipboard", "../images/wysiwyg/ed_paste.png", false, cut_copy_paste ]
	};
 ...
 *
 * 1. config.registerButton("my-hilite", "Hilite text", "my-hilite.png", false, function(editor) {...});
 * 2. config.registerButton({
 *      id       : "my-hilite",      // the ID of your button
 *      tooltip  : "Hilite text",    // the tooltip
 *      image    : "my-hilite.png",  // image to be displayed in the toolbar
