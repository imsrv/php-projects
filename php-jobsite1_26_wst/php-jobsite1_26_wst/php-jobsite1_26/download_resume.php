...
if ($HTTP_SESSION_VARS['sess_resume_id']) {
                    $resume_query = bx_db_query("select * from ".$bx_table_prefix."_resumes where ".$bx_table_prefix."_resumes.resumeid = '".$HTTP_SESSION_VARS['sess_resume_id']."'");
