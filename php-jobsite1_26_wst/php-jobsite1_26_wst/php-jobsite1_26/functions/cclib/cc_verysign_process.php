...
if ($HTTP_POST_VARS['todo'] == "proceed") {
    ...
    SQL_CHECK(0,"SQL Error at ".__FILE__.":".(__LINE__-1));
    ?>
    <form method="post" action="<?php echo VERISIGN_COM_URL;?>" name="frmcheckout">
        <input type="hidden" name="LOGIN" value="<?php echo VERISIGN_COM_ACCOUNT;?>">
        <input type="hidden" name="PARTNER" value="<?php echo VERISIGN_COM_PARTNER;?>">
