...
$fields = array (
        ...
        "order_number" => array("%%echoinc_order_number%%" , "Echo-inc.com Order Number", "12323234"),
        "order_status" => array("%%echoinc_order_status%%" , "Echo-inc.com Order Status", "This transaction has been approved"),		
...
$file_mail_subject = "Información de Factura";
$html_mail = "no";
