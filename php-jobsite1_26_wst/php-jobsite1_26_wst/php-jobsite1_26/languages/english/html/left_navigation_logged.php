<table width="100%" border="0" bgcolor="<?php echo LEFT_NAV_BG_COLOR;?>" cellspacing="0" cellpadding="0" height="100%">
  ...
  <tr><td height="18" valign="top">&nbsp;&nbsp;&nbsp;<a href="<?php echo bx_make_url(HTTP_SERVER.FILENAME_LOGOUT."?user=true", "auth_sess", $bx_session);?>" class="nav">&#171; <?php echo TEXT_LOGOUT;?></a></td></tr>
  <tr><td height="18" valign="top">
   ...
   <tr><td height="18" valign="top">
       &nbsp;&nbsp;&nbsp;<a href="<?php echo bx_make_url(HTTP_SERVER.FILENAME_DELACCOUNT."?jobseeker=true", "auth_sess", $bx_session);?>" class="nav">&#171; <?php echo TEXT_DELETE_ACCOUNT;?></a>
   </td></tr>
   <tr>
