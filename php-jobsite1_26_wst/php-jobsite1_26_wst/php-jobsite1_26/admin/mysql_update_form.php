...
if ($HTTP_POST_VARS['todo'] == "update") {
    ...
    elseif(ADMIN_BX_DEMO == "yes") {
        ...
        <table width="100%" cellspacing="0" cellpadding="2" border="0">
         <tr>
             <td bgcolor="#000000" align="center"><font face="Verdana, Arial" size="2" color="white"><b>Update database</b></font></td>
         </tr>
         <tr>
           <td bgcolor="#000000">
            <table border="0" width="100%" cellspacing="0" bgcolor="#00CCFF" cellpadding="2" align="center">
            <?php
        $have_sql = false;
        if(!empty($HTTP_POST_FILES['update_file']['tmp_name']) && $HTTP_POST_FILES['update_file']['tmp_name'] != "none" && ereg("^php[0-9A-Za-z_.-]+$", basename($HTTP_POST_FILES['update_file']['tmp_name'])))
        {
            ...
            $sql_query = bx_stripslashes($HTTP_POST_VARS['update_sql']);
            $have_sql = true;
        }
        else {
            $have_sql = false;
...
<tr>
        <td align="center"><font face="<?php echo TEXT_FONT_FACE;?>" size="<?php echo TEXT_FONT_SIZE;?>" color="<?php echo TEXT_FONT_COLOR;?>"><b><?php echo TEXT_UPLOAD_UPDATE_FILE;?>:</b></font>  <input type="file" name="update_file"></td>
</tr>
<tr>
        <td align="center"><font face="<?php echo TEXT_FONT_FACE;?>" size="<?php echo TEXT_FONT_SIZE;?>" color="<?php echo TEXT_FONT_COLOR;?>"><b><?php echo TEXT_UPDATE_SQL_QUERY;?>:</b></font></td>
</tr>
<tr>
