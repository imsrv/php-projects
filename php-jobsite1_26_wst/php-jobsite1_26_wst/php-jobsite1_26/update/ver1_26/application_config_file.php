...
############################################################
define('HTTP_SERVER','http://www.yourjobsite.com/');
define('HTTPS_SERVER','https://www.yourjobsite.com/');
define('HTTP_SERVER_ADMIN','http://www.yourjobsite.com/admin/');
define('DIR_SERVER_ROOT','/path/to/the/script/');

define('DB_SERVER_TYPE', 'mysql');
define('DB_SERVER','localhost');
define('DB_SERVER_USERNAME','mysql_user');
define('DB_SERVER_PASSWORD','mysql_password');
define('DB_DATABASE','phpjobsite');
...
define('INSTALLATION_DATE','2003-06-01');
