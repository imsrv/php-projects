<table width="100%" border="0" bgcolor="<?php echo LEFT_NAV_BG_COLOR;?>" cellspacing="0" cellpadding="0" height="100%">
  ...
  <tr><td height="18" valign="top">&nbsp;&nbsp;&nbsp;<a href="<?php echo bx_make_url(HTTP_SERVER.FILENAME_EMPLOYER, "auth_sess", $bx_session);?>" class="nav">&#171; <?php echo TEXT_HOME;?></a></td></tr>
  ...
  <tr><td valign="top" height="18">
   ...
   <tr><td height="18" valign="top">
       &nbsp;&nbsp;&nbsp;<a href="<?php echo bx_make_url(HTTP_SERVER.FILENAME_DELACCOUNT."?employer=true", "auth_sess", $bx_session);?>" class="nav">&#171; <?php echo TEXT_DELETE_ACCOUNT;?></a>
   </td></tr>
   <TR>
      <TD valign="top" height="18"><br>
       <?php include(DIR_FORMS."jobview_form.php");?>
	   <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr bgcolor="<?php echo LEFT_NAV_BG_COLOR?>"><td><?php echo bx_image_width(HTTP_IMAGES.$language."/pix-t.gif",1,1,0,"");?></td></tr></table>
       <?php include(DIR_FORMS."account_statistics_form.php");?>
      </TD>
   </TR>
