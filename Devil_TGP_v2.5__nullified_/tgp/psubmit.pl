...
my($add) = "INSERT INTO DMtgpgalleries VALUES('$webname','$affemail','$weburl','$webcate','$webpics','$webdesc','$date_today','$datecode','$approval','$newpid','$ip','$passwd','1','$isnow','$rating','1')";
