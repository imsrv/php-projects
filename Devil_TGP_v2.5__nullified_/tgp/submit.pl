...
my($add) = "INSERT INTO DMtgpgalleries VALUES('$webname','$webemail','$weburl','$webcate','$webpics','$webdesc','$date_today','$datecode','$approval','$newpid','$ip','$passwd','$vermail','$isnow','$rating','0')";
