<?php
	...
	if(isset($addEvent))
	{
		...
		if(mysql_query("INSERT INTO calendar_event (subject, detail, event_date, event_recur,  queue_flag) VALUES ('$subject', '$detail', '$time', '$event_recur','0')"))
			$success = true;
	}
?>
...
<tr><form action="addEvent.php" method="post" onSubmit="javascript: return checkForm();" name="eventForm">
	<td>
		...
		<tr><td colspan="3" align="center">
			...
			<br><br><input type="button" value="Close" onClick="javascript: window.opener.location.href = window.opener.location.href; self.close();"></td></tr>
		<?php }else{ ?>
		<tr>
