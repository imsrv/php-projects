<?php
	class miniCalendar
	{
		...
		function miniCalendar($link, $day = "", $month = "", $year = "")
		{
		...
		function buildMiniCalendar($height, $width, $selectedDayColor = "orange", $bgColor = "#eeeeee", $headerColor = "#0080ff")
		{
			...
			switch($this->month)
			{
				...
				case 2: $totalDaysInThisMonth = $this->isLeapYear ? 29 : 28; break;
			...
			$output .= "<tr height='20' valign='center'><td align='center'><a href='".$this->link."?hc=".urlencode($headerColor)."&bc=".urlencode($bgColor)."&sc=".urlencode($selectedDayColor)."&d=$pday&m=$pmonth&y=$pyear' class='navi'><img src='./_pic/left_arrow.gif' border='0'></a></td><td align='center' valign='middle' class='title'>".date("M Y",$currenttime)."</td><td align='center' class='navi'><a href='".$this->link."?hc=".urlencode($headerColor)."&bc=".urlencode($bgColor)."&sc=".urlencode($selectedDayColor)."&d=$nday&m=$nmonth&y=$nyear'><img src='./_pic/right_arrow.gif' border='0'></a></td></tr><tr><td colspan='3'  bgcolor='$bgColor'><table border='0' cellpadding='2' cellspacing='2' width='100%' bgcolor='$bgColor' height='100%'>";
			
			$output .= "<tr bgcolor='$headerColor'><td align='center' valign='middle' width='14%' class='day'>S</td><td align='center' valign='middle' width='14%' class='day'>M</td><td align='center' valign='middle' width='14%' class='day'>T</td><td align='center' valign='middle' width='14%' class='day'>W</td><td align='center' valign='middle' width='14%' class='day'>T</td><td align='center' valign='middle' width='14%' class='day'>F</td><td align='center' valign='middle' width='14%' class='day'>S</td></tr>";
			...
			{
				if($this->day == $i && $this->month == date("n") && $this->year == date("Y"))
					$output .= "<td align='center' bgcolor='$selectedDayColor'>";
				else
			...
			$output .= "</tr></table></td></tr><tr><td colspan='3' align='center' class='day'>Today : <a href='".$this->link."?hc=".urlencode($headerColor)."&bc=".urlencode($bgColor)."&sc=".urlencode($selectedDayColor)."&d=".date("d")."&m=".date("n")."&y=".date("Y")."'>".date("d M Y")."</a></td></tr></table>";
