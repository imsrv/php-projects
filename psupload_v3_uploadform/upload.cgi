...
#
#       January 2002, V3.0 was released with the auto-rename feature.
#
#######################################################################################
#
...
$Data = "/usr/name/HTML/path/to/directory";
...
$DataURL = qq~http://www.yourdomain.com/path/to/dir~;
