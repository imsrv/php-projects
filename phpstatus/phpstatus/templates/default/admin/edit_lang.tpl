...
<table class="borderline" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td width="100%" valign="top" align="center" class="block-header"><font class="header">{L_EDITLANG}</font></td>
</tr>
<tr>
<td width="100%" valign="top">
<form action="lang_edited.php" method="post">
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td width="10%" valign="top" align="center"><input type="submit" name="submit" value="Edit Language"></td>
</tr>
</table>
</form>
</td>
