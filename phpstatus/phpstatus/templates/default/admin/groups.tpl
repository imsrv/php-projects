...
<table class="borderline" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td width="100%" valign="top" align="center" class="block-header"><font class="header">{L_GROUPS}</font></td>
</tr>
<tr>
<td width="100%" valign="top">
<table border="1" bordercolor="#003399" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td width="33%" valign="top" align="center"><font class="text">{L_GROUPID}</font></td>
<td width="33%" valign="top" align="center"><font class="text">{L_GROUPNAME}</font></td>
<td width="33%" valign="top" align="center"><font class="text">{L_ACTION}</font></td>
</tr>
<!-- BEGIN groups -->
<tr>
<td width="33%" valign="top"><font class="text">{groups.ID}</font></td>
<td width="33%" valign="top"><font class="text">{groups.NAME}</font></td>
<td width="33%" valign="top"><a href="edit_groups.php?id={groups.ID}">Edit</a> | <a href="delete_groups.php?id={groups.ID}">Delete</a></td>
</tr>
<!-- END groups -->
</table></td>
</tr>
...
<table class="borderline" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td width="100%" valign="top" align="center" class="block-header"><font class="header">{L_ADDGROUP}</font></td>
</tr>
<tr>
<td width="100%" valign="top">
...
<td width="50%" valign="top" align="left">{PORTS}</td>
</tr>
</table>
<br>
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td width="10%" valign="top" align="center"><input type="submit" name="submit" value="Add"></td>
</tr>
</table>
</form></td>
</tr>
