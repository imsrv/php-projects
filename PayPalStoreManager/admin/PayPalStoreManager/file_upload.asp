...
If (CStr(Request.QueryString("GP_upload")) <> "") Then
  ...
  pau_thePath = """../../applications/PayPalStoreManager/assets/images"""
...
<body>
<form ACTION="<%=MM_editAction%>" METHOD="post" enctype="multipart/form-data" name="FileForm" id="FileForm" onSubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','');return document.MM_returnValue">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
    <tr> 
      <td colspan="2" valign="baseline">Upload <%=filetype%>: <strong><%=(items.Fields.Item("ItemName").Value)%>&nbsp;</strong></td>
    </tr>
    <tr> 
      <td width="0" height="21" align="left"><%=filetype%> File</td>
      <td width="0" height="21" valign="baseline"> 
	  <input name="File" type="file" onChange="checkOneFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,'','','','','','','')">
	  </td>
    </tr>
    <tr> 
      <td width="0" align="right" valign="baseline">&nbsp;</td>
	   <td width="0" valign="baseline"> <input name="submit" type="submit" value="Upload File">
      </td>
    </tr>
  </table>
