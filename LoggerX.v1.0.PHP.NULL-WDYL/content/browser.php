...
$data = $db1 -> onQueryBrowser($db1 -> currentID);
...
echo "<td colspan=2 class=\"Header\"> Browser </td> <tr><td bgcolor=white>";
...
echo "<tr bgcolor=\"#000000\" align=center>";
echo "<td colspan=3 class=\"Header\">  Browser </td> <tr><td bgcolor=white width=100%>";

$header = array(" Browser","% of Visitors","Visitors");
$hchart = new HChart;
$hchart -> setData($data);
