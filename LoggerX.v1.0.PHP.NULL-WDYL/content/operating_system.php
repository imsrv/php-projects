...
$data = $db1 -> onQueryOS($db1 -> currentID);
...
echo "<td colspan=2 class=\"Header\"> Operating system </td> <tr><td bgcolor=white>";
...
echo "<tr bgcolor=\"#000000\" align=center>";
echo "<td colspan=3 class=\"Header\"> Operating system </td> <tr><td bgcolor=white>";

$header = array("Operating system","% of Visitors","Visitors");
$hchart = new HChart;
$hchart -> setData($data);
$hchart -> barwidth = 270;
