...
$data = $db1 -> onQueryColor($db1 -> currentID);
...
echo "<td colspan=2 class=\"Header\"> Color depth </td> <tr><td bgcolor=white>";
...
echo "<tr bgcolor=\"#000000\" align=center>";
echo "<td colspan=3 class=\"Header\"> Color depth </td> <tr><td bgcolor=white>";

$header = array("Color depth","% of Visitors","Visitors");
$hchart = new HChart;
$hchart -> setData($data);
$hchart -> barwidth = 270;
