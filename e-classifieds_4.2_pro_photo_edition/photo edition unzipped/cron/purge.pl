...
# purges ads that are older than the amount of expiration days as specified
# in the setup file for this section.  To run automatically, this program
