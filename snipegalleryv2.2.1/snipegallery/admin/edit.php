...
$PAGE_TITLE="Edits Saved";
} elseif ($action=="add new") {
$PAGE_TITLE="Add New Image";
} elseif ($action=="save") {
$PAGE_TITLE="Image Saved";
} elseif ($action=="confirm") {
$PAGE_TITLE="Image Deleted";
...
<table width="100%">
<tr>
	<td><h3><?php echo "$PAGE_TITLE"; ?></h3></td>
...
?>
<b><a href="<?php echo "$cfg_site_home"; ?>?screen=<?php echo "$screen"; ?>&cat_id=<?php echo "$cat_id"; ?>&action=<?php echo "$urlaction"; ?>&keyword=<?php echo "$keywordencode"; ?>">&lt;&lt; Back</a></b>
<?php
include ("footer.php");
?>