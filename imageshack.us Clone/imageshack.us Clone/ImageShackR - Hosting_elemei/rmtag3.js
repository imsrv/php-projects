...
function rmShowAd(size) {
	...
	rm_url = rm_host + "/imp?z=" + rm_ad_size + "&Z=" + rm_w + "x" + rm_h;
...
function rmGetSize(size) {
	...
	else if (size == "125x90") return 22 ;
	else if (size == "120x90") return 23 ;
	else if (size == "520x31") return 24 ;
	else if (size == "300x400") return 25 ;
	else if (size == "460x31") return 26 ;
	else if (size == "503x140") return 27 ;
	else if (size == "250x400") return 28 ;
	else if (size == "200x200") return 29 ;
	else if (size == "250x250") return 30 ;
	else if (size == "468x250") return 31 ;
	else if (size == "500x350") return 32 ;
	else if (size == "425x600") return 33 ;
	else if (size == "140x60") return 34 ;
	else if (size == "120x60") return 35 ;
	else if (size == "700x700") return 36 ;
	else if (size == "140x140") return 37 ;
	else if (size == "620x90") return 38 ;
	else if (size == "125x300") return 39 ;
	else if (size == "420x100") return 40 ;
	else if (size == "88x31") return 41 ;
	else if (size == "240x400") return 42 ;
	else if (size == "120x300") return 43 ;
	else if (size == "380x200") return 44 ;
	else if (size == "199x70") return 45 ;
	else if (size == "199x170") return 46 ;
	else if (size == "180x240") return 47 ;
	else if (size == "160x90") return 48 ;
	else if (size == "230x33") return 49 ;
	else if (size == "134x492") return 50 ;
	else if (size == "436x600") return 51 ;
	else if (size == "600x400") return 52 ;
	else if (size == "430x600") return 53 ;
	else if (size == "460x60") return 54 ;
	else if (size == "217x126") return 55 ;
	else if (size == "260x31") return 56 ;
	else if (size == "120x120") return 57 ;
	else if (size == "400x600") return 58 ;
	else return -1 ;
}
