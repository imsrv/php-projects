...
objCDOSYSCon.Fields("http://schemas.microsoft.com/cdo/configuration/smtpserver") = "mail.dmxready.com"
...
sendmail.From = "info@" & replace(Request.ServerVariables("SERVER_NAME"), "www.", "")
...
sendmail.TextBody = "Site recommendation from a friend!" & _
