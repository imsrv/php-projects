...
deletelistitem.ActiveConnection = MM_eventlistingmanager_STRING
deletelistitem.Source = "SELECT *  FROM tblEventListings  WHERE ItemID = " + Replace(deletelistitem__MMColParam, "'", "''") + ""
