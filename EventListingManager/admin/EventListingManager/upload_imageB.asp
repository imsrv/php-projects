...
images.ActiveConnection = MM_eventlistingmanager_STRING
images.Source = "SELECT *  FROM tblEventListings  WHERE ItemID = " + Replace(images__value1, "'", "''") + ""
images.CursorType = 0
