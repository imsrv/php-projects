...
##
        ...
        my($query) = "SELECT * FROM DMtgpgalleries WHERE webcate = '$categ' and approval = '1' ORDER BY 'idnum' DESC LIMIT $startat, $endat";
...
print "<body>\n";
print "\n";
print "<p align=\"center\"><font face=\"Verdana\">Page generated</font></p>\n";
print "\n";
print "</body>\n";
print "\n";
print "</html>\n";
