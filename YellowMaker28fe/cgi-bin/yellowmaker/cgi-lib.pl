...
sub ReadParse {
  ...
  if ($len > $cgi_lib'maxdata) { #'
      &CgiDie("Sorry, your image file cannot exceed $len bytes\n");
&bottom;
  }
   ...
   PART: # find each part of the multi-part while reading data
    while (1) {
     ...
     BODY: 
	  ...
	  &CgiDie("Sorry, reached end of input while seeking boundary " .
	...
	die "Short Read: wanted $amt, got $got\n" if $errflag;
     ...
     HEAD:
	  ...
	  &CgiDie("Sorry, reached end of input while seeking end of " .
...
&top;
  ...
  print "<br><br><br><br><br><center><h2>$msg[0]</h2></center><br><br><br><br><br><br><br>\n";
  foreach $i (1 .. $#msg) {
    print "<p>$msg[$i]</p>\n";
  }
...
<body text="#000000" topmargin="0" leftmargin="0" link="#000000" vlink="#000000"
alink="#000000" bgcolor="#FFFFCC">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    face="$font" size="$size"><a href="../$sub/copyr.pl">$copyright</a> Use of this web
    site constitutes acceptance of the $company <a href="../$sub/terms.pl">Service
    Agreement</a> and <a href="../$sub/privacy.pl">Privacy Policy</a>.&nbsp;Designated
    trademarks and brands are the property of their respective owners. This program is powered
    by <a href="http://www.yellowbuilder.com">YellowBuilder</a> 2.8 Standard Edition.</font><p>&nbsp;</td>
    <td width="5%" valign="top" align="center" height="75" bgcolor="#FFD966"></td>
  </tr>
</table>
</center></div>
