...
############################################################
#  GET MATCHES BY DESCRIPTION
############################################################
sub getbydescription{

my($query) = "SELECT * FROM items where (description like '%$keyword1%' and description like '%$keyword2%' and description like '%$keyword3%' and description like '%$keyword4%' and description like '%$keyword5%' and description like '%$keyword6%' and description like '%$keyword7%' and category like '%$category%') or (title like '%$keyword1%' and title like '%$keyword2%' and title like '%$keyword3%' and title like '%$keyword4%' and title like '%$keyword5%' and title like '%$keyword6%' and title like '%$keyword7%' and category = '$category')";
...
sub searchbypost {
	...
	if ($keyword =~ / /i){
	($keyword1,$keyword2,$keyword3,$keyword4,$keyword5,$keyword6,$keyword7) = split(/ /,$keyword);
	}
	if ($keyword =~ /\,/i){
	($keyword1,$keyword2,$keyword3,$keyword4,$keyword5,$keyword6,$keyword7) = split(/\,/,$keyword);
	}
