...
<a href="lang.php">Edit/Add Langauges</a><br>
...
<tr>
<td width="100%" valign="top" align="center">
<form method="post" action="lang_edited.php">
{HIDDEN}
...
<td width="50%" valign="top" align="left" bgcolor="#FFFFFF">{NAME}</td>
</tr>
</table>
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td width="100%" valign="top" align="center"><input class="mainoption" type="submit" name="submit" value="Edit Language"> <input class="mainoption" type="reset" name="reset" value="Reset Form"></td>
</tr>
</table></center>
</form></td>
</tr>
