        ...
        <tr>
          ...
          <td valign="top" align="left">
            ...
            <?
              ...
              $dbq = $db->execute("select * from tblFavorites where user_id = $user_id and favorite_id = $favorite_id");
              $txturl = $dbq->fields['url'];
              $txttitle   = $dbq->fields['url_title'];
              $txtnotes   = $dbq->fields['notes'];
              $dbq->close();

              echo "        <form method='post' action='favoritesupdate.php?ID=$ID&lang=$lang&favorite_id=$favorite_id'>\n";
              ...
              echo "                          <td width='22%' valign='top'>$text66</td>\n";
