                  ...
                  <tr>
                             ...
                             <table width='100%' border='0' cellspacing='0' cellpadding='1'>
                               ...
                               <tr bgcolor='#DFDFDF'>
                                 ...
                                 <td width='86%'>
                                   ...
                                   &nbsp;&nbsp;
                                   <a href="createcontact.php?mbox_id=<? echo $mbox_id; ?>&msg_no=<? echo $msg_no; ?>&rm=1&txtemail=<? echo rawurlencode(turkcelestir($postaci_from)); ?>"><img src="images/bt_adressbook2.gif" border="0" alt="<? echo $text86; ?>"></a>
                                   &nbsp;&nbsp;
                                   <?
                                     if ($ek == 1) {
                   ...
                   <tr align='right'>
                     <td nowrap bgcolor='#E3E7E8' align="right">
                        ...
                        ?>
                        <img src='images/reply.gif' width='16' height='17' border='0'> <a href='sendmail.php?topmsg=<? echo $topmsg; ?>&post_act=<? echo $reply_act; ?>&msg_id=<? echo $msg_no; ?>&mbox_id=<? echo $mbox_id; ?>'><? echo $text34 ?></a> | <img src='images/forward.gif' width='21' height='16' border='0'> <a href='sendmail.php?topmsg=<? echo $topmsg; ?>&post_act=<? echo $forward_act; ?>&msg_id=<? echo $msg_no; ?>&mbox_id=<? echo $mbox_id; ?>'><? echo $text35 ?></a> | <img src="images/delete.gif">&nbsp;<a href='deletemessage.php?chk[0]=<? echo $msg_no; ?>&mbox_id=<? echo $mbox_id ?>'><? echo $text85 ?></a></td>
                     </td>
                   </tr>
                   <tr>
                     <td>
