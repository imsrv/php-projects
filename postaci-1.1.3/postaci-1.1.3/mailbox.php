                ...
                <?
                  if ($email->empty_mailbox()) {
                    ...
                    for ($i = 0; $i < $message_count_right_now ;$i++) {
                      ...
                      echo "  <td width='3%' bgcolor='#E4E4E4'><font color='#000000'><input type='checkbox' name='chk[]' value='$mesaj_numerosu'></font></td>\n";
                      ...
                      if ($mbox_id == "$to_folder" || $mbox_id == $POP3toFolder) {
                          ...
                          echo "<td width=\"29%\" bgcolor=\"#E4E4E4\" nowrap><a href=\"sendmail.php?topmsg=" . $topmsg . "&msg_id=" . $postaci_headers["msg_no"][$i] . "&mbox_id=$urlenc_mbox_id&post_act=$post_act\">";
                          echo "$message_new_tag_begin" . mychop($postaci_headers["from"][$i],25) . "$message_new_tag_end";
                          echo "</a>&nbsp;&nbsp;</td>";
                      }
                      ...
                      if ($postaci_headers["subject"][$i] == "") {
                        $postaci_headers["subject"][$i] = $text40;
                      }
                      echo "$message_new_tag_begin" . mychop(turkcelestir($postaci_headers["subject"][$i]),22) . "$message_new_tag_end";
                      echo "</a>&nbsp;&nbsp;</td>";
