...
if ($log_id == ""){
  ...
  if ($default_protocol == "pop3" && $mbox_id != "INBOX" && $post_act != 0 && $post_act !=4) {                   // Security Check
            ...
            <div align='center'>&nbsp;<br>
              <form name='myForm' method='post' action='postmail.php' onSubmit='submitonce(this)'>
                ...
                <table width='550' border='0' cellspacing='0' cellpadding='1' bgcolor='#999999'>
                      ...
                      <table width='100%' border='0' cellspacing='0' cellpadding='1'>
                        ...
                        <tr bgcolor='#DFDFDF'>
                          ...
                          <td width='370' bgcolor='#DFDFDF'>
                            <input type='text' name='to' class='styletextfield' size='45' value='<? echo $to; ?>'>
                          </td>
                        </tr>
                        <tr bgcolor='#DFDFDF'>
                          ...
                          <td width='10' align='center'><b><font color='#4E4E4E'>:</font></b></td>
                          <td width='370'>
                            <input type='text' name='cc' class='styletextfield' size='45' value='<? echo $cc; ?>'>
                          </td>
                        </tr>
                        <tr bgcolor='#DFDFDF'>
                          ...
                          <td width='10' align='center'><b><font color='#4E4E4E'>:</font></b></td>
                          <td width='370'>
                            <input type='text' name='bcc' class='styletextfield' size='45' value="<? echo $bcc; ?>">
                          </td>
                        </tr>
                        <tr bgcolor='#DFDFDF'>
                          <td width='20' align='left' nowrap>&nbsp;</td>
                          ...
                          <td width='370' nowrap>
                            <input type='text' name='subject' class='styletextfield' size='45' value='<? echo $subject; ?>'>
                          </td>
                        </tr>
                        <tr bgcolor='#DFDFDF'>
                          <td width='20' align='left' valign='top' nowrap>&nbsp;</td>
                  ...
                  <tr>
                    <td bgcolor='#F3F3F3'>
                      <textarea name='msgbody' cols='74' rows='22' wrap='PHYSICAL' class='stylemsgbody'><? echo $msgbody; ?></textarea><br>
                    </td>
                  </tr>
                  <tr>
