...
The full path to this directory - on most servers you can leave it set to ./templates<br />
<input name="templates_path" type="text" size="50" value="./templates" /><br /><br />
The url to the templates directory<br />
<input name="templates_url" type="text" size="50" value="http://www.you.com/topsites/templates" /><br /><br />
...
Password<br />
<input name="sql_pass" type="text" size="50" /><br /><br />
...
elseif ($FORM['a'] == "done") {
  ...
  if (!$FORM['templates_path']) { $error .= "Templates Path<br />"; }
  if (!$FORM['templates_url']) { $error .= "Templates URL<br />"; }
...
EndHTML;
    ...
    echo "<a href=\"http://www.aardvarkind.com/topsitesphp/manual/4.1.0/\">Manual</a>";
  }
}
