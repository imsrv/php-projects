...
<td class="lore_splash_header" width="60%" align="left" valign="bottom">
	...
	{if $lore_system.settings.knowledge_base_description}
		<br />
		<span class="lore_normal_font">
			{$lore_system.settings.knowledge_base_description}
		</span>
	{/if}
</td>
<td class="lore_top_buttons" width="40%" align="right" valign="bottom">
	...
	{if $lore_system.settings.enable_glossary}
		<a class="lore_dark_link" href="{$lore_system.base_dir}/{$lore_system.scripts.index}?action=glossary"><img src="{$lore_system.base_dir}/{$image_dir}/glossary.gif" alt="" border="0" align="middle" /> Glossary</a>
	{/if}

	&nbsp;&nbsp;

	{if $lore_system.settings.show_contact_link }
		<a class="lore_dark_link" href="{$lore_system.base_dir}/{$lore_system.scripts.contact}"><img src="{$lore_system.base_dir}/{$image_dir}/contact.gif" alt="" border="0" align="middle" /> Contact Us</a>
	{/if}
</td>
</tr>
</table>
