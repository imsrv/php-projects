...
die("Det oppstod en feil. Greide ikke å laste opp.");

} else {
	die("Du anga ikke noe filnavn");
}
echo $top;
echo "Du lastet opp dette bildet";
...
echo $top;
echo "Dine brukerinnstillinger ble oppdatert <br><br> Du må logge ut og inn igjen for at endringene skal tre i kraft.";
echo $bottom;
...
if($nsniva==$ns_user_admin)
{
echo"Skriver du historien for noen? <input type=\"Checkbox\" name=\"skriverfor\"><br>";
echo"Navn på forfatter: <input type='text' name='skriverfornavn' value=''><br><br>";
}
else
{
}
...
{
echo $top;
echo "<h2>Her kan du velge hvilken nyhet du vil endre</h2>";
...
if($nsbruker==$bruker)
{
echo "<tr><td><b>Tittel:</b></td><td><a href='$PHP_SELF?valg=endre2&&verdi=$tall'>$overskrift</a></td><td><b>Plassering:</b></td><td>$katvalg</td></tr>";
}
}
elseif($nsniva==admin)
{
echo "<tr><td><b>Tittel:</b></td><td><a href='$PHP_SELF?valg=endre2&&verdi=$tall'>$overskrift</a></td><td><b>Plassering:</b></td><td>$katvalg</td><td><b>Forfatter:</b></td><td>$navn ($bruker)</td></tr>";
}
...
Navn: <input type=\"text\" name=\"endrebrnavn\" value=\"$brnavn\" align=\"right\"><br>
Brukernavn: <input type=\"text\" name=\"endrebrbrukernavn\" value=\"$brnav\" readonly><br>
Epost: <input type=\"text\" name=\"endrebrepost\" value=\"$bremail\"><br>
Passord: <input type=\"password\" name=\"endrebrpassord\" value=\"$brpassord\"><br>
<input type=\"submit\" value=\"Endre konto\">
</form>";
}
$i=$i + 1;
...
{
echo $top;
echo ("Legg til i \"Fra pressen\"<br><br><form name='add' method='post' action='link.php'>\n");
echo ("<table frame='0'>\n");
echo ("<tr>\n");
echo ("<td valign='top'>Avis:</td><td valign='top'><input type='text' name='avis' size='40'></td>\n");
echo ("</tr>\n");
echo ("<tr>\n");
echo ("<td valign='top'>URL:</td><td valign='top'><input type='text' name='url' size='40' value='http://'></td>\n");
echo ("</tr>\n");
echo ("<tr>\n");
echo ("<td valign='top'>Overskrift:</td><td valign='top'><input type='text' name='overskrift' size='40'></td>\n");
echo ("</tr>\n");
echo ("</table>\n");
echo ("<input type='submit' value='legg til link'>\n");
echo ("</form>\n");
echo ("<br><br><br>Endre avstemningen:<br><br><a href=\"news/admin.php\">Klikk her</a><br><br><br><br><br>");
echo $bottom;
}
