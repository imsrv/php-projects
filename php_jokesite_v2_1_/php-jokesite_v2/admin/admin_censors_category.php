...
$database_table_name = $bx_db_table_censor_categories;
$this_file_name = basename($HTTP_SERVER_VARS['PHP_SELF']);
$page_title = "Censor Category (".$language.")";
$nr_of_cols = 4;
$primary_id_name = "censor_category_id";
$primary_id = $HTTP_GET_VARS[$primary_id_name];
$edit_field_name = "censor_category_name".$slng;
...
?>
		<tr bgcolor="<?=INSIDE_TABLE_BG_COLOR?>" align="center">
			<td colspan="<?=$nr_of_cols?>" align="center">
				<b>There are no censor categories!</b>
			</td>
		</tr>
<?
}
