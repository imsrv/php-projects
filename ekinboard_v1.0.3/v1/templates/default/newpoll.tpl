...
<a href="index.php"><{page_title}> Home</a> - <a href="index.php?cid=<{category_id}>"><{category_name}></a> - <a href="viewforum.php?id=<{forum_id}>"><{forum_name}></a> - New Poll
</td></tr></table>
...
<{loop_newpoll}>
	...
	<tr><td width=100% class=table_1_header><img src="templates/<{template}>/images/arrow_up.gif"> <b>New Poll</b></td><td align=right class=table_1_header><img src="templates/<{template}>/images/EKINboard_header_right.gif"></td></tr>
	</table></td></tr>
	<tr class=table_subheader><td align=left class=table_subheader>Topic Details</td></tr>
	<tr><td class=contentmain align=center>
	<form action="newpoll.php?id=<{id}>&d=post" method="post" name="Form" onSubmit="disableButton()">
...
<br>
	...
	<tr class=table_subheader><td align=left class=table_subheader>Poll Details</td></tr>
	<tr><td class=contentmain align=center>
	<table cellspacing="0" class="legend_<{poll_question_error}>" width=95%>
	<tr><td>
		<span class="error"><{poll_question_error_message}></span>
	</td></tr><tr><td align=center>
	<table cellspacing="0" cellpadding="0"><tr><td width=150>
	Poll Question:
	</td><td width=350>
	<input type="text" class="text" name="poll_question" value="<{submitted_poll_question}>" size="50">
	</td></tr></table>
	</td></tr></table>
<br>
	<table cellspacing="0" class="legend_<{poll_choices_error}>" width=95%>
	<tr><td>
		<span class="error"><{poll_choices_error_message}></span>
	</td></tr><tr><td align=center>
	<table cellspacing="0" cellpadding="0"><tr><td width=150>
	Poll Choices:<br>
( One choice per line )
	</td><td width=350>
	<textarea class=text cols=47 rows=7 name=poll_choices><{submitted_poll_choices}></textarea>
	</td></tr></table>
	</td></tr></table>
	<tr class=table_subheader><td align=left class=table_subheader>EKINcode</td></tr>
...
<!--
	...
	{
		document.Form.topic_message.value += code;
		//return true;
	}
//-->
</script>
...
<a href=javascript:add_smilie(':sleep:')><img alt=\"smile for :sleep:\" title=\":sleep:\" src=templates/<{template}>/images/smilies/sleeping.gif border=0></a>
	...
	<textarea class=text cols=100 rows=10 name=topic_message><{submitted_message}></textarea>
	</td></tr></table>
	</td></tr>
