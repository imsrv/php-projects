...
$this_config_type = "theme_newleft";
...
function start_html($title="ModernBill .:. Client Billing System",$head=NULL,$body_color=NULL,$body_vars="leftmargin=0 marginwidth=0 topmargin=0 marginheight=0")
{
         ...
         echo "\n$head\n</HEAD>\n<BODY bgcolor=\"$body_color\" $background $body_vars>\n";
         $logo_size = GetImageSize($logo_img);
         ?>
         <table width=100% border=0 cellpadding=2 cellspacing=2>
         <tr>
           <td width=157 valign=top align=center>
             <a href=<?=$https?>://<?=$secure_url?>><image src=<?=$logo_img?> width=157 border=0></a>
             <?=SFW?>
             <?=HELLO?> <?=$welcome_name?>
             <br>
             <?=date("l, M. d, Y")?>
             ...
             <? if ($admin_login) { ?>
                    ...
                    <td>
                    <?=search_select_box();?><br>
                    <input type=text name=query size=15 maxlength=25>&nbsp;<?=GO_IMG?>
                    </td>
                    </form>
                    </tr>
                    </table>
               ...
               <td>
                <table width=100% cellpadding=0 cellspacing=0 border=0 bgColor=#ffffff>
                 <TR>
                  ...
                  <td align=center>&nbsp;</td>
                  <td align=right valign=top><a href="<?=$page?>?op=menu&tile=dashboard"><img src=images/icons/home_round.gif border=0 align=middle alt="<?=HOME?>"></a>&nbsp;<a href="<?=$https."://".$secure_url.$login_page?>?op=logout"><img src=images/icons/x_blue.jpg border=0 align=middle alt="<?=EXIT_t?>"></a>&nbsp;<img src=images/upper_right.gif></td>
                 </tr>
                </table>
               </td>
              </tr>
...
function stop_html($toggle=1)
{
         ...
         <TR>
         <td align=left valign=top><img src=images/lower_left.gif></td>
         <td align=center><?=SFB?><?=go_back();?> | <b><a href="javascript:printWindow()"><?=PRINTSCREEN?></a></b><?=EF?></td>
         <td align=right valign=top><img src=images/lower_right.gif></td>
         </tr>
         <?
         //
         ...
         ?>
         <? if ($toggle&&!$this_user) { ?>
            <tr bgcolor=<?=$default_bgcolor?>>
             <td align=center colspan=3><br><?=SFW."ModernBill <SUP><SMALL>TM</SMALL></SUP> .:. Client Billing System .:. Version $version<br>
                                                    Copyright &copy; 2001,2002 .:. ModernGigabyte, LLC .:. All Rights Reserved.<br>
                                                    T:".sprintf("%.3f",abs(get_microtime()-$start_timer)).EF?></td></tr>
         <? } ?>
         </table>
         </td>
         </tr>
...
function start_box($title=NULL,$width="100%",$align="center")
{
         ...
         ?>
         <table width=<?=$width?> align=<?=$align?> border=0 cellpadding=0 cellspacing=0>
...
function start_table($title=NULL,$width="100%",$align="center",$bgcolor="#FFFFFF")
{
         ...
         ?>
         <TABLE cellSpacing=0 cellPadding=0 width=<?=$width?> align=<?=$align?> bgcolor=<?=$bgcolor?> border=0>
         <TR>
...
function user_main_menu($tile)
{
         ...
         //$myplesk_bgcolor    = ($tile=="plesk")     ? $active_bgcolor : $default_bgcolor ;
         //$myserver_bgcolor   = ($tile=="server")    ? $active_bgcolor : $default_bgcolor ;
         ?>
         <table width=100% align=center border=0 cellspacing=1 cellpadding=3>
         <tr><td bgcolor=<?=$myinfo_bgcolor?>><?=SFB?><img src=images/icons/clients.gif border=0 align=absmiddle>&nbsp;<a href=<?=$page?>?op=menu&tile=myinfo><b><?=MYINFORMATION?></b></a><?=EF?></td></tr>
         <tr><td bgcolor=<?=$mypackages_bgcolor?>><?=SFB?><img src=images/icons/product.gif border=0 align=absmiddle>&nbsp;<a href=<?=$page?>?op=menu&tile=mypackages><b><?=MYPACKAGES?></b></a><?=EF?></td></tr>
         <tr><td bgcolor=<?=$mydomains_bgcolor?>><?=SFB?><img src=images/icons/prompt.gif border=0 align=absmiddle>&nbsp;<a href=<?=$page?>?op=menu&tile=mydomains><b><?=MYDOMAINS?></b></a><?=EF?></td></tr>
         <tr><td bgcolor=<?=$myinvoices_bgcolor?>><?=SFB?><img src=images/icons/money.gif border=0 align=absmiddle>&nbsp;<a href=<?=$page?>?op=menu&tile=myinvoices><b><?=MYINVOICES?></b></a><?=EF?></td></tr>
         <tr><td bgcolor=<?=$mycontact_bgcolor?>><?=SFB?><img src=images/icons/email.gif border=0 align=absmiddle>&nbsp;<a href=<?=$page?>?op=menu&tile=contact><b><?=CONTACTUS?></b></a><?=EF?></td></tr>
         <? if ($display_faq_link)          { ?><tr><td bgcolor=<?=$myfaq_bgcolor?>><?=SFB?><img src=images/icons/download.gif border=0 align=absmiddle>&nbsp;<a href=<?=$page?>?op=faq><b><?=ONLINEFAQ?></b></a><?=EF?></td></tr><? } ?>
         <? if ($display_support_desk_link) { ?><tr><td bgcolor=<?=$mysupport_bgcolor?>><?=SFB?><img src=images/icons/support.jpg border=0 align=absmiddle>&nbsp;<a href=<?=$page?>?op=menu&tile=mysupport><b><?=SUPPORTDESK?></b></a><?=EF?></td></tr><? } ?>
         <? if ($display_news_link)         { ?><tr><td bgcolor=<?=$mynews_bgcolor?>><?=SFB?><img src=images/icons/note.gif border=0 align=absmiddle>&nbsp;<a href=<?=$page?>?op=menu&tile=mynews><b><?=NEWSUPDATES?></b></a><?=EF?></td></tr><? } ?>
         <tr><td bgcolor=<?=$myhome_bgcolor?>><?=SFB?><img src=images/icons/note.gif border=0 align=absmiddle>&nbsp;<a href=<?=$page?>?op=menu&tile=dashboard><b><?=CLIENTHOME?></b></a><?=EF?></td></tr>
         <tr><td bgcolor=<?=$mylogout_bgcolor?>><?=SFB?><img src=images/icons/note.gif border=0 align=absmiddle>&nbsp;<a href="<?=$https."://".$secure_url.$login_page?>?op=logout"><b><?=LOGOUT?></b></a><?=EF?></td></tr>
         </table>
         <?
}
