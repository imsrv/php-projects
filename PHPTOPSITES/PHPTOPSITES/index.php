...
?>
<font color="<? echo $font_color;?>" face="<? echo $font_face;?>" size="<? echo $font_size;?>"><a href=add.php>Inscreva-se</a> || <a href=edit.php>Editar Site</a> || <a href=last.php>Últimos <? echo $last_ssites;?> Submetidos</a> || <a href=help.php>Ajuda </a></font>
</center>
<BR>
...
while ($rows = mysql_fetch_array($squery)) {
	...
	<tr>
		...
		if ($use_review == 1) {
			...
			echo "<B><font size=\"-2\"><A HREF=\"review.php?site=$rows[sid]\">Minha Revisão</A> ($reviews)</font></B>&nbsp;&nbsp;&nbsp;&nbsp;";
		}
		if ($use_taf == 1) {
			echo "<B><font size=\"-2\"><A HREF=\"recommend.php?site=$rows[sid]&cid=$rows[category]\">Recomenda</A></font></B>&nbsp;&nbsp;&nbsp;&nbsp;";
		}
		if ($cid == 0) {
		...
		<td align="center" bgcolor="white">
			...
			<A HREF="rate.php?site=<? echo $rows[sid]?>">Vote Aqui</A>
			</font>		
		</td>
	</tr>
	<?
...
?>
	...
	<tr>
		...
		<font color="<? echo $font_color;?>" face="<? echo $font_face;?>" size="<? echo $font_size-1;?>"><? echo $stotal;?> Sites em nosso banco de dados, List Views: <? include "counter.php";?><BR>
		...
		echo "Tempo de processamento da página: ".$totaltime." seg.";
	...
	<tr>
		...
		<font color="<? echo $font_color;?>" face="<? echo $font_face;?>" size="<? echo $font_size-1;?>">
		<img src="images/star.gif" width="10" height="9" border="0" alt="">=Site Podre
		<img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt="">=Chato
		<img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt="">=Muito Bem
		<img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt="">=Soberbo
		<img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt=""><img src="images/star.gif" width="10" height="9" border="0" alt="">=Site Super Mesmo
		</font>
		</td>
	</tr>
</table>
