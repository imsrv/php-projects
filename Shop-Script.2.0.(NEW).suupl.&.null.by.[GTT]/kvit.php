 ...
 ****************************************************************************/
	...
	{
		if (isset($log))
			$client = $log; //для показа клиенту
		else die ("Клиент не найден в базе данных");
	}
	...
	$cl =  db_fetch_row($q);
	if (!$cl) die ("Клиент не найден в базе данных или не является физическим лицом");


	if (!isset($orderID)) die("Не указан номер заказа");
	...
	if (!$order) die ("Заказ не найден в базе данных");
...
<HTML><HEAD><TITLE>Оплата по Квитанции</TITLE>
...
<CENTER>
  ...
  <TR>
    <TD vAlign=top align=right width=200 height=255><BR><BR><FONT size=2>
      <P>Извещение</P><BR><BR><BR><BR><BR><BR><BR><BR><BR><BR><BR><FONT size=1>
      <P>Кассир</P></FONT></FONT></TD>
    <TD vAlign=center align=right width=100 height=255>
      <TABLE cellSpacing=0 cellPadding=3 width=370 border=1><FONT size=-1>
        <P align=center>ИНН $inn КПП $kpp<BR><U>$reciever</U><BR><FONT size=1>получатель платежа</FONT></FONT> 
        <TBODY>
        <TR>
        ...
        <TR>
          <TD vAlign=center align=middle colSpan=4 height=10><FONT size=2>
            <P>Кор. сч.: $ks</P></FONT></TD></TR>
        <TR>
          <TD colSpan=4><FONT size=2>
            <CENTER>$cl[2]&nbsp;$cl[0]&nbsp;$cl[1]<BR>$cl[3],&nbsp;$cl[4]
            <CENTER>
            <CENTER><FONT size=1>плательщик (ФИО, 
            адрес)</FONT></CENTER></FONT></CENTER></CENTER></TD></TR>
        <TR>
        ...
        <TR>
          <TD align=middle colSpan=2><FONT size=1>заказ №$orderID</FONT></TD>
  ...
  <TR>
    <TD vAlign=top align=right width=200 height=255><FONT size=2><BR><BR>
      <P>Квитанция</P><BR><BR><BR><BR><BR><BR><BR><BR><BR><BR><BR><FONT size=1>
      <P>Кассир</P></FONT></FONT></TD>
    <TD vAlign=center align=right width=100 height=255>
      <TABLE cellSpacing=0 cellPadding=3 width=370 border=1><FONT size=-1>
        <P align=center>ИНН $inn КПП $kpp<BR><U>$reciever</U><BR><FONT size=1>получатель платежа</FONT></FONT> 
