...
If (CStr(Request.QueryString("GP_upload")) <> "") Then
  ...
  pau_thePath = """../../applications/ContactUsManager/images"""
...
If (Request.QueryString("ContactID")         <> "") Then 
  images__value1 = Request.QueryString("ContactID")        
End If
%>
<%
set images = Server.CreateObject("ADODB.Recordset")
images.ActiveConnection = MM_contactusmanager_STRING
images.Source = "SELECT *  FROM tblContactUs  WHERE ContactID = " + Replace(images__value1, "'", "''") + ""
images.CursorType = 0
...
<input type="hidden" name="MM_recordId" value="<%= images.Fields.Item("ContactID").Value %>">
</form>
</body>
</html>
<%
