...
/* Nullified by WDYL-WTN */
	...
	$template = new Template("templates/prospects_undeliverables");
	$db = new DB_Sql;
	...
	$template->set_file("tpl_prospects_undeliverables", "prospects_undeliverables.tpl");
	$template->set_var("USER_NAME", $name);

	// obtinem lista de subscrisi la care nu s-a putut trimite mail-uri
	...
	$template->parse("content", "tpl_prospects_undeliverables");
