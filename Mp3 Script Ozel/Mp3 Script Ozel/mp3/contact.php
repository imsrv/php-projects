											  ...
											  <tr>
												<td height="496" valign="top">												 											 	  <div style="margin-left:25px; margin-top:18px; color: #9C9C9C;">														
												  <div align="left" class="style27"> 
													      <p><img src="images/1_w1.gif" width="34" height="34"><span class="style30"> ABOUT </span></p>
											      </div>
												  <table  border="0" cellpadding="0" cellspacing="0">
												    <!--DWLayoutTable-->
												 
														  <tr>
															<td width="405" height="179" valign="top" ><form action="contact-process.php" method="post" name="form1" target="_blank">
                                                              <p align="left">Your Name :
                                                                  <input name="your_name2" type="text" id="your_name2">
                                                              </p>
                                                              <p align="left">Your Email :
                                                                  <input name="your_email2" type="text" id="your_email2">
                                                              </p>
                                                              <p align="left">Massage:</p>
                                                              <p align="left">
                                                                <textarea name="massage" cols="25" rows="5" id="massage"></textarea>
                                                              </p>
                                                              <p align="center">
