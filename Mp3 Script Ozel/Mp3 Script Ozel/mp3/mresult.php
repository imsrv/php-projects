									  ...
									  <tr>
										<td valign="top" width="439" height="639" style="background-color:#292929 ">
											<table  border="0" cellspacing="0" cellpadding="0" style="background:URL(images/back_bot.gif) no-repeat bottom; height:100%">
											  ...
											  <tr>
												<td height="598" valign="top">												 											 	  <div style="margin-left:25px; margin-top:18px ">														
												  <div align="left">
												    <p><em><span class="style3"> <img src="images/1_w1.gif" width="34" height="34"></span></em><span class="style7"> </span>   <span class="style15">Result</span> <br>
											...
											mysql_select_db($db_name) or die(mysql_error());
												...
												$result = mysql_query("SELECT * FROM mp3 WHERE $kind LIKE '$search'");
