...
<table width="326" border="0" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr>
    <td height="458" colspan="3" valign="top"><div align="center">
           <p><?=$artist;?> - <?=$video?></p>
           <p align="left"><embed name="PersianMP3Player" src="<?=$link?>" type="application/x-mplayer2" width="320" height="300" showc.."1" showstatusbar="1" loop="true" enablec.."0" displaysize="0" pluginspage="http://www.microsoft.com/Windows/Downloads/Contents/Products/MediaPlayer/"></embed>
            </p>
           <p align="center">HTML CODE :</p>
           <p align="center">
             <textarea name="textarea"><embed name="PersianMP3Player" src="<?=$link?>" type="application/x-mplayer2" width="320" height="300" showc.."1" showstatusbar="1" loop="true" enablec.."0" displaysize="0" pluginspage="http://www.microsoft.com/Windows/Downloads/Contents/Products/MediaPlayer/"></embed><br>
<a href="<?=$siteurl?>" target="_blank">Video provided by <?=$sitename_www;?></a>
  ...
  <tr>
    <td height="19"></td>
    <td valign="top"><div align="center"><a href="<?=$link?>">Click Here To Download 
            <?=$video?> 
            Video </a></div></td>
    <td></td>
    <td></td>
