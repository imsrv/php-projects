											  ...
											  <tr>
												<td height="496" valign="top">												 											 	  <div style="margin-left:25px; margin-top:18px; color: #9C9C9C;">														
												  <div align="left" class="style27"> 
													      <p><img src="images/1_w1.gif" width="34" height="34"><span class="style30">Player</span><span class="style29"></span></p>
											      </div>
												  ...
												  ?>
														  <tr>
															<td width="92" height="33" >&nbsp;</td>
														    <td colspan="3" valign="top" ><p>
															  <embed name="PersianMP3Player" src="<?=$link?>" type="application/x-mplayer2" width="217" height="20" showc.."1" showstatusbar="1" loop="true" enablec.."0" displaysize="0" pluginspage="http://www.microsoft.com/Windows/Downloads/Contents/Products/MediaPlayer/"></embed>
										                    </p></td>
														    <td width="105" >&nbsp;</td>
													      </tr>
														  <tr>
														  ...
														  <tr>
														    <td height="13" ></td>
														    <td ></td>
														    <td valign="top" ><div align="center"><strong><span class="style31">HTML CODE: </span></strong></div></td>
														  <td ></td>
														    <td ></td>
												    </tr>
														  <tr>
												    ...
												    <td ></td>
														  ...
														  <tr>
														    ...
														    <td valign="top" ><div align="center">
														      <textarea name="textarea" cols="24" rows="3"><embed name="PersianMP3Player" src="<?=$link?>" type="application/x-mplayer2" width="217" height="20" showc.."1" showstatusbar="1" loop="true" enablec.."0" displaysize="0" pluginspage="http://www.microsoft.com/Windows/Downloads/Contents/Products/MediaPlayer/"></embed><br>
<a href="<?=$siteurl?>" target="_blank">Video provided by <?=$sitename_www;?></a>
												    ...
												    <td ></td>
														  ...
														  <tr>
														    <td height="26" ></td>
														    <td ></td>
														    <td valign="top" ><div align="center"><a href="<?=$link?>">CLICK HERE TO DOWNLOAD THE THIS SONG </a></div></td>
												    <td ></td>
														    <td ></td>
												    </tr>
