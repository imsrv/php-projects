									  ...
									  <tr>
										<td valign="top" width="439" height="639" style="background-color:#292929 ">
											  ...
											  <tr>
												<td height="496" valign="top">												 											 	  <div style="margin-left:25px; margin-top:18px; color: #9C9C9C;">														
												  <div align="left" class="style27"> 
													      <p><img src="images/1_w1.gif" width="34" height="34"><span class="style30">Music</span></p>
											...
											mysql_select_db($db_name) or die(mysql_error());
												...
												$result = mysql_query("SELECT * FROM mp3 WHERE artistabc LIKE '$abc'");
												...
												?>
												    ...
												    <td ></td>
														  ...
														  <tr>
														    <td height="19" ></td>
														    <td valign="top" ><div align="center"><a href="download.php?id=<?=$id?>">Click Here To Download </a></div></td>
														    <td ></td>
												    <td ></td>
												    </tr>
														  <tr>
												    ...
												    <td ></td>
														  ...
														  <tr>
														    ...
														    <td colspan="4" valign="top"><div align="center"><img src="images/hl.gif" alt="" width="300"></div></td>
														    <td>&nbsp;</td>
												    </tr>
														  <tr>
														    <td height="1"></td>
