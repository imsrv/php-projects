											...
											<table  border="0" cellspacing="0" cellpadding="0" style="background:URL(images/back_bot.gif) no-repeat bottom; height:100%">
											  ...
											  <tr>
												<td height="529" valign="top">												 											 	  <div style="margin-left:25px; margin-top:18px ">														
												  ...
												  <p align="center">ADD NEW ALBUM</a> | <a href="add-video.php">ADD NEW VIDEO</a> | <a href="edit-album.php">EDIT ADDED ALBUM</a> | <a href="edit-video.php">EDIT ADDED VIDEO</a> | <a href="delete-album.php">DELETE ALBUM</a> | <a href="delete-video.php">DELETE VIDEO</a> | <a href="add-news.php">ADD NEWS</a>  </p>
...
<div align="left">
	<table cellpadding="0" cellspacing="0" width="461" height="144">
	  <!--DWLayoutTable-->
		<tr><td width="124" height="19"><form method="POST" action="">
		...
		<tr>
			...
			<td colspan="2" valign="top">
													<p align="left">
													<input  name="album" size="15" style="font-family: Verdana; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
			...
			<p align="left"><input type="text" name="text1" size="15"  style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="17" valign="top">
			...
			<td colspan="2" valign="top">
													<p align="left">
													<input  name="artist" size="15" style="font-family: Verdana; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
			<td valign="top">
		  </td>
			<td>
			...
			<td>
			<p align="left">
													<input type="text" name="link1" size="15" dir="ltr" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="17" valign="top">
			<p align="left">
			...
			<td colspan="2" valign="top">
													<p align="left">
													<input name="date" size="15" style="font-family: Verdana; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
			<td valign="top">
		  </td>
			<td>
			<p align="left">
			...
			<td>
			<p align="left">
													<input type="text" name="text2" size="15" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="17" valign="top">
			...
			<td colspan="2" valign="top">
													<p align="left">
													<input name="img" size="15"  style="font-family: Verdana; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
			<td valign="top">
		  </td>
			<td>
			...
			<td>
			<p align="left">
													<input type="text" name="link2" size="15" dir="ltr" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			...
			<td>
			<p align="left">
													<input type="text"  name="text3" size="15" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			...
			<td rowspan="3">
			<p align="left">
													<input type="text" name="link3" size="15" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
		...
		<tr>
		  <td height="19" valign="top">
			...
			<td>
			<p align="left">
													<input type="text"  name="text4" size="15" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="link4" size="15" dir="ltr" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			...
			<td>
			<p align="left">
													<input type="text" name="text5" size="15" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="link5" size="15" dir="ltr" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text"  name="text6" size="15"  style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="link6" size="15" dir="ltr" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="text7" size="15" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="link7" size="15" dir="ltr" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="text8" size="15" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="link8" size="15" dir="ltr" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="text9" size="15" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="link9" size="15" dir="ltr" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text"  name="text10" size="15" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
			...
			<td>
			<p align="left">
													<input type="text" name="link10" size="15" dir="ltr" style="font-family: Tahoma; font-size: 8pt; color: #FF6600; border: 1px dotted #000000; background-color: #ffffff"></td>
		</tr>
		<tr>
			<td height="19">
			<p align="left"></td>
...
$img = $_POST['img'];
$artist = $_POST['artist'];
$artistabc = $_POST['artistabc'];
$album = $_POST['album'];
$date = $_POST['date'];


mysql_query("INSERT INTO mp3 (text1,link1,text2,link2,text3,link3,text4,link4,text5,link5,text6,link6,text7,link7,text8,link8,text9,link9,text10,link10,date,img,artist,artistabc,album ) VALUES ('$text1','$link1','$text2','$link2','$text3','$link3','$text4','$link4','$text5','$link5','$text6','$link6','$text7','$link7','$text8','$link8','$text9','$link9','$text10','$link10','$date','$img','$artist','$artistabc','$album')");
echo "<font face='Tahoma' color='#9C9C9C' style='font-size: 8pt'><span lang='fa'>New Album Added successfully</span></font>";
