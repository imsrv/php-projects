											...
											<table  border="0" cellspacing="0" cellpadding="0" style="background:URL(images/back_bot.gif) no-repeat bottom; height:100%">
											  ...
											  <tr>
												<td height="529" valign="top">												 											 	  <div style="margin-left:25px; margin-top:18px ">														
												  ...
												  <form action="add-video-process.php" method="post" name="video" id="video">
												  <table  border="0" cellspacing="0" cellpadding="0">
												    <!--DWLayoutTable-->
												      <?php 
include("../config.php");
...
mysql_select_db($db_name) or die(mysql_error());
	   $id=$_GET["id"];
											...
											mysql_select_db($db_name) or die(mysql_error());
												...
												$result = mysql_query("SELECT * FROM video WHERE id LIKE '$id'");
												while($r=mysql_fetch_array($result))
												{
												$video=$r["video"];
												$artist=$r["artist"];
												$link=$r["link"];
												$artistabc=$r["artistabc"];
												$id=$r["id"];
												$img=$r["img"];
												}
												?>
														  ...
														  <td width="1658" valign="top" >Artist :</td>
														    <td width="100" valign="top" ><input name="artist" type="text" id="artist" value="<?=$artist?>" size="20"></td>
														  <td width="12" >&nbsp;</td>
														  <td>&nbsp;</td>
														  </tr>
														  <tr>
														    ...
														    <td valign="top" ><input name="video" type="text" id="video" value="<?=$video?>" size="20"></td>
												    <td ></td>
												    <td>&nbsp;</td>
												    </tr>
														  <tr>
														    ...
														    <td valign="top" ><input name="link" type="text" id="link" value="<?=$link?>" size="20"></td>
												    <td ></td>
												    <td>&nbsp;</td>
												    </tr>
														  <tr>
														    <td height="18" ></td>
														    <td >First Letter Of artist name : </td>
														    <td > <select size="1" name="artistabc" style="font-family: Verdana; font-size: 8pt; color: #009900; border: 1px dotted #000000; background-color: #ffffff">
													<option>A</option>
													<option>B</option>
													<option>C</option>
													<option>D</option>
												    ...
												    <td>&nbsp;</td>
														  ...
														  <tr>
														    ...
														    <td valign="top" ><input name="img" type="text" id="img" value="<?=$img?>" size="20"></td>
													<td>&nbsp;</td>
												    <td>&nbsp;</td>
												    <tr>
			<td height="19">
												    <td valign="top">Write The Following Code In (<?=$id?>) </td>
													<td valign="top"><input name="textfield" type="text" size="20"  value="<?=$id?>" size="20"></td>
													<td>&nbsp;</td>
												    <td>&nbsp;</td>
												    </tr>
														  <tr>
												    ...
												    <td>&nbsp;</td>
														  ...
														  <tr>
														    <td height="21" ></td>
														    <td valign="top" ><input name="Submit" type="submit" id="Submit" value="Submit" value="></td>
														    <td ></td>
														    <td ></td>
												    </tr>
														  <tr>
																					  ...
																					  <tr>
																						<td valign="top" style="background:URL(images/r_b.gif) no-repeat right bottom; width:100%; height:100%">
																							<div style="margin-left:11px; margin-top:12px ">																						    
																							  ...
																							  <p align="center">This Website Powered By Persian MP3 Which is writen by A.Ghotbi (Persian Script Team),This Script Is Completely Free And You Can Download It From Www.Persianscript.com. If You Have Any Comments or Sugestion You can Contact us : nomad_6_6_6@hotmail.com and nomad_6_6_6@yahoo.com, And You Can Also contact Us With The Form In Contact Us page of Our Official Website. And If You Need Any CMS Script You Can Also Order It And We Will Do It For Free!!! (Limited)</p>
																							</div>
																						</td>
																					  </tr>
																					</table>
