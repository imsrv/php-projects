											...
											<table  border="0" cellspacing="0" cellpadding="0" style="background:URL(images/back_bot.gif) no-repeat bottom; height:100%">
											  ...
											  <tr>
												<td height="529" valign="top">												 											 	  <div style="margin-left:25px; margin-top:18px ">														
												  ...
												  <form action="add-news-process.php" method="post">
												    <table  border="0" cellspacing="0" cellpadding="0">
												    <!--DWLayoutTable-->
														  <tr>
															<td height="13" colspan="2" valign="top" >Add News </td>
														  <td width="170" ></td>
														  <td width="81" ></td>
														  <td width="32" ></td>
														  </tr>
												    ...
												    <td ></td>
														  ...
														  <tr>
														    ...
														    <td colspan="2" valign="top" ><input name="headline" type="text" id="headline" size="50" maxlength="100"></td>
												    <td >&nbsp;</td>
												    </tr>
														  <tr>
														    <td height="21" >&nbsp;</td>
												    ...
												    <td ></td>
														  ...
														  <tr>
														    <td height="134" >&nbsp;</td>
														    <td colspan="3" valign="top" ><textarea name="news" cols="35" rows="7" id="news"></textarea></td>
														    <td ></td>
												    </tr>
														  <tr>
														    <td height="21" >&nbsp;</td>
