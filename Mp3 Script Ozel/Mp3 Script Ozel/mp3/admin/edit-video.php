...
$video=$r["video"];
$id=$r["id"];
echo "<img border='0' src='../images/document.gif' width='11' height='11'><a href='edit-video1.php?id=$id'><font face='Tahoma' color='#FF0000' style='font-size: 8pt'><span lang='fa'style='text-decoration: none'>Edit &nbsp;</span><span style='text-decoration: none'>$video   video  |</span></font></a>";
echo "  ";
}
?>&nbsp;</td>
														  </tr>
