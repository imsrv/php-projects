...
mysql_query("INSERT INTO video (artist,video,link,artistabc,img) VALUES ('$artist','$video','$link','$artistabc','$img')");
echo "<font face='Tahoma' color='#9C9C9C' style='font-size: 8pt'><span lang='fa'>New Video Added Successfully</span></font>";
?></td>
														  </tr>
												  </table>
