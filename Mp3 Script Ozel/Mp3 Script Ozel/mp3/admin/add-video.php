											...
											<table  border="0" cellspacing="0" cellpadding="0" style="background:URL(images/back_bot.gif) no-repeat bottom; height:100%">
											  ...
											  <tr>
												<td height="529" valign="top">												 											 	  <div style="margin-left:25px; margin-top:18px ">														
												  ...
												  <form action="add-video1.php" method="post" name="video" id="video">
												  <table  border="0" cellspacing="0" cellpadding="0">
												    <!--DWLayoutTable-->
														  <tr>
															<td width="10" height="19" ></td>
														  <td width="135" valign="top" >Artist :</td>
														    <td width="149" valign="top" ><input name="artist" type="text" id="artist"></td>
														  <td width="12" >&nbsp;</td>
														  </tr>
														  <tr>
														    <td height="19" ></td>
														    <td valign="top" >Video :</td>
														    <td valign="top" ><input name="video" type="text" id="video"></td>
												    <td ></td>
												    </tr>
														  <tr>
														    <td height="19" ></td>
														    <td valign="top" >Video Link : </td>
														    <td valign="top" ><input name="link" type="text" id="link"></td>
												    <td ></td>
												    </tr>
														  <tr>
														    <td height="18" ></td>
												    ...
												    <td ></td>
														  ...
														  <tr>
														    ...
														    <td valign="top" ><input name="img" type="text" id="img"></td>
														    <td ></td>
												    </tr>
														  <tr>
														    <td height="2" ></td>
														  ...
														  <tr>
														    <td height="21" ></td>
														    <td valign="top" ><input name="Submit" type="submit" id="Submit" value="Submit"></td>
														    <td ></td>
														    <td ></td>
												    </tr>
														  <tr>
