...
$result = mysql_query("select * FROM mp3 order by id");
...
$album=$r["album"];
$id=$r["id"];
echo "<img border='0' src='../images/document.gif' width='11' height='11'><a href='delete-album1.php?do=delete&id=$id'><font face='Tahoma' color='#FF0000' style='font-size: 8pt'><span lang='fa'style='text-decoration: none'>Delete &nbsp;</span><span style='text-decoration: none'>$album   Album  |</span></font></a>";
echo "  ";
}
}
?>
