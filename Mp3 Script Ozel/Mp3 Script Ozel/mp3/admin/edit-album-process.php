...
mysql_query("UPDATE mp3 SET text1 = '$text1' WHERE id=$id ");
mysql_query("UPDATE mp3 SET text2 = '$text2' WHERE id=$id ");
mysql_query("UPDATE mp3 SET text3 = '$text3' WHERE id=$id ");
mysql_query("UPDATE mp3 SET text4 = '$text4' WHERE id=$id ");
mysql_query("UPDATE mp3 SET text5 = '$text5' WHERE id=$id ");
mysql_query("UPDATE mp3 SET text6 = '$text6' WHERE id=$id ");
mysql_query("UPDATE mp3 SET text7 = '$text7' WHERE id=$id ");
mysql_query("UPDATE mp3 SET text8 = '$text8' WHERE id=$id ");
mysql_query("UPDATE mp3 SET text9 = '$text9' WHERE id=$id ");
mysql_query("UPDATE mp3 SET text10 = '$text10' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link1 = '$link1' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link2 = '$link2' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link3 = '$link3' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link4 = '$link4' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link5 = '$link5' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link6 = '$link6' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link7 = '$link7' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link8 = '$link8' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link9 = '$link9' WHERE id=$id ");
mysql_query("UPDATE mp3 SET link10 = '$link10' WHERE id=$id ");
mysql_query("UPDATE mp3 SET img = '$img' WHERE id=$id ");
mysql_query("UPDATE mp3 SET artist = '$artist' WHERE id=$id ");
mysql_query("UPDATE mp3 SET artistabc = '$artistabc' WHERE id=$id ");
{
echo "<p align='right'><font face='Tahoma' style='font-size: 8pt' color='#FF0000'>
<span lang='fa'>Album Edited !</span></font></p>";
}?>
<?php	mysql_close(); ?>
&nbsp;</td>
														  </tr>
