...
$result = mysql_query("select * FROM video order by id");
...
$video=$r["video"];
$id=$r["id"];
echo "<img border='0' src='../images/document.gif' width='11' height='11'><a href='delete-video1.php?do=delete&id=$id'><font face='Tahoma' color='#FF0000' style='font-size: 8pt'><span lang='fa'style='text-decoration: none'>Delete &nbsp;</span><span style='text-decoration: none'>$video   Video  |</span></font></a>";
echo "  ";
}
}
?>
