...
<tr><td width="100%">
<font size=5>USER LOG ($data{user})</font>
<form action="$cgi/adcadm.pl" method="post">
<input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="clearlog"><input type="hidden" name="user" value="$data{user}">
<table border="0" width="100%" cellpadding="0" bgcolor="#97D0E1">
<tr><td bgcolor="#82c7db" width="25%"><font size=2><b>Date</b></font></td><td bgcolor="#82c7db" width="55%"><font size=2><b>Comment</b></font></td><td bgcolor="#82c7db" width="25%"><font size=2><b>Visitor IP</b></font></td></tr>
$ndta
<tr><td colspan=3 align="right"><input type="image" border=0 src="$adcenter/images/delete.gif" width=75 height=23></td></tr>
</table></form>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
