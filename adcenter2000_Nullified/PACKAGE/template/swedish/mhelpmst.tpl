...
<tr><td>
<font size=5 color="#000000">MÅNADS STATISTIK</font>
<br><font size=2>
Här kan du se statistik för varje månad till dina banners. Du kan välja vilken banner (nummer) och år för den banner du vill se statistik på. Det visas även med grafik.
</font></td></tr>
</table></center></div>
<!--NON-STATIC-->
</td></tr></table>
