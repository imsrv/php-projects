...
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_gsestat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="GET HELP"></a>&nbsp;&nbsp;<font size=5 color="#000000">GENERELLA INSTÄLLNINGAR</font>
<table border="0" width="100%" bgcolor="#97D0E1" cellspacing="0" cellpadding="0">
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;URL</font></td>
<td width="50%" bgcolor="#82c7db"><input type="text" name="url" size="51" value="$url"></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Titel</font></td>
<td width="50%"><input type="text" name="sitetitle" size="51" value="$sitetitle"></td></tr>
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Beskrivning</font></td>
<td width="50%" bgcolor="#82c7db"><input type="text" name="description" size="51" value="$description"></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Sökord</font></td>
<td width="50%"><input type="text" name="keywords" size="51" value="$keyword"></td></tr>
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Kategori</font></td>
<td width="50%" bgcolor="#82c7db"><select name="category">
$result
</select></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Visa "rich media" banners?</font></td>
