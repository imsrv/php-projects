...
<tr><td width="100%">
<table border="0" width="100%">
<tr><td width="100%"><font size="4" face="Verdana,Arial,Helvetica"><b>SWIMBANNER MENY</b></font></td></tr>
...
<tr><td>
<font size=5 color="#000000">LADDA UPP GIF ELLER JPG BANNER</font>
<font size=2><center>
<form action="$cgi/adcuplsb.pl" method="post" enctype="multipart/form-data">
<input type="hidden" name="name" value="$data{name}"><input type="hidden" name="lang" value="$data{lang}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="spot" value="$data{spot}"><input type="hidden" name="method" value="$data{method}"><input type="file" name="UploadBanner" size="20"><input type="submit" value="Ladda upp"><br>Bannern måste vara $sbwidth x $sbheight i GIF eller JPG<br>och inte mer än $sbsize bytes</form></center>
<br><center>DIN NUVARANDE BANNER:
$result1
<br>DIN NUVARANDE TEXT:
<br>$result2
</center></font>
</td></tr>
</table></center></div>
