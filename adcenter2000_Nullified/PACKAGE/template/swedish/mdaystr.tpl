...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Totala visningar under $data{month} $data{year}: $totimp </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
<div align=center><center><table width="$table" bgcolor=white cellpadding=0 cellspacing=0 border=1><tr><td><table width="$table" bgcolor=white cellpadding=0 cellspacing=0>
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Totala klick under $data{month} $data{year}: $totclc </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
<tr><td width="40%" valign="top"><font size=2><b>Datum</b></font></td><td width="30%" align="right"><font size=2><b>Visningar</b></font></td><td width="30%" align="right"><font size=2><b>Klick</b></font></td></tr>
@mstats
<tr><td colspan=3 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>daglig statistik för <b>$data{name}</b> ($month $year)</font></td></tr>
</table>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
