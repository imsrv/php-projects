...
<select name=type><option value="web">Web</option><option value="people">Personer</option></select><input type=text name=words size=40><br><font size=2>Sök efter en person, genom<select name="searchby"><option value="name">Namn</option><option value="address">Adress</option><option value="city">Kommun</option><option value="country">Land</option><option value="phone">Tele</option><option value="email">E-post</option></select></font></td><td align=left valign=top>
<input type="image" border="0" src="$adcenter/images/$data{lang}/search.gif" width="142" height="23">
</td></tr></table></form>
</td></tr>
<tr><td align=center colspan=2>
<font size=2 color=black>Sökresultat för: <b>$data{words}</b></font><br><br>
<div align=right>
<table width="93%">
<tr><td>
@result
