...
<tr><td>
<font size=5 color="#000000">RÄKNARE - DAGLIG STATISTIK (UNIK)</font><br>
...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Unika besökare för $data{month} $data{year}: $totimp </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
<tr><td width="60%" valign="top"><font size=2><b>Datum</b></font></td><td width="40%" align="right"><font size=2><b>Besökare</b></font></td></tr>
@mstats
<tr><td colspan=2 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>Unika besökare under <b>$data{name}</b> ($data{month} $data{year})</font></td></tr>
</table>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
