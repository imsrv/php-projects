...
<tr><td>
<font size=5 color="#000000">HTML KOD</font>
<br><font size=2>
Du måste "kopiera & klistra in" html koden på de sidor som du vill ha banner annonser på med de storlekarna som du valt att visa. Använd helst en ren textredigerare när du klistar in koden på sidan, tex notepad.
</font></td></tr>
</table></center></div>
<!--NON-STATIC-->
</td></tr></table>
