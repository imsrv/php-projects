...
<table border="0" width="100%">
<tr><td width="100%" colspan="2">
<font size="4" face="Verdana,Arial,Helvetica"><b>BANNER $data{spot} KOD</b></font></td></tr>
...
<tr><td width="100%">
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_hcostat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="HJÄLP"></a>&nbsp;&nbsp;<font size=5 color="#000000">HTML KOD</font><br>
<font size=2><form>
<center>För att annonsera med banner som har följande mått<br>
<img src="$adcenter/images/$data{lang}/$banwidth[$data{spot}]x$banheight[$data{spot}].gif"><br>
måste du sätta in följande html kod på din sida:<br><b><font size="2">
...
Om du använder koden på ASP (VBScript baserade) sidor, använd följande kod:<br><b><font size="2">
<textarea cols=63 rows=8>
<!--Start $owntitle kod-->
<script language="Javascript" src="$cgi/nph-adcnet.pl?$data{name}&$data{spot}&<%=Rnd%>"></script>
<!--Slut $owntitle kod-->
</textarea></font></b>
Om du använder koden på ASP (JScript baserade) sidor, använd följande kod:<br><b><font size="2">
<textarea cols=63 rows=8>
<!--Start $owntitle kod-->
