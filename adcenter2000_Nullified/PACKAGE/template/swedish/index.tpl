...
Välkommen till vårt banner nätverk. Gå med och få gratis marknadsföring av din hemsida på andra medlemmars sidor. Vid medlemskap får du även gratis mailinglista och räknare till din hemsida. Du kan även använda dig av "rich media" banners. Tack för att du väljer oss.
</font></div><br>
...
Användare <font size=2><input type=text name=name size=8 maxlength=8></font> Lösenord <font size=2><input type=password name=password size=8 maxlength=8></font>
...
<b>GLÖMT LÖSENORD?<br><font size=1>$error1</font></b>
</font></td></tr>
...
<select name=type><option value="web">Web</option><option value="people">Personer</option></select><input type=text name=words size=40><br><font size=2>Sök efter person, genom <select name="searchby"><option value="name">Namn</option><option value="address">Adress</option><option value="city">Stad</option><option value="country">Land</option><option value="phone">Tele</option><option value="email">E-post</option></select></font></td><td align=left valign=top>
