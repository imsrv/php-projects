...
<!--NON-STATIC-->
<br><div align="center"><center><table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr><td width="100%">
<font size=5 color="#000000">PROBLEM? FRÅGA OSS...</font><br>
<font size=2><form action="$cgi/adcstat.pl" method=post>
<input type="hidden" name="name" value="$data{name}"><input type="hidden" name="lang" value="$data{lang}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="sendsup">
<center><font size="2">
<textarea name=message cols=63 rows=8>
</textarea></font>
