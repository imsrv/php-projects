...
<tr><td>
<font size=5 color="#000000">DAGLIG STATISTIK</font>
...
@mstats
<tr><td colspan=3 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>daglig statistik under <b>$data{name}</b> ($month $year)</font></td></tr>
</table>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
