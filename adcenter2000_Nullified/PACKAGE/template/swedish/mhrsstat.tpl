...
<tr><td width="100%">
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_hrsstat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="HJÄLP"></a>&nbsp;&nbsp;<font size=5 color="#000000">STATISTIK PER TIMME</font>
