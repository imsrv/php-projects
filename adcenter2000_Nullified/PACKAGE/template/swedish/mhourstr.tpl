...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Totala visningar för $data{date} $data{month} $data{year}: $totimp </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
