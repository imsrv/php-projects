...
<tr><td width="100%" valign=center><font size=2 face="Verdana,Arial,Helvetica"><form action="$cgi/adcstat.pl" method=post><table><tr><td><input type=hidden name=lang value=$data{lang}><input type=hidden name=name value=$data{name}><input type=hidden name=password value=$data{password}><select name=method><option $selectede{str} value=str>Övergripande statistik</option><option $selectede{montlystr} value=montlystr>Månads Statisik</option><option $selectede{dailystr} value=dailystr>Daglig Statisik</option><option $selectede{hourlystr} value=hourlystr>Statisik per timme</option><option $selectede{manstr} value=manstr>Banner</option><option $selectede{htmlstr} value=htmlstr>HTML kod</option></select></td><td><input type=image border=0 src="$adcenter/images/$data{lang}/goto.gif" width="70" height="23"></td></tr></table></form></font></td></tr>
</table>
</td>
</tr>
</table>
...
<font size=5 color="#000000">ÖVERGRIPANDE STATISIK</font>
<table border="0" width="100%" cellpadding="2" cellspacing=0 bgcolor="#97D0E1">
<tr><td width="40%" valign="top"><font size=2><b>Totala visningar</b></font></td><td width="60%" align="right"><font size=2>$itx</font></td></tr>
<tr><td width="40%" bgcolor="#82c7db" valign="top"><font size=2><b>Totala klick</b></font></td><td width="60%" align="right" bgcolor="#82c7db"><font size=2>$ctx</font></td></tr>
<tr><td width="40%" valign="top"><font size=2><b>Klick per visning</b></font></td><td width="60%" align="right"><font size=2>$ctr</font></td></tr>
