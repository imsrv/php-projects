...
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_psestat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="GET HELP"></a>&nbsp;&nbsp;<font size=5 color="#000000">PERSONLIGA INSTÄLLNINGAR</font>
<table border="0" width="100%" bgcolor="#97D0E1" cellspacing="0" cellpadding="0">
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Namn</font></td>
<td width="50%" bgcolor="#82c7db"><input type="text" name="realname" size="48" value="$name"></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Adress</font></td>
<td width="50%"><input type="text" name="street" size="48" value="$street"></td></tr>
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Kommun</font></td>
<td width="50%" bgcolor="#82c7db"><input type="text" name="city" size="48" value="$city"></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Post nr</font></td>
<td width="50%"><input type="text" name="zip" size="48" value="$zip"></td></tr>
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Land</font></td>
<td width="50%" bgcolor="#82c7db"><select name="country">
$result
</select></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Tele</font></td>
<td width="50%"><input type="text" name="phone" size="48" value="$phone"></td></tr>
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;E-post</font></td>
<td width="50%" bgcolor="#82c7db"><input type="text" name="uemail" size="48" value="$uemail"></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Visas i offentlig databas</font></td>
