...
<font size=2><form>
Om du vill kan du enkelt skaffa en räknare till din hemsida, använd följande html kod:<br>
<font color=red>VARIANT A (VISA ALLA BESÖKARE):</font><br>
<b><font size="2">
...
<font color=red>VARIANT B (VISA UNIKA BESÖKARE):</font><br>
<b><font size="2">
<center><textarea cols=62 rows=8>
<!--START $owntitle counter kod-->
<script type="text/javascript" language="Javascript">
