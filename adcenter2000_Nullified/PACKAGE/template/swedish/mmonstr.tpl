...
<tr><td width="100%">
<table border="0" width="100%">
<tr><td width="50%"><font size="4" face="Verdana,Arial,Helvetica"><b>SWIMBANNER MENY</b></font></td>
<td width="50%" align=right><font size="4" face="Verdana,Arial,Helvetica"><b>VÄLJ ÅR</b></font></td></tr>
<tr><td width="100%" valign=center><font size=2 face="Verdana,Arial,Helvetica"><form action="$cgi/adcstat.pl" method=post><table><tr><td><input type=hidden name=lang value=$data{lang}><input type=hidden name=name value=$data{name}><input type=hidden name=password value=$data{password}><select name=method><option $selectede{str} value=str>Övergripande statistik</option><option $selectede{montlystr} value=montlystr>Månads Statisik</option><option $selectede{dailystr} value=dailystr>Daglig Statisik</option><option $selectede{hourlystr} value=hourlystr>Statisik per timme</option><option $selectede{manstr} value=manstr>Manage Ads</option><option $selectede{htmlstr} value=htmlstr>HTML kod</option></select></td><td><input type=image border=0 src="$adcenter/images/$data{lang}/goto.gif" width="70" height="23"></td></tr></table></form></font></td>
<td><form action="$cgi/adcstat.pl" method=post><table><tr><td><input type=hidden name=spot value=$data{spot}><input type=hidden name=name value=$data{name}><input type=hidden name=password value=$data{password}><input type=hidden name=method value=montlystr><input type="hidden" name="lang" value="$data{lang}"><input type=text name=year value=$data{year} size=4></td><td><input type=image border=0 src="$adcenter/images/$data{lang}/getstats.gif" width="96" height="23"></td></tr></table></form></td></tr>
</table>
</td>
</tr>
</table>
...
<tr><td width="100%" colspan=2>
<font size=5 color="#000000">MÅNADS STATISTIK</font></td></tr>
<tr><td width="30%">
...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Totala visningar under $data{year}: $totimp </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Totala klick under $data{year}: $totclc </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
<tr><td width="60%" valign="top"><font size=2><b>Månad</b></font></td><td width="20%" align="right"><font size=2><b>Visningar</b></font></td><td width="20%" align="right"><font size=2><b>Klick</b></font></td></tr>
<tr><td bgcolor="#82C7DB"><font size=2><b>Januari</b></font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mimp[1]</font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mclc[1]</font></td></tr>
<tr><td><font size=2><b>Februari</b></font></td><td align="right"><font size=2>$mimp[2]</font></td><td align="right"><font size=2>$mclc[2]</font></td></tr>
<tr><td bgcolor="#82C7DB"><font size=2><b>Mars</b></font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mimp[3]</font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mclc[3]</font></td></tr>
...
<tr><td bgcolor="#82C7DB"><font size=2><b>Maj</b></font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mimp[5]</font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mclc[5]</font></td></tr>
<tr><td><font size=2><b>Juni</b></font></td><td align="right"><font size=2>$mimp[6]</font></td><td align="right"><font size=2>$mclc[6]</font></td></tr>
<tr><td bgcolor="#82C7DB"><font size=2><b>Juli</b></font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mimp[7]</font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mclc[7]</font></td></tr>
<tr><td><font size=2><b>Augusti</b></font></td><td align="right"><font size=2>$mimp[8]</font></td><td align="right"><font size=2>$mclc[8]</font></td></tr>
...
<tr><td><font size=2><b>Oktober</b></font></td><td align="right"><font size=2>$mimp[10]</font></td><td align="right"><font size=2>$mclc[10]</font></td></tr>
...
<tr><td colspan=3 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>Månads statistik för <b>$data{name}</b> ($data{year})</font></td></tr>
</table>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
