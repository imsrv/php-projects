...
<tr><td>
<font size=5 color="#000000">RÄKNARE - MÅNADS STATISTIK</font><br>
...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Totala besökare under $data{year}: $totimp </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
<tr><td colspan=2 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>Månads statistik för <b>$data{name}</b> ($data{year})</font></td></tr>
</table></td></tr></table>
</center></div>
<!--NON-STATIC-->
</td></tr></table>
