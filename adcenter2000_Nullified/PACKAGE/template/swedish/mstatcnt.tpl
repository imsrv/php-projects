...
<title>Svenska Banner Byten</title></head>
...
<tr><td width="100%">
<form action="$cgi/adcstat.cgi" method="get"><input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="lang" value="$data{lang}">
...
<tr><td>
<form action="$cgi/adcstat.cgi" method=post>
<font size=5 color="#000000">RÄKNAR INSTÄLLNING</font>
<table border="0" width="100%" cellspacing=0 cellpadding="2" bgcolor="#97D0E1">
<tr><td width="40%" valign="top"><font size=2><b>Öka totala beökare med</b></font></td><td width="60%" align="right"><font size=2><input type=text name=tpreset value="$tpreset" size=14></font></td></tr>
<tr><td width="40%" bgcolor="#82C7DB" valign="top"><font size=2><b>Öka unkia besökare med</b></font></td><td width="60%" align="right" bgcolor="#82C7DB"><font size=2><input type=text name=upreset value="$upreset" size=14></font></td></tr>
...
<tr><td>
<form action="$cgi/adcstat.cgi" method=post>
<font size=5 color="#000000">ÖVERGRIPANDE STATISTIK</font>
<table border="0" width="100%" cellspacing=0 cellpadding="2" bgcolor="#97D0E1">
<tr><td width="40%" valign="top"><font size=2><b>Totala besökare</b></font></td><td width="60%" align="right"><font size=2>$globcnt</font></td></tr>
<tr><td width="40%" bgcolor="#82C7DB" valign="top"><font size=2><b>Unika besökare</b></font></td><td width="60%" align="right" bgcolor="#82C7DB"><font size=2>$unqcnt</font></td></tr>
<tr><td width="40%" valign="top"><font size=2><b>Popularitet index</b></font></td><td width="60%" align="right"><font size=2>$popularity</font></td></tr>
...
<tr><td>
<font size=5 color="#000000">UTÖKAD STATISTIK</font>
<br><font size=5 color="#000000">WEBLÄSARE</font>
...
<tr><td width="40%" valign="top"><font size=2><b>Annan</b></font></td><td width="60%" align="right"><font size=2>$ext{bother}</font></td></tr>
</table>
</td></tr>
<tr><td>
<font size=5 color="#000000">SKÄRM UPPLÖSNING</font>
<table border="0" width="100%" cellpadding="2" cellspacing=0 bgcolor="#97D0E1">
...
<tr><td>
<font size=5 color="#000000">LAND</font>
<table border="0" width="100%" cellpadding="2" cellspacing=0 bgcolor="#97D0E1">
$result
</table>
</td></tr>
