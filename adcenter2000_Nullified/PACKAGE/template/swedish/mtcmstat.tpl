...
<tr><td>
<font size=5 color="#000000">MÅLTAVLOR - LÄNDER</font><br>
<font size=2>Här kan du välja måltavlor för dina banners. Din banner kommer bara att visas på sidor i valda länder.</font><br>
<font size=2><center>
