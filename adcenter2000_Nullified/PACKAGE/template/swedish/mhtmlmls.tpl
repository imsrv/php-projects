...
<br><font size=2><form>
Använd följande html kod så att dina besökare kan anmäla sig till din mailinglista:<br><b><font size="2">
<center><textarea cols=64 rows=8>
<!--START $owntitle maillist kod-->
<form action="$cgi/adcsubsc.pl" method="post"><input type="hidden" name="destination" value="$data{name}">Din e-post: <input type="text" size="30" name="email"><input type="submit" value="OK"><br><font size=1><input type="radio" name="method" checked value="subscribe"> Gå med &amp;nbsp;&amp;nbsp;&amp;nbsp;<input type="radio" name="method" value="unsubscribe"> Gå ur</font></form>
<!--SLUT $owntitle maillist kod-->
