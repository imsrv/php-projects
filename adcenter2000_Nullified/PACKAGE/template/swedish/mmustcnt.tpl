...
<font color="#ffffff" size="5" face="Verdana,Arial,Helvetica"><b>BANNER NÄVERK</b></font></td></tr>
...
<tr><td>
<font size=5 color="#000000">RÄKNARE - MÅNADS STATISTIK (UNIK)</font><br>
...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Unika besökare under $data{year}: $totimp </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
<tr><td width="60%" valign="top"><font size=2><b>Månad</b></font></td><td width="40%" align="right"><font size=2><b>Besökare</b></font></td></tr>
...
<tr><td colspan=2 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>Räknare månads statistik (unik) för <b>$data{name}</b> ($data{year})</font></td></tr>
</table></td></tr></table>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
