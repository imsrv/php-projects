...
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_extstat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="HJÄLP"></a>&nbsp;&nbsp;<font size=5 color="#000000">UTÖKAD STATISTIK</font>
<table border="0" width="100%" cellpadding="2" cellspacing=0 bgcolor="#97D0E1">
<tr><td width="60%" valign="top"><font size=2><b>Din banner visades hos</b></font></td><td width="20%" align="right"><font size=2><b>Visningar</b></font></td><td width="20%" align="right"><font size=2><b>Klick</b></font></td></tr>
@res
<tr><td colspan=3><font size=1><b>Statistik sedan $adate</font></td></tr>
