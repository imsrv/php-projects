...
<tr><td align=center colspan=2>
<font size=4><b>MEDLEMSKAP</b></font>
<form action="$cgi/adcjoin.pl" method=post>
<input type=hidden name=lang value="$data{lang}">
<input type=hidden name=method value=1>
<table width="100%">
<tr><td width="25%"><font size=2><b>Namn</b></font></td>
<td width="75%" colspan="3"><input type="text" name="Name" size="51"></td></tr>
<tr><td><font size=2><b>Adress</b></font></td>
<td colspan="3"><input type="text" name="Address" size="51"></td></tr>
<tr><td width="25%"><font size=2><b>Kommun</b></font></td>
<td width="25%"><input type="text" name="City" size="18"></td>
<td width="15%"><font size=2><b>Post nr</b></font></td>
<td width="35%"><input type="text" name="ZipCode" size="14"></td></tr>
<tr><td><font size=2><b>Land</b></font></td>
<td colspan="3"><select name="Country" size="1">
$countries
</select></td></tr>
<tr><td><font size=2><b>Tele</b></font></td>
<td><input type="text" name="Phone" size="18"></td>
<td><font size=2><b>E-post</b></font></td>
<td><input type="text" name="EMail" size="14"></td></tr>
<tr><td><font size=2><b>Visas i databas?</b></font></td>
<td>$showcheck</td></tr>
<tr><td colspan="4" align="center"><font color="#FFFFFF"><small><small><small>VAR GOD OCH FYLL I SAMTLIGA FÄLT I FORMULÄRET</small></small></small></font></td></tr>
<tr><td><font size=2><b>Användare</b></font></td>
<td colspan="3"><input type="text" name="Username" size="51" maxlength="8"></td></tr>
<tr><td><font size=2><b>Lösenord</b></font></td>
<td colspan="3"><input type="text" name="Password" size="51" maxlength="8"></td></tr>
<tr><td><font size=2><b>URL</b></font></td>
<td colspan="3"><input type="text" name="URL" size="51"></td></tr>
<tr><td><font size=2><b>Titel</b></font></td>
<td colspan="3"><input type="text" name="Sitetitle" size="51"></td></tr>
<tr><td><font size=2><b>Kategori</b></font></td>
<td colspan="3">
<SELECT NAME="Category">
$categories
</SELECT></td></tr>
<tr><td><font size=2><b>Beskrivning</b></font></td>
<td colspan="3"><input type="text" name="Description" size="51"></td></tr>
<tr><td><font size=2><b>Sökord</b></font></td>
<td colspan="3"><input type="text" name="Keywords" size="51"></td></tr>
