...
<tr><td>
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_daystat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="HJÄLP"></a>&nbsp;&nbsp;<font size=5 color="#000000">DAGLIG STATISTIK</font>
...
@mstats
<tr><td colspan=3 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>dalig statistik för <b>$data{name}</b> ($month $year)</font></td></tr>
</table>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
