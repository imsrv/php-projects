...
<tr><td>
<font size=5 color="#000000">LADDA UPP HTML KOD</font><br>
<font size=2><center>Var god och ändra inte URL:en till en binär fil (bild).
...
$code
</textarea><br><input type="submit" value="Ladda upp"><br>Bannern måste vara $banwidth[$data{spot}] x $banheight[$data{spot}]</form></center>
</font></td></tr>
</table></center></div>
<!--NON-STATIC-->
</td></tr></table>
