...
<tr><td colspan=2 align=center><font size=2>Visa <select name=top><option>10<option>25<option>100</select> poster i $types</font></td></tr>
</table></form>
<font size=4><b>TOPP $data{top} SIDOR (SwimBanner Annonsering)</b></font><br><br>
<table width="100%" cellpadding=2 cellspacing=0 bgcolor="#97d0e1">
<tr><td width="70%" background="$adcenter/images/$data{lang}/globalbk.gif"><font size=2 color=white><b>Sidor</b></font></td><td width="15%" background="$adcenter/images/$data{lang}/globalbk.gif" align=right><font size=2 color=white><b>Visningar</b></font></td><td width="15%" background="$adcenter/images/$data{lang}/globalbk.gif" align=right><font size=2 color=white><b>Klick</b></font></td></tr>
$result
</table>
</td></tr>
</table></div>
