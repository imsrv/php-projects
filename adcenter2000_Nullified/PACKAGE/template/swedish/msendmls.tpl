...
<tr><td>
<font size=5 color="#000000">MAILINGLISTA</font>
<form method="post" action="$cgi/adcstat.pl">
<input type="hidden" name="lang" value="$data{lang}"><input type="hidden" name="email" value="$sea"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="maillist"><input type="hidden" name="name" value="$data{name}">
<table bgcolor="#97D0E1" border="0" width="100%" cellspacing="0" cellpadding="0" style="border: 0px none rgb(0,0,0)">
<tr><td colspan=2 align=center><font size="2">Du har <b>$total</b> medlemmar på din mailinglista</font></td></tr>
<tr><td width="35%" bgcolor="#82c7db"><font size="2"><b>Ämne</b></font></td>
<td width="65%" bgcolor="#82c7db"><input type="text" name="subject" size="51"></td></tr>
<tr><td colspan=2 align="center"><textarea name="body" cols=63 rows=8></textarea></td></tr>
<tr><td colspan=2 align="right"><input type="image" border=0 src="$adcenter/images/$data{lang}/mls.gif" width=84 height=23></td></tr>
</table></form></td></tr>
</table></center></div>
<!--NON-STATIC-->
</td></tr></table>
