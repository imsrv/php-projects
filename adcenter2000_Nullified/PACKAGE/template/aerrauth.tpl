...
<tr><td width="100%">
<form action="$cgi/adcadm.pl" method="post"><input type="hidden" name="method" value="genset">
<font size=5>LOGIN</font>
<table border="0" width="100%" bgcolor="#97D0E1" cellspacing="0" cellpadding="0">
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Login</font></td>
<td width="50%" bgcolor="#82c7db"><input type="text" name="name" size="48"></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Password</font></td>
<td width="50%"><input type="password" name="password" size="48"></td></tr>
<tr><td colspan=2 align="right" bgcolor="#82c7db"><input type="image" border=0 src="$adcenter/images/login.gif">
</td></tr>
</table></form></td></tr>
</table></center></div>
<!--NON-STATIC-->
