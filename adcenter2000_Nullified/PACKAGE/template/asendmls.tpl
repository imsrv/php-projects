...
<tr><td width="100%">
<font size=5>MAILLIST STATUS</font>
<table border="0" width="100%" cellpadding="0" bgcolor="#97D0E1">
<tr><td bgcolor="#82c7db"><font size=2>Sending newsletter to $count users</font></td></tr>
</table>
</td></tr>
<script type="text/javascript" language="Javascript">
window.open("$cgi/nph-adcamail.pl?method=maillist&name=$data{name}&password=$data{password}&num=$num", 'f', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=113,height=135');
</script>
</table></center></div>
<!--NON-STATIC-->
</td></tr></table>
