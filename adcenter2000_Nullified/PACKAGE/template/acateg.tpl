...
<tr><td width="100%">
<font size=5>REMOVE CATEGORY</font><br>
<font size=2><center>
<form action="$cgi/adcadm.pl" method="post"><input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="category">
...
<tr><td width="100%">
<font size=5>ADD CATEGORY</font>
<form action="$cgi/adcadm.pl" method="post">
<input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="addcateg">
<table border="0" width="100%" cellpadding="0" bgcolor="#97D0E1">
<tr><td width="40%" bgcolor="#82c7db"><font size=1><b>Category name</b></font></td><td width="60%" align="right" bgcolor="#82c7db"><font size=2><input type="text" size=48 name="categ"></font></td></tr>
<tr><td width="40%"><font size=1><b>Subcategory name</b></font></td><td width="60%" align="right"><font size=2><input type="text" size=48 name="subcateg"></font></td></tr>
