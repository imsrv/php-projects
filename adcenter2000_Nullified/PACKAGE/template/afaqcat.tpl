...
<table border="0" width="100%">
<tr><td width="100%" colspan="2">
<font size="4" face="Verdana,Arial,Helvetica"><b>FAQ MENU NAVIGATOR</b></font></td></tr>
<tr><td width="73%" valign=middle><font size=2 face="Verdana,Arial,Helvetica">
<select name=method>
<option $selectede{faq} value="faq">Categories</option>
<option $selectede{edit_faq} value="edit_faq">Edit FAQ</option>
<option $selectede{new_faq} value="new_faq">New queries</option>
</select></font>
</td><td width="27%" align="right"><input type=image border=0 src="$adcenter/images/goto.gif" width="70" height="23"></td></tr>
</table>
</form>
</td>
</tr>
...
<tr><td width="100%">
<br><font size=5 color=black>REMOVE CATEGORY</font>
<form method="post" action="$cgi/adcadm.pl">
<input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="rem_cat_faq">
<table bgcolor="#97D0E1" border="0" width="100%" cellspacing="0" cellpadding="1">
<tr><td width="35%" bgcolor="#82c7db"><font size="2"><b>Category</b></font></td>
<td width="65%" bgcolor="#82c7db" align="right"><select name="category">
$fcat
</select>
</td></tr>
...
<tr><td width="100%">
<font size=5 color=black>ADD CATEGORY</font>
<form method="post" action="$cgi/adcadm.pl">
<input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="add_cat_faq">
<table bgcolor="#97D0E1" border="0" width="100%" cellspacing="0" cellpadding="1">
<tr><td width="35%" bgcolor="#82c7db"><font size="2"><b>Category</b></font></td>
<td width="65%" align="right" bgcolor="#82c7db"><input type="text" name="category" size="48"></td></tr>
<tr><td width="35%"></td>
