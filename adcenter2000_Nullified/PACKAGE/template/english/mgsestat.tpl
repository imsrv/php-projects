...
<tr><td width="100%"><form method="post" action="$cgi/adcstat.pl"><input type="hidden" name="name" value="$data{name}"><input type="hidden" name="lang" value="$data{lang}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="m_general">
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_gsestat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="GET HELP"></a>&nbsp;&nbsp;<font size=5 color="#000000">GENERAL SETTINGS</font>
<table border="0" width="100%" bgcolor="#97D0E1" cellspacing="0" cellpadding="0">
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Site URL</font></td>
<td width="50%" bgcolor="#82c7db"><input type="text" name="url" size="51" value="$url"></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Site title</font></td>
<td width="50%"><input type="text" name="sitetitle" size="51" value="$sitetitle"></td></tr>
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Site description</font></td>
<td width="50%" bgcolor="#82c7db"><input type="text" name="description" size="51" value="$description"></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Keywords</font></td>
<td width="50%"><input type="text" name="keywords" size="51" value="$keyword"></td></tr>
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Category</font></td>
<td width="50%" bgcolor="#82c7db"><select name="category">
$result
</select></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Show rich media banners?</font></td>
<td width="50%"><input type="checkbox" name="show" value="1" $result2></td></tr>
<tr><td colspan=2 align="right"><input type="image" border=0 src="$adcenter/images/$data{lang}/proceed.gif" width=83 height=23>
</td></tr>
</table></form></td></tr>
<tr><td width="100%"><form method="post" action="$cgi/adcstat.pl"><input type="hidden" name="name" value="$data{name}"><input type="hidden" name="lang" value="$data{lang}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="m_transfer">
<font size=5 color="#000000">TRANSFER CREDITS</font>
<table border="0" width="100%" bgcolor="#97D0E1" cellspacing="0" cellpadding="0">
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;Status</font></td>
<td width="50%" bgcolor="#82c7db"><font size="2">$statusline</font></td></tr>
<tr><td width="50%"><font size="2">&nbsp;Credits</font></td>
<td width="50%"><input type="text" name="credits" size="51"></td></tr>
<tr><td width="50%" bgcolor="#82c7db"><font size="2">&nbsp;To (username)</font></td>
<td width="50%" bgcolor="#82c7db"><input type="text" name="touser" size="51"></td></tr>
<tr><td colspan=2 align="right"><input type="image" border=0 src="$adcenter/images/$data{lang}/proceed.gif" width=83 height=23>
</td></tr>
</table></form></td></tr>
</table></center></div>
