...
<tr><td>
<font size=5 color="#000000">HTML CODE</font>
<br><font size=2><form>
Please insert following code to your page so your visitors can subscribe to your mailling list:<br><b><font size="2">
<center><textarea cols=64 rows=8>
<!--Begin $owntitle maillist code-->
<form action="$cgi/adcsubsc.pl" method="post"><input type="hidden" name="destination" value="$data{name}">Your email: <input type="text" size="30" name="email"><input type="submit" value="Subscribe me"><br><font size=1><input type="radio" name="method" checked value="subscribe"> Subscribe &amp;nbsp;&amp;nbsp;&amp;nbsp;<input type="radio" name="method" value="unsubscribe"> Unsubscribe</font></form>
<!--End $owntitle maillist code-->
