...
<tr><td>
<font size=5>COUNTER DAILY STATS</font><br>
...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Total visitors for $data{month} $data{year}: $totimp </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
@mstats
<tr><td colspan=2 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>daily counter stats for <b>$data{name}</b> ($data{month} $data{year})</font></td></tr>
</table>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
