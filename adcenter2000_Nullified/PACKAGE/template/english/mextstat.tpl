...
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_extstat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="GET HELP"></a>&nbsp;&nbsp;<font size=5 color="#000000">EXTENDED STATS</font>
<table border="0" width="100%" cellpadding="2" cellspacing=0 bgcolor="#97D0E1">
<tr><td width="60%" valign="top"><font size=2><b>Banners were showed at</b></font></td><td width="20%" align="right"><font size=2><b>Impressions</b></font></td><td width="20%" align="right"><font size=2><b>Clicks</b></font></td></tr>
@res
<tr><td colspan=3><font size=1><b>Stats since $adate</font></td></tr>
<tr><td colspan=3><input type=hidden name=name value=$data{name}><input type=hidden name=lang value=$data{lang}><input type=hidden name=password value=$data{password}><input type=hidden name=method value=clearestats><input type="image" border=0 src="$adcenter/images/$data{lang}/reset.gif" width=105 height=23></td></tr>
</table></form></td></tr>
</table></center></div>
<!--NON-STATIC-->
</td></tr></table>
