...
<tr><td width="100%" colspan=2>
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_monstat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="GET HELP"></a>&nbsp;&nbsp;<font size=5 color="#000000">MONTHLY STATS</font></td></tr>
<tr><td width="30%">
