...
<tr><td>
<font size=5 color="#000000">TARGET SITES MANAGEMENT</font><br>
<font size=2>Here you can set targets for your banners. Your banner will be shown only on the sites belong to choosen categories</font><br>
<font size=2><center>
<form action="$cgi/adcstat.pl" method="post"><input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="m_target"><input type="hidden" name="lang" value="$data{lang}">
