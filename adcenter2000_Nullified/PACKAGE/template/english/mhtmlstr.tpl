...
<font size=2><form>
Want to join our SwimBanner exchange? Easy place following code to your html page:<br>
<br><b><font size="2">
<center><textarea cols=62 rows=8>
<!--Begin $owntitle SwimBanner code-->
<script language="Javascript" type="text/javascript" src="$cgi/nph-adcsb.pl?$data{name}"></script>
<!--End $owntitle SwimBanner code-->
