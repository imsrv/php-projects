...
<tr><td>
<font size=5 color="#000000">CHANGE ERROR PAGE</font>
...
<tr><td>
<font size=5 color="#000000">CHANGE SUBSCRIBE PAGE</font>
<form method="post" action="$cgi/adcstat.pl" target="_blank">
...
<tr><td>
<font size=5 color="#000000">CHANGE UNSUBSCRIBE PAGE</font>
<form method="post" action="$cgi/adcstat.pl" target="_blank">
...
<tr><td>
<font size=5 color="#000000">CHANGE ERROR MESSAGES</font>
...
<table bgcolor="#97D0E1" border="0" width="100%" cellspacing="0" cellpadding="0" style="border: 0px none rgb(0,0,0)">
<tr><td bgcolor="#82c7db"><font size=2 face=arial>Incorrect email address</font></td><td align="right" bgcolor="#82c7db"><input type=text name="err1" size=48 value="$errneml"></td></tr>
<tr><td><font size=2 face=arial>Email is already exist</font></td><td align="right"><input type=text name="err2" size=48 value="$errex"></td></tr>
<tr><td bgcolor="#82c7db"><font size=2 face=arial>Email is not exist</font></td><td align="right" bgcolor="#82c7db"><input type=text name="err3" size=48 value="$errnex"></td></tr>
