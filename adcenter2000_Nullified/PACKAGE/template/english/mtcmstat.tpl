...
<tr><td>
<font size=5 color="#000000">TARGET COUNTRY MANAGEMENT</font><br>
<font size=2>Set target countries for your banners. Your banner will be show only on sites from choosen countries and to visitors from choosen countries</font><br>
<font size=2><center>
<form action="$cgi/adcstat.pl" method="post"><input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="m_ctarget"><input type="hidden" name="lang" value="$data{lang}">
