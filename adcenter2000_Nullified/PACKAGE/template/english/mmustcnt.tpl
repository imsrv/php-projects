...
<td><form action="$cgi/adcstat.pl" method=post><table><tr><td><input type=hidden name=spot value=$data{spot}><input type=hidden name=name value=$data{name}><input type=hidden name=password value=$data{password}><input type=hidden name=method value=montlyucount><input type="hidden" name="lang" value="$data{lang}"><input type=text name=year value=$data{year} size=4></td><td><input type=image border=0 src="$adcenter/images/$data{lang}/getstats.gif" width="96" height="23"></td></tr></table></form></td></tr>
</table>
</td>
</tr>
</table>
...
<tr><td>
<font size=5 color="#000000">COUNTER MONTHLY STATS (UNIQUE)</font><br>
...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Unique visitors for $data{year}: $totimp </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
</table></td></tr></table></center></div></td><td valign=top width="75%">
<table border="0" width="100%" cellpadding="2" cellspacing=0 bgcolor="#97D0E1">
<tr><td width="60%" valign="top"><font size=2><b>Month</b></font></td><td width="40%" align="right"><font size=2><b>Visitors</b></font></td></tr>
<tr><td bgcolor="#82C7DB"><font size=2><b>January</b></font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mimp[1]</font></td></tr>
<tr><td><font size=2><b>February</b></font></td><td align="right"><font size=2>$mimp[2]</font></td></tr>
<tr><td bgcolor="#82C7DB"><font size=2><b>March</b></font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mimp[3]</font></td></tr>
<tr><td><font size=2><b>April</b></font></td><td align="right"><font size=2>$mimp[4]</font></td></tr>
<tr><td bgcolor="#82C7DB"><font size=2><b>May</b></font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mimp[5]</font></td></tr>
<tr><td><font size=2><b>June</b></font></td><td align="right"><font size=2>$mimp[6]</font></td></tr>
<tr><td bgcolor="#82C7DB"><font size=2><b>Jule</b></font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mimp[7]</font></td></tr>
<tr><td><font size=2><b>August</b></font></td><td align="right"><font size=2>$mimp[8]</font></td></tr>
<tr><td bgcolor="#82C7DB"><font size=2><b>September</b></font></td><td align="right" bgcolor="#82C7DB"><font size=2>$mimp[9]</font></td></tr>
<tr><td><font size=2><b>October</b></font></td><td align="right"><font size=2>$mimp[10]</font></td></tr>
...
<tr><td colspan=2 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>Unique monthly counter stats for <b>$data{name}</b> ($data{year})</font></td></tr>
</table></td></tr></table>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
