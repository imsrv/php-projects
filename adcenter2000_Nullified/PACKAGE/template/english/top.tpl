...
<font size=4><b>TOP $data{top} SITES (Counter Hits)</b></font><br><br>
<table width="100%" cellpadding=2 cellspacing=0 bgcolor="#97d0e1">
<tr><td width="70%" background="$adcenter/images/$data{lang}/globalbk.gif"><font size=2 color=white><b>Site</b></font></td><td width="15%" background="$adcenter/images/$data{lang}/globalbk.gif" align=right><font size=2 color=white><b>Total hits</b></font></td><td width="15%" background="$adcenter/images/$data{lang}/globalbk.gif" align=right><font size=2 color=white><b>Unique hits</b></font></td></tr>
$result
</table>
</td></tr>
</table></div>
