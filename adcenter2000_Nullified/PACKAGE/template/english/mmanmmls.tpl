...
<tr><td>
<font size=5 color="#000000">VIEW MAILLIST</font>
...
<tr><td>
<font size=5 color="#000000">ADD TO MAILLIST</font><br>
<font size=2>You can add several email addresses delimeted by comma</font>
...
<tr><td>
<font size=5 color="#000000">REMOVE FROM MAILLIST</font><br>
<font size=2>You can remove several email addresses delimeted by comma</font>
<form method="post" action="$cgi/adcstat.pl">
...
<tr><td>
<font size=5 color="#000000">UPLOAD FILE</font><br>
<font size=2>You can upload file with email addresses delimeted by carriage return. This operation is available only for users with special trusted status.</font>
$trustedform1
<table bgcolor="#97D0E1" border="0" width="100%" cellspacing="0" cellpadding="0">
