...
<tr><td align=center>
<a href="$cgi/adcindex.pl?lang=$data{lang}"><font size=3 color=black><b>Category:</b></font></a><a href="$cgi/adcbrow.pl?lang=$data{lang}&cat=$argum"><font size=3 color=black><b> $data{cat}:</b></font></a><font size=3 color=black><b> $data{subcat}</b></font><br><br>
<div align=right>
<table width="93%">
<tr><td>
@result
