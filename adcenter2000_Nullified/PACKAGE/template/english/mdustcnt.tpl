...
<tr><td>
<font size=5 color="#000000">COUNTER DAILY STATS (UNIQUE)</font><br>
...
<tr><td colspan=2><center><font face="Lucida Console" size=1 color=red><br>Unique visitors for $data{month} $data{year}: $totimp </font><br><br></center></td><td width=60 rowspan=3>&nbsp;</td></tr>
...
<tr><td width="60%" valign="top"><font size=2><b>Date</b></font></td><td width="40%" align="right"><font size=2><b>Visitors</b></font></td></tr>
@mstats
<tr><td colspan=2 background="$adcenter/images/$data{lang}/globalbk.gif"><font color=white size=1>Unique daily counter stats for <b>$data{name}</b> ($data{month} $data{year})</font></td></tr>
</table>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
