...
<table border="0" width="100%">
<tr><td width="100%" colspan="2">
<font size="4" face="Verdana,Arial,Helvetica"><b>SWIMBANNER MENU NAVIGATOR</b></font></td></tr>
<tr><td width="100%" valign=center><font size=2 face="Verdana,Arial,Helvetica"><form action="$cgi/adcstat.pl" method=post><table><tr><td><input type=hidden name=lang value=$data{lang}><input type=hidden name=name value=$data{name}><input type=hidden name=password value=$data{password}><select name=method><option $selectede{str} value=str>Global stats</option><option $selectede{montlystr} value=montlystr>Monthly stats</option><option $selectede{dailystr} value=dailystr>Daily stats</option><option $selectede{hourlystr} value=hourlystr>Hourly stats</option><option $selectede{manstr} value=manstr>Manage Ads</option><option $selectede{htmlstr} value=htmlstr>Get HTML code</option></select></td><td><input type=image border=0 src="$adcenter/images/$data{lang}/goto.gif" width="70" height="23"></td></tr></table></form></font></td></tr>
</table>
</td>
</tr>
</table>
...
<tr><td width="40%" valign="top"><font size=2><b>Total impressions</b></font></td><td width="60%" align="right"><font size=2>$itx</font></td></tr>
<tr><td width="40%" bgcolor="#82c7db" valign="top"><font size=2><b>Total clicks</b></font></td><td width="60%" align="right" bgcolor="#82c7db"><font size=2>$ctx</font></td></tr>
<tr><td width="40%" valign="top"><font size=2><b>CTR</b></font></td><td width="60%" align="right"><font size=2>$ctr</font></td></tr>
<tr><td width="100%" colspan=2 bgcolor="#82c7db" align="right"><input type=hidden name=name value=$data{name}><input type=hidden name=lang value=$data{lang}><input type=hidden name=password value=$data{password}><input type=hidden name=method value=clearstr><input type="image" border=0 src="$adcenter/images/$data{lang}/reset.gif" width=105 height=23></td></tr>
</table>
</form>
</td></tr>
</table></center></div>
