...
<font size=2><form>
If you haven't counter on your page - you can use our free counter! Easy place following code to your html page:<br>
<font color=red>VARIANT A (SHOW TOTAL VISITORS):</font><br>
<b><font size="2">
<center><textarea cols=62 rows=8>
<!--Begin $owntitle counter code-->
<script type="text/javascript" language="Javascript">
document.write('<script src="$cgi/nph-adccount.pl?$data{name}&A&'+Math.random()+'"><\\/script>');
</script>
<!--End $owntitle counter code-->
</textarea></center></font></b><br>
<font color=red>VARIANT B (SHOW UNIQUE VISITORS):</font><br>
<b><font size="2">
<center><textarea cols=62 rows=8>
<!--Begin $owntitle counter code-->
<script type="text/javascript" language="Javascript">
