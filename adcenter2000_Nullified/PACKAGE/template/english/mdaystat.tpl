...
<tr><td>
<a href="$cgi/adcstat.pl?name=$data{name}&password=$data{password}&method=h_daystat&lang=$data{lang}" target="_blank"><img src="$adcenter/images/$data{lang}/info.gif" border=0 alt="GET HELP"></a>&nbsp;&nbsp;<font size=5 color="#000000">DAILY STATS</font>
