...
<tr><td>
<font size=5 color="#000000">UPLOAD ADDITIONAL TEXT</font><br>
<font size=2><center>Please, do not use scripts or HTML tags, just plain text (up to 150 characters)
...
<br><input type="submit" value="Upload Text"></form><br>Your banner looks like:<br>$bannerco</center>
</font></td></tr>
</table></center></div>
<!--NON-STATIC-->
</td></tr></table>
