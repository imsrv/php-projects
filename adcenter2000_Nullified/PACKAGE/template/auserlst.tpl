...
<tr><td width="100%">
<form action="$cgi/adcadm.pl" method="get"><input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="get_userlist">
<table border="0" width="100%">
<tr><td width="100%" colspan="2">
<font size="4" face="Verdana,Arial,Helvetica"><b>CHOOSE USERLIST TYPE</b></font></td></tr>
<tr><td width="73%"><font size=2 face="Verdana,Arial,Helvetica">
<select name="type">
<option $selected{all} value="all">All accounts</option>
<option $selected{enable} value="enable">Enabled accounts</option>
<option $selected{disable} value="disable">Disabled accounts</option>
<option $selected{free} value="free">Free accounts</option>
<option $selected{advertiser} value="advertiser">Advertiser accounts</option>
<option $selected{expirable} value="expirable">Expirable accounts</option>
<option $selected{nonexpirable} value="nonexpirable">Non-expirable accounts</option>
<option $selected{untrust} value="untrust">Untrusted accounts</option>
<option $selected{trust} value="trust">Trusted accounts</option>
<option $selected{standart} value="standart">Approval required accounts</option>
<option $selected{autoaccept} value="autoaccept">Auto-accept accounts</option>
<option $selected{blitz} value="blitz">Blitz pool list</option>
<option $selected{inactive} value="inactive">Inactive accounts</option>
</select></font></td>
...
<tr><td width="100%">
<font size=5 color=black>USERLIST ($data{type})</font>
