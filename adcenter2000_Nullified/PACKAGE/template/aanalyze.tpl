...
<table border="0" width="100%">
<tr><td width="100%" colspan="2">
<font size="4" face="Verdana,Arial,Helvetica"><b>CHEAT ANALYZER</b></font></td></tr>
<tr><td width="100%" valign=middle><font face="Verdana,Arial,Helvetica">
<form action="$cgi/adcadm.pl" method=post><table width="100%"><tr><td><input type=hidden name=name value=$data{name}><input type=hidden name=password value=$data{password}><input type=hidden name=method value=analyze>
<select name=newmethod>
<option $selectedn{analyze} value="analyze">User logs</option>
<option $selectedn{ctranalyze} value="ctranalyze">CTR Analyzer</option>
<option $selectedn{advanalyze} value="advanalyze">Advanced Analyzer</option>
</select>
</font></td>
<td align="right"><input type=image border=0 src="$adcenter/images/goto.gif" width="70" height="23"></td></tr>
</table></form>
</font></td></tr>
</table>
</td>
...
<tr><td width="100%">
<a href="$cgi/adcadm.pl?name=$data{name}&password=$data{password}&method=h_analyze" target="_blank"><img src="$adcenter/images/info.gif" border=0 alt="GET HELP"></a>&nbsp;&nbsp;<font size=5>USER LOGS</font>
<form action="$cgi/adcadm.pl" method="post">
<input type="hidden" name="name" value="$data{name}"><input type="hidden" name="password" value="$data{password}"><input type="hidden" name="method" value="clearalllogs">
<table border="0" width="100%" cellpadding="0" bgcolor="#97D0E1">
<tr><td bgcolor="#82c7db"><font size=3><b>Available logs</b></font></td></tr>
<tr><td><font size=2>$ndta</font></td></tr>
<tr><td align="right"><input type="image" border=0 src="$adcenter/images/delete.gif" width=75 height=23></td></tr>
</table></form>
</td></tr>
</table></center></div>
<!--NON-STATIC-->
