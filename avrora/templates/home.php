...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="95%" class="story" valign="top">
			<img src="/p.gif" width="1" height="7" border="0"><br>
			<!--- Content START --->
			<?=$art['text']?><br>
			<div align="center"><strong><font color="#6B7594" style="font: bold 12px Verdana Geneva Arial Helvetica sans-serif;">/* ------------------------ НОВОЕ ------------------------ */</font></strong></div><br>
		...
		<td width="220" valign="top">
			...
			<br><br>
			<div align="center"><?=modules('sys_calendar')?></div><br>
		</td>
	</tr>
	<tr>
