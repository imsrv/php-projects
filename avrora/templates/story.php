...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="95%" class="story">
			<img src="/p.gif" width="1" height="15" border="0"><br>
			<!--- Content START --->
			...
			<!--- Content END --->
			<br>
			<a href="/talk/"><font color="#0033cc"><strong>Вы можете обсудить эту заметку в форуме</strong></font></a>.
