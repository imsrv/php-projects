...
mysql_select_db($database_lyrics, $lyrics);
$query_onayal = sprintf("SELECT * FROM istekler WHERE id = %s", $colname_onayal);
...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">moderatör Paneli</a> | <a href="istenen.php">Ýstenen Sözler</a><br>
        <br>
        <center>
          <b>Ýstenen Sözler</b>
        </center><br>
      <center>Þarký sözü isteðini silmek istediðinizden emin misiniz?<br><a href="istenensil_2.php?id=<?php echo $row_onayal['id']; ?>">Evet</a>&nbsp;&nbsp;&nbsp;<a href=javascript:history.go(-1);>Hayýr</a></center></td>
