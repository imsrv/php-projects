...
mysql_select_db($database_lyrics, $lyrics);
$query_sayi = "SELECT * FROM sarki";
$sayi = mysql_query($query_sayi, $lyrics) or die(mysql_error());
$row_sayi = mysql_fetch_assoc($sayi);
$totalRows_sayi = mysql_num_rows($sayi);
?>
<html>
<head>
...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">moderatör Paneli</a><br>
        <br>
        <center>
          <b>Moderatör Paneli</b>
        </center><br>
      <center>Moderatör paneline hoþgeldin <b><?php echo $MM_Username; ?></b>. Sitede þu anda <b><?php echo $totalRows_sayi ?></b> tane þarký sözü var.<br><br><b>Not: </b>Moderatör giriþi yaptýktan sonra, logout olmadýðýnýz sürece sitenin arama motorunu kullanarak sözlere ulaþabilir ve düzenleyebilirsiniz.<br><br><b>Not-2:</b> Þarký eklerken veya onaylarken, þarkýcý adý içinde & karakteri olmamasýna özen gösterin.
      </center></td>
