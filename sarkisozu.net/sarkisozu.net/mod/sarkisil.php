...
mysql_select_db($database_lyrics, $lyrics);
$query_onayal = sprintf("SELECT * FROM sarki WHERE id = %s", $colname_onayal);
...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">moderatör Paneli</a> | <a href="duzenle.php">Söz Düzenle</a><br>
      ...
      <center>Bu þarký sözünü silmek istediðinizden emin misiniz?<br><a href="sarkisil_2.php?id=<?php echo $row_onayal['id']; ?>">Evet</a>&nbsp;&nbsp;<a href=javascript:history.go(-2);>Hayýr</a></center></td>
