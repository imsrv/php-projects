...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">moderatör Paneli</a> | <a href="yeniekle.php">Söz Ekle</a><br>
        <br>
        <center>
          <b>Söz Ekle</b>
        </center><br>
      <center>Þarký sözü veritabanýna kaydedildi.</center><br><center><b>Yeni Söz Ekle:</b></center><br><center><table style="border: 1px solid black;"><tr><form action="<?php echo $editFormAction; ?>" method="POST" onsubmit="submitonce(this);" name="sarkiekle">
      <td style="width:30%; vertical-align:middle;"><b>Þarkýcý:</b></td><td style="width:70%;"><input type="text" name="sanatci"></td></tr><tr><td style="width:30%; vertical-align:middle;"><b>Þarký Adý:</b></td><td style="width:70%;"><input type="text" name="sarki"></td></tr><tr><td style="width:30%; vertical-align:middle;"><b>Albüm:</b></td><td style="width:70%;"><input type="text" name="album"></td></tr><tr><td style="width:30%; vertical-align:middle;"><b>Sözler:</b></td><td style="width:70%;"><textarea name="soz" rows="10" cols="30"></textarea></td></tr><tr><td colspan="2"><center><input type="submit" value="ekle!"></center></td>
