...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "copyrightyonet")) {
  $updateSQL = sprintf("UPDATE copyright SET copyright=%s WHERE id=%s",
  ...
  $updateGoTo = "copyrightupdate.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_lyrics, $lyrics);
$query_copyrightal = "SELECT * FROM copyright";
$copyrightal = mysql_query($query_copyrightal, $lyrics) or die(mysql_error());
$row_copyrightal = mysql_fetch_assoc($copyrightal);
$totalRows_copyrightal = mysql_num_rows($copyrightal);
?>
...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="copyrightyonet.php">Copyright Yönetimi</a><br>
        <br>
        <center>
          <b>Copyright Yönetimi</b>
        </center><br>
      <center><table><tr><td><form action="<?php echo $editFormAction; ?>" method="POST" name="copyrightyonet">
      <input type="hidden" name="id" value="<?php echo $row_copyrightal['id']; ?>"><center>
        <textarea name="copyright" rows="20" cols="50"><?php echo $row_copyrightal['copyright']; ?></textarea><br><input type="submit" value="güncelle"></center>
      <input type="hidden" name="MM_update" value="copyrightyonet">
