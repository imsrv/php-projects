...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "gidenekle")) {
  $insertSQL = sprintf("INSERT INTO cikis (isim, url) VALUES (%s, %s)",
...
<table height="520">
  ...
  <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="gidenyonet.php">Destekleyenleri Yönet</a><br>
        <br>
        <center>
          <b>Destekleyenleri Yönet</b>
        </center><br>
      <center><table style="border: 1px solid black;"><tr><td colspan="2"><center><b>Destekleyen Ekle</b></center></td></tr><tr><form action="<?php echo $editFormAction; ?>" method="POST" onsubmit="submitonce(this);" name="gidenekle">
      <td style="width:30%; vertical-align:middle;"><b>Site Adý:</b></td><td style="width:70%;"><input type="text" name="isim"></td></tr><tr><td style="width:30%; vertical-align:middle;"><b>URL:</b></td><td style="width:70%;"><input type="text" name="url"></td></tr><tr><td colspan="2"><center><input type="submit" value="ekle!"></center></td>
        <input type="hidden" name="MM_insert" value="gidenekle">
      </form></tr></table></center><table style="border:1px solid black;"><tr><td colspan="4"><center><b>Destekleyenlere Giden Ziyaretçiler:</b></center></td></tr><?php do { ?><tr>
      <td><a href="<?php echo $row_gond['url']; ?>" target="_blank" title="<?php echo $row_gond['url']; ?>"><?php echo $row_gond['isim']; ?></a>:</td><td><b><?php echo $row_gond['sayi']; ?></b></td><td>Toplam: <b><?php echo $row_gond['toplam']; ?></b></td><td><a href="gidensifirlaonay.php?id=<?php echo $row_gond['id']; ?>">sýfýrla</a> - <a href="gidensilonay.php?id=<?php echo $row_gond['id']; ?>">sil</a></td></tr>
      <?php } while ($row_gond = mysql_fetch_assoc($gond)); ?><tr><td colspan="4"><center><a href="gidenhepsinisifirlaonay.php">Hepsini Sýfýrla</a></center></td></tr></table></td>
