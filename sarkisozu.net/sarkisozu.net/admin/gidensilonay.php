...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="gonderenyonet.php">Destekleyenleri Yönet</a><br>
        <br>
        <center>
          <b>Destekleyenleri Yönet</b>
        </center><br>
      <center>Bu destekleyen linki silmek istediðinizden emin misiniz?<br><a href="gidensil.php?id=<?php echo $row_onayal['id']; ?>">Evet</a>&nbsp;&nbsp;&nbsp;<a href="javascript:history.go(-1);">Hayýr</a></center></td>
