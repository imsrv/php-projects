...
mysql_select_db($database_lyrics, $lyrics);
$query_onayal = sprintf("SELECT * FROM `admin` WHERE id = %s", $colname_onayal);
...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="moderatoryonet.php">Moderatör Yönetimi</a><br>
      ...
      <center>Bu moderatörü silmek istediðinizden emin misiniz?<br><a href="moderatorsil_2.php?id=<?php echo $row_onayal['id']; ?>">Evet</a>&nbsp;&nbsp;&nbsp;<a href="javascript:history.go(-1);">Hayýr</a></center></td>
