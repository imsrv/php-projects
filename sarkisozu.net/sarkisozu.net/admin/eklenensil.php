...
<table height="520">
  ...
  <tr>
    <td width="18%" rowspan="2" style="border-right:1px solid black; border-top:1px solid black; border-bottom:1px solid black;"><center>
        ...
        <a href="istenen.php">Ýstenen sözler</a>(<b><?php echo $totalRows_istenen ?></b>)<br><a href="yeniekle.php">Söz ekle</a><br><a href="duzenle.php">Söz düzenle</a><br><br><a href="gonderenyonet.php">Ziyaretçi Gönderenler</a><br><a href="adminyonet.php">Admin yönetimi</a><br><a href="moderatoryonet.php">Moderatör Yönetimi</a><br><a href="cssyonet.php">CSS yönetimi</a><br><a href="destekleyonet.php">Destekleyenleri yönet</a><br><a href="copyrightyonet.php">Copyright yönetimi</a><br>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="eklenen.php">Eklenen Sözler</a><br>
      ...
      <center>Eklenen bu þarký sözünü veritabanýna kaydetmeden silmek istediðinizden emin misiniz?<br><a href="eklenensil_2.php?id=<?php echo $row_onayal['id']; ?>">Evet</a>&nbsp;&nbsp;&nbsp;<a href="javascript:history.go(-1);">Hayýr</a></center></td>
