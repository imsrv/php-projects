...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "cssyonet")) {
  $updateSQL = sprintf("UPDATE css SET css=%s WHERE id=%s",
...
mysql_select_db($database_lyrics, $lyrics);
$query_cssal = "SELECT * FROM css";
$cssal = mysql_query($query_cssal, $lyrics) or die(mysql_error());
$row_cssal = mysql_fetch_assoc($cssal);
$totalRows_cssal = mysql_num_rows($cssal);
?>
...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="cssyonet.php">CSS Yönetimi</a><br>
        <br>
        <center>
          <b>CSS Yönetimi</b>
        </center><br>
      <center><table><tr><td><form method="POST" action="<?php echo $editFormAction; ?>" name="cssyonet">
      <input type="hidden" name="id" value="<?php echo $row_cssal['id']; ?>"><center><textarea name="css" rows="20" cols="50"><?php echo $row_cssal['css']; ?></textarea><br><input type="submit" value="güncelle"></center>
      <input type="hidden" name="MM_update" value="cssyonet">
