...
mysql_select_db($database_lyrics, $lyrics);
$query_onayal = sprintf("SELECT * FROM `gonderenler` WHERE id = %s", $colname_onayal);
...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="gonderenyonet.php">Ziyaretçi Gönderenler</a><br>
      ...
      <center>Bu göndericinin gönderdiði ziyaretçi sayýsýný sýfýrlamak istediðinizden emin misiniz?<br><a href="gonderensifirla.php?id=<?php echo $row_onayal['id']; ?>">Evet</a>&nbsp;&nbsp;&nbsp;<a href="javascript:history.go(-1);">Hayýr</a></center></td>
