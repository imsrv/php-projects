...
<table height="520">
  ...
  <tr>
    ...
    <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="eklenen.php">Eklenen Sözler</a><br>
        <br>
        <center>
          <b>Eklenen Sözler</b>
        </center><br>
      <center>
        <?php if ($totalRows_eklenen > 0) { // Show if recordset not empty ?>
        <?php do { ?>
        <table style="border: 1px solid black;">
		<tr>
      <td style="width:30%; vertical-align:middle;"><b>IP Adresi:</b></td>
      <td style="width:70%;"><b><?php echo $row_eklenen['ip']; ?></b></td>
    </tr>
  <tr>
  <form action="<?php echo $editFormAction; ?>id=<?php echo $row_eklenen['id']; ?>" method="POST" onsubmit="submitonce(this);" name="sarkiekle">
    <td style="width:30%; vertical-align:middle;"><b>Þarkýcý:</b></td>
    <td style="width:70%;"><input type="text" name="sanatci" value="<?php echo $row_eklenen['sanatci']; ?>"></td>
    </tr>
	
    <tr>
      <td style="width:30%; vertical-align:middle;"><b>Þarký Adý:</b></td>
      <td style="width:70%;"><input type="text" name="sarki" value="<?php echo $row_eklenen['sarki']; ?>"></td>
    </tr>
    <tr>
      <td style="width:30%; vertical-align:middle;"><b>Albüm:</b></td>
      <td style="width:70%;"><input type="text" name="album" value="<?php echo $row_eklenen['album']; ?>"></td>
    </tr>
    <tr>
      <td style="width:30%; vertical-align:middle;"><b>Sözler:</b></td>
      <td style="width:70%;"><textarea name="soz" rows="10" cols="30"><?php echo $row_eklenen['soz']; ?></textarea></td>
    </tr>
    <tr>
      <td colspan="2"><center>
          <input type="submit" value="onayla">&nbsp;&nbsp;<input type="button" value="sil" onClick=window.location=('eklenensil.php?id=<?php echo $row_eklenen['id']; ?>');>
      </center></td>
      <input type="hidden" name="MM_insert" value="sarkiekle">
        ...
        <?php } while ($row_eklenen = mysql_fetch_assoc($eklenen)); ?>
        <?php } // Show if recordset not empty ?>
        <?php if ($totalRows_eklenen == 0) { // Show if recordset empty ?>
Eklenen þarký sözü yok.
