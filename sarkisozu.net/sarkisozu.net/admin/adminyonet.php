...
mysql_select_db($database_lyrics, $lyrics);
$query_adminler = "SELECT * FROM `admin` WHERE yetki = '10' ORDER BY `user` ASC";
...
<table height="520">
  ...
  <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="adminyonet.php">Admin Yönetimi</a><br>
        <br>
        <center>
          <b>Admin Yönetimi</b>
        </center><br>
      <center><table style="border: 1px solid black;"><tr><td colspan="2"><center><b>Admin Ekle</b></center></td></tr><tr><form action="<?php echo $editFormAction; ?>" method="POST" onsubmit="submitonce(this);" name="adminekle">
      <td style="width:30%; vertical-align:middle;"><b>Kullanýcý:</b></td><td style="width:70%;"><input type="text" name="user"></td></tr><tr><td style="width:30%; vertical-align:middle;"><b>Þifre:</b></td><td style="width:70%;"><input type="password" name="pass"><input type="hidden" name="yetki" value="10"></td></tr><tr><td colspan="2"><center><input type="submit" value="ekle!"></center></td>
        <input type="hidden" name="MM_insert" value="adminekle">
      </form></tr></table></center><br><center><b>Adminler:</b></center><?php do { ?>
      <?php echo $row_adminler['user']; ?> - <a href="adminsil.php?id=<?php echo $row_adminler['id']; ?>">sil</a><br>
