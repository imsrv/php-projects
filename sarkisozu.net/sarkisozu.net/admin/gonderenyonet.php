...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "referansekle")) {
  $insertSQL = sprintf("INSERT INTO gonderenler (ref, isim) VALUES (%s, %s)",
...
mysql_select_db($database_lyrics, $lyrics);
$query_gond = "SELECT * FROM gonderenler";
$gond = mysql_query($query_gond, $lyrics) or die(mysql_error());
$row_gond = mysql_fetch_assoc($gond);
$totalRows_gond = mysql_num_rows($gond);
?>
...
<table height="520">
  ...
  <td width="60%" rowspan="2"><a href="../index.php">Anasayfa</a> | <a href="yonet.php">Admin Paneli</a> | <a href="gonderenyonet.php">Ziyaretçi Gönderenler</a><br>
        <br>
        <center>
          <b>Ziyaretçi Gönderenler</b>
        </center><br>
      <center><table style="border: 1px solid black;"><tr><td colspan="2"><center><b>Gönderici Ekle</b></center></td></tr><tr><form action="<?php echo $editFormAction; ?>" method="POST" onsubmit="submitonce(this);" name="referansekle">
      <td style="width:30%; vertical-align:middle;"><b>gond= deðeri:</b></td><td style="width:70%;"><input type="text" name="ref"></td></tr><tr><td style="width:30%; vertical-align:middle;"><b>gönderen ismi:</b></td><td style="width:70%;"><input type="text" name="isim"></td></tr><tr><td colspan="2"><center><input type="submit" value="ekle!"></center></td>
        <input type="hidden" name="MM_insert" value="referansekle">
      </form></tr></table></center><table style="border: 1px solid black;"><tr><td colspan="4"><center><b>Ziyaretçi Gönderenler:</b></center></td></tr><?php do { ?><tr>
      <td><a href="#" title="<?php echo $row_gond['ref']; ?>"><?php echo $row_gond['isim']; ?></a>:</td><td><b><?php echo $row_gond['ziyaretci']; ?></b></td><td>Toplam: <b><?php echo $row_gond['toplam']; ?></b></td><td><a href="gonderensifirlaonay.php?id=<?php echo $row_gond['id']; ?>">sýfýrla</a> - <a href="gonderensilonay.php?id=<?php echo $row_gond['id']; ?>">sil</a></td></tr>
      <?php } while ($row_gond = mysql_fetch_assoc($gond)); ?><tr><td colspan="4"><center><a href="gonderenhepsinisifirlaonay.php">Hepsini Sýfýrla</a></center></td></tr></table></td>
