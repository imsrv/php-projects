...
HTMLArea.Config = function () {
	...
	this.toolbar = [
		...
		[ "justifyleft", "justifycenter", "justifyright", "justifyfull", "separator",
		  ...
		  "forecolor", "hilitecolor","insertsmiley", "separator",
		  "inserthorizontalrule", "createlink", "insertimage", "inserttable","separator", "removeformat", "killword", "separator","htmlmode", 
		  "popupeditor",  "showhelp", "about" ]
	];
	...
	this.btnList = {
		...
		insertsmiley: [ "Insert Smiley", "smiley.gif", false, function(e) {e.execCommand("insertsmiley");} ],
	...
	function initIframe() {
		...
		if (!editor.config.fullPage) {
			...
			html += "<style>" + editor.config.pageStyle +
				" html,body { border: 0px; font-family: Tahoma;font-size:10 pt;}</style>\n";
			html += "</head>\n";
			html += "<body>\n";
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
		...
		break;
		case "insertsmiley":
			window.open(this.popupURL("smileys.html"), "fullscreen",
					    "toolbar=no,location=no,directories=no,status=yes,menubar=no," +
					    "scrollbars=no,resizable=yes,width=200,height=200");
			break;
	    case "createlink":
		this._createLink();
		break;
