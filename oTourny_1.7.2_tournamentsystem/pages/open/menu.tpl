var BLANK_IMAGE="pages/open/images/b.gif";
//keywords
...
[
	...
	{code:"Forum", url:"{SITE_URL}/forum", "target":"_self",
		sub:[
			...
			{code:"- Disscussion", url:"{SITE_URL}/forum/viewforum.php?f=2", "target":"_self"},
			{code:"- Tech Support", url:"{SITE_URL}/forum/viewforum.php?f=3", "target":"_self"},
			{code:"- Non Disscussion", url:"{SITE_URL}/forum/viewforum.php?f=4", "target":"_self"},
