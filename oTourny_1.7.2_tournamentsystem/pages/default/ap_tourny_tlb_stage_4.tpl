...
<table width="100%" class="panel" border="0"><tr class="adminsubbartournybot"><td class="adminsubbartournybot" align=center>
 <a class="adminsubbartournybot" href="?page=admin&cmd=tourny&cmdd=modules&tournyid={TOURNY_ID}">
  Modules
 </a>
</td><td class="adminsubbartournybot" align=center>
 <a class="adminsubbartournybot" href="?page=tourny&tournyid={TOURNY_ID}&cmd=matchs&show=listall">
  Matchs
 </a>
</td><td class="adminsubbartournybot" align=center>
