...
#
# 導出表中的數據 `{prefix}basic`
#

INSERT INTO `{prefix}basic` VALUES ('1', 'Okphp BBS', 'forum.php', 'Okphp Group', 'http://yourdomain', 'yourname@yourdomain', '', '<font size="1">Copyright &copy; 2003-2005 by OKPHP group, All rights reserved. </font>\r\n<br>', '20&50000&10&10&1&&120&20&0&1&0&1&1&100&big5&bbs/lang/big5&bbs/themes/default&bbs/themes/default/images/blue&bbs/themes/default/css/full_light&Y-m-d H:i&0&8&70&20&3&4&10&100&30&0&Sorry, site is updating..&1&20&100&3&5&1&1&&', '', 0, 1102523209, '<select name="forum_id" onchange="this.form.submit();">\r\n				<option value="0">Select..</option><option value="2">Category - Forum</option></select><input type="submit" value="Go">', 1100594226, 1);
...
#
# 導出表中的數據 `{prefix}group`
#

INSERT INTO `{prefix}group` VALUES (1, '遊客/未登陸', 'don\'t delete this!', 'no');
INSERT INTO `{prefix}group` VALUES (2, '普通會員', 'don\'t delete this!', 'no');
INSERT INTO `{prefix}group` VALUES (13, 'test group', 'adf', 'yes');
INSERT INTO `{prefix}group` VALUES (3, '超級管理員', 'don\'t delete this!', 'no');
