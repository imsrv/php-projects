  ...
  <tr> 
    <td bgcolor="#FFFFFF" bordercolor="#FFFFFF" align="center" valign="top"> 
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><b>Build class under </b><font class="directory">{type_name}</font><b> 
            </b></td>
        </tr>
        <tr> 
          <td align="right" bordercolor="#99CCCC">[ <a href="index.php?action=list_file&type_id=%7Btype_id%7D">Go 
            Back </a> ] </td>
        </tr>
      </table>
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td> 
            <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
              ...
              <form name="form" method="post" action="index.php">
                ...
                <tr> 
                  <td width="39%" bgcolor="#FFFFFF" align="right">Name:</td>
