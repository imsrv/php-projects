            ...
            <td> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC" bordercolor="#CCCCCC">
                <tr> 
                  ...
                  <th width="27%" bgcolor="#EBEBEB">Name</th>
                  <th width="20%" bgcolor="#EBEBEB">Threads</th>
                  <th width="14%" bgcolor="#EBEBEB">Moderator</th>
                  <th width="30%" align="center" bgcolor="#EBEBEB">Opration</th>
                </tr>
                <!-- BEGIN type -->
