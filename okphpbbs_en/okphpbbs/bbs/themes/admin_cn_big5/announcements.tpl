  ...
  <tr> 
    <td bgcolor="#FFFFFF" bordercolor="#FFFFFF" align="center" valign="top"> 
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> 
            <p><font class="directory">公告:</font><b>管理</b> </p>
          </td>
        </tr>
        <tr> 
          <td align="right" bordercolor="#99CCCC">[<a href="index.php?action=announcements#add">添加新公告</a>] 
          </td>
        </tr>
      </table>
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
              <form action="index.php" method="post">
                <tr> 
                  <th width="3%">id</th>
                  <th width="33%">標題</th>
                  <th width="22%" align="center">發佈時間<b><font color="#FFFFFF"></font></b></th>
                  <th width="21%">是否顯示在所有版面</th>
                  <th width="21%">操作</th>
                </tr>
                <!-- BEGIN list -->
      ...
      <table border="0" cellspacing="1" cellpadding="0" bgcolor="#999999">
        <form name="post" method="post" action="index.php">
          ...
          <tr bgcolor="#F3F3F3"> 
            <td width="19%" bgcolor="#F3F3F3">*顯示在所有版面?<br>
            </td>
          ...
          <tr> 
            <td width="19%" bgcolor="#F3F3F3">*內容<a href="#note"></a></td>
