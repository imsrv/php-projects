  ...
  <tr> 
    <td bordercolor="#FFFFFF"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr > 
          <td height="26" bgcolor="#FFFFFF"> <font class="directory">э盞絏</font></td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
        <form name="form1" method="post" action="index.php" enctype="multipart/form-data">
          ...
          <tr bgcolor="#FFFFFF"> 
            <td width="27%" height="26" align="right">盞絏</td>
            <td width="73%" height="26"> 
              <input type="password" name="password" size="20">
            </td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td width="27%" height="26" align="right">穝盞絏</td>
            <td width="73%" height="26"> 
              <input type="password" name="password1" size="20">
            </td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td width="27%" height="26" align="right">狡筂</td>
            <td width="73%" height="26"> 
