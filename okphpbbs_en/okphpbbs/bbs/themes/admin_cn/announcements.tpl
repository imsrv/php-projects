    ...
    <td bgcolor="#FFFFFF" bordercolor="#FFFFFF" align="center" valign="top"> 
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
              <form action="index.php" method="post">
                <tr> 
                  <th width="3%">id</th>
                  <th width="33%">标题</th>
                  <th width="22%" align="center">发布时间<b><font color="#FFFFFF"></font></b></th>
                  <th width="21%">是否显示在所有版面</th>
                  <th width="21%">操作</th>
                </tr>
                <!-- BEGIN list -->
      ...
      <table border="0" cellspacing="1" cellpadding="0" bgcolor="#999999">
        <form name="post" method="post" action="index.php">
          ...
          <tr bgcolor="#F3F3F3"> 
            <td width="19%" bgcolor="#F3F3F3">*显示在所有版面?<br>
            </td>
          ...
          <tr> 
            <td width="19%" bgcolor="#F3F3F3">*内容<a href="#note"></a></td>
