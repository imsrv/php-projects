<?php
/* --------------------------------------------------------------
   $Id: english.php,v 1.2 2003/09/07 15:11:41 fanta2k Exp $   
...
define('TEXT_DATABASE_LONG','The database used to hold the catalog data. An example database name is <i>xtcommerce</i>.');
...
define('TITLE_GUEST_CONFIG_NOTE','*Note; Settings for standart user (non-regristrated customer)');
define('TITLE_CUSTOMERS_CONFIG','Default customers configuration');
define('TITLE_CUSTOMERS_CONFIG_NOTE','*Note; Settings for standart user (regristrated customer)');
