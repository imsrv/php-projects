<?php
/* -----------------------------------------------------------------------------------------
   $Id: chp.php,v 1.1 2003/09/06 21:54:34 fanta2k Exp $   
   ...
   (c) 2002-2003 osCommerce(chp.php,v 1.01 2003/02/18 03:33:00); www.oscommerce.com 
   (c) 2003	 nextcommerce (chp.php,v 1.4 2003/08/13); www.nextcommerce.org
...
define('MODULE_SHIPPING_CHP_COUNTRIES_6_TITLE' , 'Tarifzone 4 Länder');
define('MODULE_SHIPPING_CHP_COUNTRIES_6_DESC' , 'Durch Komma getrennt Liste der Länder als zwei Zeichen ISO-Code Landeskennzahlen, die Teil der Zone 4 sind.');
define('MODULE_SHIPPING_CHP_COST_ECO_6_TITLE' , 'Tariftabelle für Zone 4 bis 30 kg ECO');
define('MODULE_SHIPPING_CHP_COST_ECO_6_DESC' , 'Tarif Tabelle für die Zone 4, basiered auf <b>\'ECO\'</b> bis 30 kg Versandgewicht.');
define('MODULE_SHIPPING_CHP_COST_PRI_6_TITLE' , 'Tariftabelle für Zone 4 bis 30 kg PRI');
define('MODULE_SHIPPING_CHP_COST_PRI_6_DESC' , 'Tarif Tabelle für die Zone 4, basiered auf <b>\'PRI\'</b> bis 30 kg Versandgewicht.');
define('MODULE_SHIPPING_CHP_COST_URG_6_TITLE' , 'Tariftabelle für Zone 4 bis 30 kg URG');
define('MODULE_SHIPPING_CHP_COST_URG_6_DESC' , 'Tarif Tabelle für die Zone 4, basiered auf <b>\'URG\'</b> bis 30 kg Versandgewicht.');
define('MODULE_SHIPPING_CHP_COUNTRIES_7_TITLE' , 'Tarifzone 5 Länder');
define('MODULE_SHIPPING_CHP_COUNTRIES_7_DESC' , 'Durch Komma getrennt Liste der Länder als zwei Zeichen ISO-Code Landeskennzahlen, die Teil der Zone 5 sind.');
define('MODULE_SHIPPING_CHP_COST_ECO_7_TITLE' , 'Tariftabelle für Zone 5 bis 30 kg ECO');
define('MODULE_SHIPPING_CHP_COST_ECO_7_DESC' , 'Tarif Tabelle für die Zone 5, basiered auf <b>\'ECO\'</b> bis 30 kg Versandgewicht.');
define('MODULE_SHIPPING_CHP_COST_PRI_7_TITLE' , 'Tariftabelle für Zone 5 bis 30 kg PRI');
