    ...
    <TR>
     <TD WIDTH="26%" BGCOLOR="#D6D6D6" VALIGN=TOP>
      <P>
       <TABLE WIDTH="100%" CELLPADDING="2" CELLSPACING="0" BORDER="0">
        <TR>
         <TD WIDTH="100%" BGCOLOR="#CC6600" VALIGN=TOP>
          <P>
           <TABLE WIDTH="100%" CELLPADDING="2" CELLSPACING="0" BORDER="0">
            <TR>
             <TD WIDTH="100%" VALIGN=TOP>
              <P ALIGN=LEFT>
               <FONT COLOR="#EB851F"><FONT FACE="Arial,Helvetica,Monaco"><FONT SIZE="4">NAVIGATION</FONT></FONT></FONT><BR>
               <HR ALIGN=LEFT WIDTH="100%" SIZE="1" NOSHADE COLOR="#EB851F">
               <FONT FACE="Arial,Helvetica,Monaco"><FONT SIZE="2"><FONT COLOR="WHITE">&#149;
                <A HREF="writer.php?action=news" CLASS="subnav1" onMouseover="EnterContent('ToolTip','Article Management','This area will allow you to edit and delete your articles.'); Activate();" onMouseout="deActivate()" >Article Management</A></FONT></FONT></FONT><BR>
               <HR ALIGN=LEFT WIDTH="100%" SIZE="1" NOSHADE COLOR="#EB851F">
               </P>
              <P>
