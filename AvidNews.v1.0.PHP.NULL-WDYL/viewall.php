...
echo("<table width=100% cellpadding=0 cellspacing=0 style=\"border: 1px solid #ffffff\">
		<tr bgcolor=#ffffff height=20><td colspan=2><font color=#666699><font size=3><font face=Arial>&nbsp;&nbsp;<b>All Approved Articles</b></font></font></font></tr></td>");
	
	$news = mysql_query("SELECT * FROM `$CONF[table_prefix]news`
	WHERE live = 'yes' ORDER BY date_added DESC");
