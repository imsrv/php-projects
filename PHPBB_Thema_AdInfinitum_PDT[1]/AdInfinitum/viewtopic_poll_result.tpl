...
<tr> 
  <td class="row1" colspan="2"><br clear="all" />
	<table cellspacing="0" cellpadding="4" border="0" align="center">
			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="templates/AdInfinitum/images/vote_lcap.gif" width="4" alt="" height="12" /></td>
					...
					<td><img src="templates/AdInfinitum/images/vote_rcap.gif" width="4" alt="" height="12" /></td>
				  </tr>
				</table>
			  </td>
	  ...
	  <tr> 
		<td colspan="4" align="center"><span class="gen">{L_TOTAL_VOTES} : {TOTAL_VOTES}</span></td>
	  </tr>
	</table>
	<br clear="all" />
  </td>
