...
<table width="100%" cellpadding="4" cellspacing="0" border="0" align="center">
  <tr> 
	<td align="center" ><a href="{U_FORUM_INDEX}" target="_parent"><img src="../templates/AdInfinitum/images/logo_phpBB_med.gif" border="0" /></a></td>
  </tr>
  <tr> 
	<td align="center" > 
	  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
        ...
        <!-- END catrow -->
        <tr> 
          <td class="catSides"><span class="cattitle">Skin Admin</span></td>
        </tr>
        <tr> 
          <td class="row1"><span class="genmed"><a href="http://community.mikelothar.com/viewtopic.php?t=105&s=AdInfinitum"  target="_blank" class="genmed">Ad 
            Infinitum updates</a></span></td>
        </tr>
        <tr>
          <td class="">&nbsp;</td>
        </tr>
        <tr>
          <td class="" align="CENTER" valign="MIDDLE"><span class="copyright"><img src="../templates/AdInfinitum/images/mikelothar.gif" border="0" /> Ad Infinitum v1.00</span></td>
        </tr>
      </table>
	</td>
  </tr>
