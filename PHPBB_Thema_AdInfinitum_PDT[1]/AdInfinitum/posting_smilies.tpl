	...
	<tr>
		<td><table width="100%" border="0" cellspacing="1" cellpadding="4" class="forumline">
              <tr align="center" valign="middle">
                <td align="LEFT" class="nav">Avatars</td>
              </tr>
			...
			<tr>
              ...
              <tr align="center" valign="middle"> 
                <!-- BEGIN smilies_col -->
                <td class="row1"><a href="javascript:emoticon('{smilies_row.smilies_col.SMILEY_CODE}')"><img src="{smilies_row.smilies_col.SMILEY_IMG}" border="0" alt="{smilies_row.smilies_col.SMILEY_DESC}" title="{smilies_row.smilies_col.SMILEY_DESC}" /></a></td>
                <!-- END smilies_col -->
              </tr>
              <!-- END smilies_row -->
