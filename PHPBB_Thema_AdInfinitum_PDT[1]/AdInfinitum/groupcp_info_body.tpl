<table align="CENTER" class="forumline" border="0" cellpadding="2" cellspacing="1" width="717">
  <tr> 
    <th class="thTop" colspan="2" height="25"><b>{L_GROUP_INFORMATION}</b></th>
  </tr>
</table>
...
<table align="CENTER" class="forumline" border="0" cellpadding="2" cellspacing="1" width="717">
  <tr> 
    <th colspan="1" align="left" height="28" class="nav" nowrap="nowrap">{GROUP_NAME}</th>
  </tr>
</table>



  <table align="CENTER" class="forumline" width="717" cellspacing="1" cellpadding="4" border="0"><form action="{S_GROUPCP_ACTION}" method="post">
    <tr> 
...
<table align="CENTER" class="forumline" width="717" cellpadding="4" cellspacing="1" border="0">
	...
	<tr> 
	  <td class="row1" colspan="7" align="center"><span class="gen"><br />{L_NO_MEMBERS}<br /><br /></span></td>
	</tr>
	<!-- END switch_no_members -->

	<!-- BEGIN switch_hidden_group -->
	<tr> 
	  <td class="row1" colspan="7" align="center"><span class="gen"><br />{L_HIDDEN_MEMBERS}<br /><br /></span></td>
	</tr>
...
<!-- BEGIN switch_mod_option -->
<table align="CENTER" width="717" border="0" cellspacing="1" cellpadding="5">
  <tr> 
  ...
  <tr>
    <td class="row1">
		...
		<span class="gen" height="28"><input type="text"  class="post" name="username" maxlength="50" size="20" /> <input type="submit" name="add" value="{L_ADD_MEMBER}" class="mainoption" /> <input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onclick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></span>
		

	
	</td>
  </tr>
</table><!-- END switch_mod_option -->
