...
<table align="CENTER" class="forumline" border="0" cellpadding="2" cellspacing="1" width="717">
	<tr>
	  <th colspan="1" align="left" height="28" class="nav" nowrap="nowrap">{L_TOPIC_REVIEW}</th>
	</tr>
</table>

<table align="CENTER" class="forumline" border="0" cellpadding="5" cellspacing="1" width="717">
	<tr>
		<td class="row1"><iframe width="100%" height="200" src="{U_REVIEW_TOPIC}" border="0">
<!-- END switch_inline_mode -->
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
		<th class="thTop" width="150" height="26">{L_AUTHOR}</th>
