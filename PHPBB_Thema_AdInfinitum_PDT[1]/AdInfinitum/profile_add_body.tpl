...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post">
	<tr>	 
		<th class="thTop" colspan="2" height="25"><b>{L_REGISTRATION_INFO}</b></th>
	</tr>
</table>
{ERROR_BOX} 
<table align="CENTER" class="forumline" border="0" cellpadding="2" cellspacing="1" width="717">
  <tr> 
    <th colspan="1" align="left" height="28" class="nav" nowrap="nowrap">{L_REGISTRATION_INFO}</th>
  </tr>
</table>
<table align="CENTER" class="forumline" border="0" cellpadding="3" cellspacing="1" width="717">
	...
	<!-- END switch_confirm -->
	<tr align="LEFT"> 
	  <th height="25" colspan="2" valign="middle" class="nav">{L_PROFILE_INFO}</th>
	</tr>
	<tr> 
	...
	<tr align="LEFT"> 
	  <th height="25" colspan="2" valign="middle" class="nav">{L_PREFERENCES}</th>
	</tr>
	<tr> 
	...
	<tr align="LEFT"> 
	  <th height="12" colspan="2" valign="middle" class="nav">{L_AVATAR_PANEL}</th>
	</tr>
	<tr align="LEFT"> 
		<td class="row1" colspan="2"><table width="70%" cellspacing="2" cellpadding="0" border="0" align="left">
			<tr> 
