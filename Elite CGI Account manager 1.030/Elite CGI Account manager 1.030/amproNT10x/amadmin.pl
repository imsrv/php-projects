...
#
# This program may not be distributed in whole or part, freely, for pay, # or any other form of compensation.
#
#################################################################
# This version designed for UNIX web servers. If you require
# a Win32 systems (NT) version, please contact cgi@elitehost.com
#################################################################
#
...
# this method, we still do consider it a beta.  Please report
# any problems you may experience in our Account Manager bulletin 
# board.
#
...
# access, you must upgrade to version 1.030 (this version) if
# using a previous version of Account Manager.
...
#    $body .= "To: $edit_approval[2]\n";
#    $body .= "From: $orgmail\n";
#    $body .= "Subject: $denied_email_subject\n";
    #Date
    $body .= "$date\n";
...
&sendmail("$edit_approval[2]","$orgmail","$denied_email_subject","$body");
...
#    $body .= "Subject: $INPUT{'mail_subject'}\n";
    $body .= "-" x 75 . "\n\n";
    $body .= "$INPUT{'message'}";
&sendmail("$edit_array[2]","$orgmail","$INPUT{'mail_subject'}","$body");
...
#    $body .= "To: $edit_array[2] ($edit_array[3] $edit_array[4])\n";
#    $body .= "From: $orgmail ($billing)\n";
#    $body .= "Subject: $orgname $month Billing Statement\n";
    $body .= "-" x 75 . "\n\n";
    
    $body .= "$date2\n";
    $body .= "Username: $edit_array[0]\n\n";
    
    $body .= "Invoice: $new_invoice\n";
    $body .= "Total of Last Bill: \$$edit_array[17]\n";

    if ($edit_array[18] && $edit_array[18] !=0) {
    $body .= "Payments Applied: \$$edit_array[18] - Thank You\n";
} else {
    $body .= "Payments Applied: \$$edit_array[18]\n";
}

    $body .= "Adjustments Applied: \$$edit_array[19]\n";

    
    $body .= "Total Balance before new charges: \$$edit_array[20]\n";
    $body .= "New Charges: \$$edit_array[21]\n";

    $body .= "Total Charges:  \$$edit_array[22]\n";
    $body .= "Taxes: \$0.00\n";
    $body .= "-" x 75 . "\n\n";
    $body .= "Net New Charges: \$$edit_array[23]\n\n";


         if ($edit_array[7] eq cc) {
         if ($edit_array[23] < 0) {
         $body .= "You have a credit of \$$edit_array[23].\n\n";
         $body .= "\$$edit_array[23] will be applied towards your future billing\n";
         $body .= "No additional payment is due this month\n\n";
}
     elsif ($edit_array[23]== 0) {
         $body .= "Your balance is \$0.  No payement is due this month.\n\n";
} else {
         $body .= "Payment for the month of $month now due.\n\n";
         $body .= "\$$edit_array[23] has been submitted for clearing through the credit card\n";
        $body .= "company of record for your account.\n\n"; 
    ...
    if ($edit_array[7] eq check) {
         ...
         if ($edit_array[23] < 0) {
         $body .= "You have a credit of \$$edit_array[23].\n\n";  
         $body .= "\$$edit_array[23] will be applied towards your next billing\n";
           $body .= "No additional payment is due this month.\n\n";
}
elsif ($edit_array[23]== 0) {
         $body .= "Your balance is \$0.  No payement is due this month.\n\n";
       ...
       $body .= "Payment for the month of $month now due.\n\n";
       $body .= "Please make check payable to:\n\n";
       $body .= "$billingaddress1\n";
       $body .= "$billingaddress2\n";
       $body .= "$billingaddress3\n\n";
          }
        }

       $body .= "Thank you for your business.\n\n";
       $body .= "$billinginquiries\n\n";

&sendmail("$edit_array[2]","$orgmail","$orgname $month Billing Statement","$body");
...
#    $body .= "To: $orgmail ($orgname)\n";
#    $body .= "From: $orgmail ($orgname Account Manager - automated script)\n";
#    $body .= "Subject: Past Due Account\n";
    $body .= "-" x 75 . "\n\n";



$body .= "This account may be past due.  Please look into it.\n";
$body .= "-" x 75 . "\n\n";
    ...
    if ($edit_array[7] eq check) {
       ...
       $body .= "Thank you for your business.\n\n";
       $body .= "$billinginquiries\n\n";
&sendmail("$orgmail","$orgmail","Subject: Past Due Account","$body");
}
