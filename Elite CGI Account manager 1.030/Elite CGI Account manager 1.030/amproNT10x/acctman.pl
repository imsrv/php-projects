...
############################################
#
# Copyright 1998 - 2000 Elite Host.  All Rights Reserved.
#
# TERMS OF USE 
...
#    $body .= "Subject: $sign_up_response\n";
    ...
    $body .="\n\n";
&sendmail("$INPUT{'email'}","$orgmail","$sign_up_response","$body");
...
#    $body .= "To: $orgmail\n";
#    $body .= "From: $INPUT{'email'} ($INPUT{'fname'} $INPUT{'lname'})\n";
#    $body .= "Subject: Account Manager Form Response\n";
    $body .= "-" x 75 . "\n\n";
    
    $body .= "Customer Information\n";
    $body .= "-" x 75 . "\n\n";
    $body .= "Name: $INPUT{'fname'} $INPUT{'lname'}\n";
...
$INPUT{'payment'} = "Credit Card";
    ...
    $body .= "-" x 75 . "\n\n";
    $body .= "Form of Payment: $INPUT{'payment'}\n";
...
&sendmail("$orgmail","$INPUT{'email'}","Account Manager Form Response","$body");
...
#    $body .= "Subject: $orgname Account Information\n\n";
    #Date
    $body .= "$date\n";
    ...
    $body .= "You requested your $orgname account information:\n\n";
...
&sendmail("$edit_array[2]","$orgmail","$orgname Account Information","$body");
