...
<div style="width: 410px;">
  ...
  <form action="" method="post">
    ...
    <div class="row">
      <span class="label"></span>
      <span class="formw">
        <input type="submit" name="submit_edit" class="button" value="Save page" />
        <input type="button" value="Back" class="button" onclick="return location.href = 'index.php?page=pages'" />                
      </span>
    </div>
    {scal:error_js}
  </form>
